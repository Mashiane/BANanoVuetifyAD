...
#DesignerProperty: Key: Indeterminate, DisplayName: Indeterminate, Description: , DefaultValue: false, FieldType: Boolean
...
'set enabled
Sub SetEnabled(varEnabled As String) As VCheckbox
sEnabled = varEnabled
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As Object) As VCheckbox
...
'set messages
Sub SetMessages(varMessages As Object) As VCheckbox
...
'set ripple
Sub SetRipple(varRipple As Object) As VCheckbox
...
Sub SetSuccessMessages(varSuccessMessages As Object) As VCheckbox
...
Sub SetValueComparator(varValueComparator As Object) As VCheckbox
...
Sub AddToApp(va As VueApp) As VCheckbox
