...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCheckbox 
mName = Name 
...
'set append-icon
Sub SetAppendIcon(varAppendIcon As String) As VCheckbox
...
Sub SetBackgroundColor(varBackgroundColor As String) As VCheckbox
...
'set color
Sub SetColor(varColor As String) As VCheckbox
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VCheckbox
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set dense
Sub SetDense(varDense As Boolean) As VCheckbox
bDense = varDense
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VCheckbox
...
'set error
Sub SetError(varError As Boolean) As VCheckbox
bError = varError
...
'set error-count
Sub SetErrorCount(varErrorCount As String) As VCheckbox
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As String) As VCheckbox
...
'set false-value
Sub SetFalseValue(varFalseValue As String) As VCheckbox
...
'set height
Sub SetHeight(varHeight As String) As VCheckbox
sHeight = varHeight
...
'set hide-details
Sub SetHideDetails(varHideDetails As String) As VCheckbox
...
'set hint
Sub SetHint(varHint As String) As VCheckbox
sHint = varHint
SetAttr("hint", sHint)
Return Me
End Sub
...
'set indeterminate
Sub SetIndeterminate(varIndeterminate As Boolean) As VCheckbox
...
Sub SetIndeterminateIcon(varIndeterminateIcon As String) As VCheckbox
...
'set input-value
Sub SetInputValue(varInputValue As String) As VCheckbox
...
'set key
Sub SetKey(varKey As String) As VCheckbox
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set label
Sub SetLabel(varLabel As String) As VCheckbox
sLabel = varLabel
...
'set light
Sub SetLight(varLight As Boolean) As VCheckbox
bLight = varLight
...
'set loading
Sub SetLoading(varLoading As Boolean) As VCheckbox
bLoading = varLoading
...
'set messages
Sub SetMessages(varMessages As String) As VCheckbox
...
'set multiple
Sub SetMultiple(varMultiple As Boolean) As VCheckbox
...
'set off-icon
Sub SetOffIcon(varOffIcon As String) As VCheckbox
sOffIcon = varOffIcon
...
'set persistent-hint
Sub SetPersistentHint(varPersistentHint As Boolean) As VCheckbox
...
'set prepend-icon
Sub SetPrependIcon(varPrependIcon As String) As VCheckbox
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VCheckbox
...
'set ref
Sub SetRef(varRef As String) As VCheckbox
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VCheckbox
...
'set ripple
Sub SetRipple(varRipple As String) As VCheckbox
sRipple = varRipple
...
'set rules
Sub SetRules(varRules As Object) As VCheckbox
SetAttr("rules", varRules)
Return Me
End Sub

'set success
Sub SetSuccess(varSuccess As Boolean) As VCheckbox
bSuccess = varSuccess
...
Sub SetSuccessMessages(varSuccessMessages As String) As VCheckbox
...
'set true-value
Sub SetTrueValue(varTrueValue As String) As VCheckbox
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCheckbox
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCheckbox
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCheckbox
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCheckbox
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VCheckbox
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VCheckbox
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCheckbox
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCheckbox
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCheckbox
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCheckbox
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCheckbox
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCheckbox
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCheckbox
sVText = varVText
...
Sub SetValidateOnBlur(varValidateOnBlur As Boolean) As VCheckbox
...
'set value
Sub SetValue(varValue As String) As VCheckbox
sValue = varValue
...
Sub SetValueComparator(varValueComparator As String) As VCheckbox
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCheckbox
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCheckbox
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCheckbox
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCheckbox
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCheckbox
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCheckbox
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCheckbox
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCheckbox
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCheckbox
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCheckbox
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCheckbox
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCheckbox
...
Sub SetOnClickPrepend() As VCheckbox
...
Sub AddComponent(child As String) As VCheckbox
...
Sub SetID(varText As String) As VCheckbox
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCheckbox
...
Sub AddToApp(vap As VueApp) As VCheckbox
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCheckbox
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCheckbox
...
Sub SetCaption(varText As String) As VCheckbox
	If mElement <> Null Then
...
public Sub SetClasses(Classes As String) As VCheckbox
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCheckbox
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCheckbox
...
Sub SetStyles(m As Map) As VCheckbox
...
Sub SetAttrs(props As Map) As VCheckbox
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCheckbox
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCheckbox
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCheckbox
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCheckbox
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCheckbox
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCheckbox
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCheckbox
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCheckbox
...
'set text color
Sub SetTextColor1(varColor As String) As VCheckbox
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCheckbox
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCheckbox
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCheckbox
	If sVShow = "" Then
		Log($"VCheckbox.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCheckbox
	If sVShow = "" Then
		Log($"VCheckbox.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCheckbox
	If sVShow = "" Then
		Log($"VCheckbox.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCheckbox
	if svBindClass = "" then
		Log($"VCheckbox.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'	If sReadonly = "" Then
'		Log($"VCheckbox.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
