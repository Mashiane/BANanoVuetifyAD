...
'set disabled
Sub SetDisabled(varDisabled As String) As VBanner
...
'set parent-id
Sub SetParentId(varParentId As String) As VBanner
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VBanner
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VBanner
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VBanner
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VBanner
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VBanner
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VBanner
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VBanner
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VBanner
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VBanner
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VBanner
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VBanner
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VBanner
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VBanner
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VBanner
...
Sub AddToApp(vap As VueApp) As VBanner
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VBanner
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VBanner
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VBanner
...
'toggle
Sub Toggle As VBanner
	If sVShow = "" Then
		Log($"VBanner.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VBanner
	If sVShow = "" Then
		Log($"VBanner.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VBanner
	If sVShow = "" Then
		Log($"VBanner.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VBanner
	if svBindClass = "" then
		Log($"VBanner.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VBanner
	if svBindStyle = "" then
		Log($"VBanner.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VBanner
'	If sRequired = "" Then
'		Log($"VBanner.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VBanner
'	If sReadonly = "" Then
'		Log($"VBanner.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VBanner
'	If sDisabled = "" Then
'		Log($"VBanner.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
