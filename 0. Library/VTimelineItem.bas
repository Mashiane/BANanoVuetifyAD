2020-07-08 02:40:00 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VTimelineItem
#IgnoreWarnings:12
...
#DesignerProperty: Key: FillDot, DisplayName: FillDot, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: HideDot, DisplayName: HideDot, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Icon, DisplayName: Icon, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: IconColor, DisplayName: IconColor, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-timeline-item" 
...
Private bFillDot As Boolean = False
Private bHideDot As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VTimelineItem 
mName = Name 
...
bFillDot = props.Get("FillDot")
bHideDot = props.Get("HideDot")
...
'set color
Sub SetColor(varColor As String) As VTimelineItem
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VTimelineItem
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VTimelineItem
...
'set fill-dot
Sub SetFillDot(varFillDot As Boolean) As VTimelineItem
bFillDot = varFillDot
SetAttr("fill-dot", bFillDot)
Return Me
End Sub

'set hide-dot
Sub SetHideDot(varHideDot As Boolean) As VTimelineItem
bHideDot = varHideDot
SetAttr("hide-dot", bHideDot)
Return Me
End Sub

'set icon
Sub SetIcon(varIcon As String) As VTimelineItem
sIcon = varIcon
SetAttr("icon", sIcon)
Return Me
End Sub
...
'set icon-color
Sub SetIconColor(varIconColor As String) As VTimelineItem
...
'set key
Sub SetKey(varKey As String) As VTimelineItem
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set large
Sub SetLarge(varLarge As Boolean) As VTimelineItem
bLarge = varLarge
...
'set left
Sub SetLeft(varLeft As Boolean) As VTimelineItem
bLeft = varLeft
SetAttr("left", bLeft)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VTimelineItem
bLight = varLight
...
'set parent-id
Sub SetParentId(varParentId As String) As VTimelineItem
...
'set readonly
Sub SetReadonly(varReadonly As String) As VTimelineItem
...
'set ref
Sub SetRef(varRef As String) As VTimelineItem
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VTimelineItem
...
'set right
Sub SetRight(varRight As Boolean) As VTimelineItem
bRight = varRight
...
'set small
Sub SetSmall(varSmall As Boolean) As VTimelineItem
bSmall = varSmall
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTimelineItem
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTimelineItem
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VTimelineItem
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VTimelineItem
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTimelineItem
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VTimelineItem
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VTimelineItem
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VTimelineItem
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VTimelineItem
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VTimelineItem
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VTimelineItem
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VTimelineItem
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VTimelineItem
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTimelineItem
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTimelineItem
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTimelineItem
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTimelineItem
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTimelineItem
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTimelineItem
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTimelineItem
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTimelineItem
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTimelineItem
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTimelineItem
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTimelineItem
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTimelineItem
...
AddAttr(bFillDot, "fill-dot")
AddAttr(bHideDot, "hide-dot")
AddAttr(sIcon, "icon")
...
Sub AddComponent(child As String) As VTimelineItem
...
Sub SetID(varText As String) As VTimelineItem
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VTimelineItem
...
Sub AddToApp(vap As VueApp) As VTimelineItem
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTimelineItem
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VTimelineItem
...
Sub SetCaption(varText As String) As VTimelineItem
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VTimelineItem
...
public Sub SetClasses(Classes As String) As VTimelineItem
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VTimelineItem
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VTimelineItem
...
Sub SetStyles(m As Map) As VTimelineItem
...
Sub SetAttrs(props As Map) As VTimelineItem
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VTimelineItem
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VTimelineItem
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VTimelineItem
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VTimelineItem
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VTimelineItem
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTimelineItem
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VTimelineItem
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VTimelineItem
...
'set text color
Sub SetTextColor1(varColor As String) As VTimelineItem
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VTimelineItem
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VTimelineItem
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VTimelineItem
	If sVShow = "" Then
		Log($"VTimelineItem.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTimelineItem
	If sVShow = "" Then
		Log($"VTimelineItem.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTimelineItem
	If sVShow = "" Then
		Log($"VTimelineItem.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTimelineItem
	if svBindClass = "" then
		Log($"VTimelineItem.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTimelineItem
	if svBindStyle = "" then
		Log($"VTimelineItem.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTimelineItem
'	If sRequired = "" Then
'		Log($"VTimelineItem.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTimelineItem
'	If sReadonly = "" Then
'		Log($"VTimelineItem.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTimelineItem
'	If sDisabled = "" Then
'		Log($"VTimelineItem.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
