2020-07-08 02:39:29 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSlideXTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-slide-x-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSlideXTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VSlideXTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VSlideXTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VSlideXTransition
...
'set key
Sub SetKey(varKey As String) As VSlideXTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VSlideXTransition
...
'set mode
Sub SetMode(varMode As String) As VSlideXTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VSlideXTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VSlideXTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VSlideXTransition
...
'set ref
Sub SetRef(varRef As String) As VSlideXTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSlideXTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSlideXTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSlideXTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSlideXTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSlideXTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSlideXTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSlideXTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSlideXTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSlideXTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSlideXTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSlideXTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSlideXTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSlideXTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSlideXTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSlideXTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSlideXTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSlideXTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSlideXTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSlideXTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSlideXTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSlideXTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSlideXTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSlideXTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSlideXTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSlideXTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSlideXTransition
...
Sub AddComponent(child As String) As VSlideXTransition
...
Sub SetID(varText As String) As VSlideXTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSlideXTransition
...
Sub AddToApp(vap As VueApp) As VSlideXTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSlideXTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSlideXTransition
...
Sub SetCaption(varText As String) As VSlideXTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSlideXTransition
...
public Sub SetClasses(Classes As String) As VSlideXTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSlideXTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSlideXTransition
...
Sub SetStyles(m As Map) As VSlideXTransition
...
Sub SetAttrs(props As Map) As VSlideXTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSlideXTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSlideXTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSlideXTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSlideXTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSlideXTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSlideXTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSlideXTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSlideXTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VSlideXTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSlideXTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSlideXTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSlideXTransition
	If sVShow = "" Then
		Log($"VSlideXTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSlideXTransition
	If sVShow = "" Then
		Log($"VSlideXTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSlideXTransition
	If sVShow = "" Then
		Log($"VSlideXTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSlideXTransition
	if svBindClass = "" then
		Log($"VSlideXTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSlideXTransition
	if svBindStyle = "" then
		Log($"VSlideXTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSlideXTransition
'	If sRequired = "" Then
'		Log($"VSlideXTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSlideXTransition
'	If sReadonly = "" Then
'		Log($"VSlideXTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSlideXTransition
'	If sDisabled = "" Then
'		Log($"VSlideXTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
