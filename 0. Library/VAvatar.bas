...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VAvatar
#IgnoreWarnings:12
...
Private mTagName As String = "v-avatar" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VAvatar 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VAvatar
sColor = varColor
...
'set disabled
Sub SetDisabled(varDisabled As String) As VAvatar
...
'set height
Sub SetHeight(varHeight As String) As VAvatar
sHeight = varHeight
...
'set key
Sub SetKey(varKey As String) As VAvatar
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set left
Sub SetLeft(varLeft As Boolean) As VAvatar
bLeft = varLeft
SetAttr("left", bLeft)
Return Me
End Sub
...
'set max-height
Sub SetMaxHeight(varMaxHeight As String) As VAvatar
...
'set max-width
Sub SetMaxWidth(varMaxWidth As String) As VAvatar
...
'set min-height
Sub SetMinHeight(varMinHeight As String) As VAvatar
...
'set min-width
Sub SetMinWidth(varMinWidth As String) As VAvatar
...
'set parent-id
Sub SetParentId(varParentId As String) As VAvatar
...
'set readonly
Sub SetReadonly(varReadonly As String) As VAvatar
...
'set ref
Sub SetRef(varRef As String) As VAvatar
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VAvatar
...
'set right
Sub SetRight(varRight As Boolean) As VAvatar
bRight = varRight
...
'set rounded
Sub SetRounded(varRounded As String) As VAvatar
sRounded = varRounded
...
'set size
Sub SetSize(varSize As String) As VAvatar
sSize = varSize
SetAttr("size", sSize)
Return Me
End Sub
...
'set tile
Sub SetTile(varTile As Boolean) As VAvatar
bTile = varTile
SetAttr("tile", bTile)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VAvatar
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VAvatar
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VAvatar
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VAvatar
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VAvatar
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VAvatar
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VAvatar
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VAvatar
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VAvatar
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VAvatar
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VAvatar
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VAvatar
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VAvatar
sVText = varVText
...
'set width
Sub SetWidth(varWidth As String) As VAvatar
sWidth = varWidth
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VAvatar
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VAvatar
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VAvatar
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VAvatar
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VAvatar
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VAvatar
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VAvatar
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VAvatar
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VAvatar
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VAvatar
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VAvatar
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VAvatar
...
Sub AddComponent(child As String) As VAvatar
...
Sub SetID(varText As String) As VAvatar
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VAvatar
...
Sub AddToApp(vap As VueApp) As VAvatar
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VAvatar
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VAvatar
...
Sub SetCaption(varText As String) As VAvatar
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VAvatar
...
public Sub SetClasses(Classes As String) As VAvatar
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VAvatar
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VAvatar
...
Sub SetStyles(m As Map) As VAvatar
...
Sub SetAttrs(props As Map) As VAvatar
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VAvatar
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VAvatar
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VAvatar
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VAvatar
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VAvatar
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VAvatar
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VAvatar
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VAvatar
...
'set text color
Sub SetTextColor1(varColor As String) As VAvatar
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VAvatar
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VAvatar
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VAvatar
	If sVShow = "" Then
		Log($"VAvatar.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VAvatar
	If sVShow = "" Then
		Log($"VAvatar.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VAvatar
	If sVShow = "" Then
		Log($"VAvatar.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VAvatar
	if svBindClass = "" then
		Log($"VAvatar.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VAvatar
	if svBindStyle = "" then
		Log($"VAvatar.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VAvatar
'	If sRequired = "" Then
'		Log($"VAvatar.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VAvatar
'	If sReadonly = "" Then
'		Log($"VAvatar.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VAvatar
'	If sDisabled = "" Then
'		Log($"VAvatar.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
