...
#DesignerProperty: Key: Size, DisplayName: Size, Description: , DefaultValue: 48, FieldType: String
...
'set enabled
Sub SetEnabled(varEnabled As String) As VAvatar
sEnabled = varEnabled
...
Sub AddToApp(va As VueApp) As VAvatar
