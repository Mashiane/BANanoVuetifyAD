2020-07-08 02:37:09 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VBreadcrumbsItem
#IgnoreWarnings:12
...
Private mTagName As String = "v-breadcrumbs-item" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VBreadcrumbsItem 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VBreadcrumbsItem
...
'set append
Sub SetAppend(varAppend As Boolean) As VBreadcrumbsItem
bAppend = varAppend
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VBreadcrumbsItem
...
'set exact
Sub SetExact(varExact As Boolean) As VBreadcrumbsItem
bExact = varExact
...
Sub SetExactActiveClass(varExactActiveClass As String) As VBreadcrumbsItem
...
'set href
Sub SetHref(varHref As String) As VBreadcrumbsItem
sHref = varHref
SetAttr("href", sHref)
Return Me
End Sub
...
'set key
Sub SetKey(varKey As String) As VBreadcrumbsItem
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set link
Sub SetLink(varLink As Boolean) As VBreadcrumbsItem
bLink = varLink
SetAttr("link", bLink)
Return Me
End Sub
...
'set nuxt
Sub SetNuxt(varNuxt As Boolean) As VBreadcrumbsItem
bNuxt = varNuxt
SetAttr("nuxt", bNuxt)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VBreadcrumbsItem
...
'set readonly
Sub SetReadonly(varReadonly As String) As VBreadcrumbsItem
...
'set ref
Sub SetRef(varRef As String) As VBreadcrumbsItem
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set replace
Sub SetReplace(varReplace As Boolean) As VBreadcrumbsItem
bReplace = varReplace
...
'set required
Sub SetRequired(varRequired As String) As VBreadcrumbsItem
...
'set ripple
Sub SetRipple(varRipple As String) As VBreadcrumbsItem
sRipple = varRipple
...
'set tag
Sub SetTag(varTag As String) As VBreadcrumbsItem
sTag = varTag
SetAttr("tag", sTag)
Return Me
End Sub
...
'set target
Sub SetTarget(varTarget As String) As VBreadcrumbsItem
sTarget = varTarget
...
'set to
Sub SetTo(varTo As String) As VBreadcrumbsItem
sTo = varTo
SetAttr("to", sTo)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VBreadcrumbsItem
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VBreadcrumbsItem
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VBreadcrumbsItem
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VBreadcrumbsItem
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VBreadcrumbsItem
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VBreadcrumbsItem
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VBreadcrumbsItem
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VBreadcrumbsItem
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VBreadcrumbsItem
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VBreadcrumbsItem
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VBreadcrumbsItem
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VBreadcrumbsItem
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VBreadcrumbsItem
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VBreadcrumbsItem
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VBreadcrumbsItem
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VBreadcrumbsItem
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VBreadcrumbsItem
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VBreadcrumbsItem
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VBreadcrumbsItem
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VBreadcrumbsItem
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VBreadcrumbsItem
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VBreadcrumbsItem
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VBreadcrumbsItem
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VBreadcrumbsItem
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VBreadcrumbsItem
...
Sub AddComponent(child As String) As VBreadcrumbsItem
...
Sub SetID(varText As String) As VBreadcrumbsItem
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VBreadcrumbsItem
...
Sub AddToApp(vap As VueApp) As VBreadcrumbsItem
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VBreadcrumbsItem
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VBreadcrumbsItem
...
Sub SetCaption(varText As String) As VBreadcrumbsItem
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VBreadcrumbsItem
...
public Sub SetClasses(Classes As String) As VBreadcrumbsItem
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VBreadcrumbsItem
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VBreadcrumbsItem
...
Sub SetStyles(m As Map) As VBreadcrumbsItem
...
Sub SetAttrs(props As Map) As VBreadcrumbsItem
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VBreadcrumbsItem
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VBreadcrumbsItem
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VBreadcrumbsItem
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VBreadcrumbsItem
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VBreadcrumbsItem
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VBreadcrumbsItem
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VBreadcrumbsItem
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VBreadcrumbsItem
...
'set text color
Sub SetTextColor1(varColor As String) As VBreadcrumbsItem
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VBreadcrumbsItem
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VBreadcrumbsItem
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VBreadcrumbsItem
	If sVShow = "" Then
		Log($"VBreadcrumbsItem.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VBreadcrumbsItem
	If sVShow = "" Then
		Log($"VBreadcrumbsItem.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VBreadcrumbsItem
	If sVShow = "" Then
		Log($"VBreadcrumbsItem.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VBreadcrumbsItem
	if svBindClass = "" then
		Log($"VBreadcrumbsItem.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VBreadcrumbsItem
	if svBindStyle = "" then
		Log($"VBreadcrumbsItem.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VBreadcrumbsItem
'	If sRequired = "" Then
'		Log($"VBreadcrumbsItem.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VBreadcrumbsItem
'	If sReadonly = "" Then
'		Log($"VBreadcrumbsItem.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VBreadcrumbsItem
'	If sDisabled = "" Then
'		Log($"VBreadcrumbsItem.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
