...
#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, Description: , DefaultValue: v-breadcrumbs__item--disabled, FieldType: String
...
Private sActiveClass As String = "v-breadcrumbs__item--disabled"
...
'set enabled
Sub SetEnabled(varEnabled As String) As VBreadcrumbsItem
sEnabled = varEnabled
...
'set href
Sub SetHref(varHref As Object) As VBreadcrumbsItem
...
'set ripple
Sub SetRipple(varRipple As Object) As VBreadcrumbsItem
...
'set to
Sub SetTo(varTo As Object) As VBreadcrumbsItem
SetAttr("to", varTo)
Return Me
End Sub
...
Sub AddToApp(va As VueApp) As VBreadcrumbsItem
