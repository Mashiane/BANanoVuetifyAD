...
#DesignerProperty: Key: Dismissible, DisplayName: Dismissible, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Type, DisplayName: Type, Description: , List: success|info|warning|error, FieldType: String, DefaultValue: 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VAlert
...
'set parent-id
Sub SetParentId(varParentId As String) As VAlert
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VAlert
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VAlert
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VAlert
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VAlert
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VAlert
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VAlert
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VAlert
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VAlert
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VAlert
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VAlert
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VAlert
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VAlert
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VAlert
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VAlert
...
Sub SetOnInputE(sInput As String) As VAlert
eOninput = sInput
Return Me
End Sub
...
'toggle
Sub Toggle As VAlert
	If sVShow = "" Then
		Log($"VAlert.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VAlert
	If sVShow = "" Then
		Log($"VAlert.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VAlert
	If sVShow = "" Then
		Log($"VAlert.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VAlert
'	If sRequired = "" Then
'		Log($"VAlert.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VAlert
'	If sReadonly = "" Then
'		Log($"VAlert.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VAlert
'	If sDisabled = "" Then
'		Log($"VAlert.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
