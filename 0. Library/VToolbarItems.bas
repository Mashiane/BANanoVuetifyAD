...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VToolbarItems
#IgnoreWarnings:12
...
Private mTagName As String = "v-toolbar-items" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VToolbarItems 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VToolbarItems
...
'set key
Sub SetKey(varKey As String) As VToolbarItems
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VToolbarItems
...
'set readonly
Sub SetReadonly(varReadonly As String) As VToolbarItems
...
'set ref
Sub SetRef(varRef As String) As VToolbarItems
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VToolbarItems
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VToolbarItems
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VToolbarItems
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VToolbarItems
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VToolbarItems
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VToolbarItems
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VToolbarItems
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VToolbarItems
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VToolbarItems
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VToolbarItems
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VToolbarItems
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VToolbarItems
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VToolbarItems
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VToolbarItems
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VToolbarItems
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VToolbarItems
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VToolbarItems
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VToolbarItems
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VToolbarItems
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VToolbarItems
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VToolbarItems
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VToolbarItems
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VToolbarItems
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VToolbarItems
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VToolbarItems
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VToolbarItems
...
Sub AddComponent(child As String) As VToolbarItems
...
Sub SetID(varText As String) As VToolbarItems
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VToolbarItems
...
Sub AddToApp(vap As VueApp) As VToolbarItems
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VToolbarItems
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VToolbarItems
...
Sub SetCaption(varText As String) As VToolbarItems
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VToolbarItems
...
public Sub SetClasses(Classes As String) As VToolbarItems
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VToolbarItems
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VToolbarItems
...
Sub SetStyles(m As Map) As VToolbarItems
...
Sub SetAttrs(props As Map) As VToolbarItems
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VToolbarItems
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VToolbarItems
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VToolbarItems
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VToolbarItems
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VToolbarItems
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VToolbarItems
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VToolbarItems
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VToolbarItems
...
'set text color
Sub SetTextColor1(varColor As String) As VToolbarItems
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VToolbarItems
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VToolbarItems
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VToolbarItems
	If sVShow = "" Then
		Log($"VToolbarItems.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VToolbarItems
	If sVShow = "" Then
		Log($"VToolbarItems.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VToolbarItems
	If sVShow = "" Then
		Log($"VToolbarItems.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VToolbarItems
	if svBindClass = "" then
		Log($"VToolbarItems.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VToolbarItems
	if svBindStyle = "" then
		Log($"VToolbarItems.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VToolbarItems
'	If sRequired = "" Then
'		Log($"VToolbarItems.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VToolbarItems
'	If sReadonly = "" Then
'		Log($"VToolbarItems.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VToolbarItems
'	If sDisabled = "" Then
'		Log($"VToolbarItems.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
