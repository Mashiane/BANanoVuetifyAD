2020-07-08 02:39:27 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSlideItem
#IgnoreWarnings:12
...
Private mTagName As String = "v-slide-item" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSlideItem 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VSlideItem
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VSlideItem
...
'set key
Sub SetKey(varKey As String) As VSlideItem
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VSlideItem
...
'set readonly
Sub SetReadonly(varReadonly As String) As VSlideItem
...
'set ref
Sub SetRef(varRef As String) As VSlideItem
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSlideItem
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSlideItem
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSlideItem
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSlideItem
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSlideItem
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSlideItem
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSlideItem
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSlideItem
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSlideItem
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSlideItem
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSlideItem
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSlideItem
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSlideItem
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSlideItem
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VSlideItem
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSlideItem
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSlideItem
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSlideItem
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSlideItem
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSlideItem
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSlideItem
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSlideItem
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSlideItem
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSlideItem
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSlideItem
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSlideItem
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSlideItem
...
Sub AddComponent(child As String) As VSlideItem
...
Sub SetID(varText As String) As VSlideItem
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSlideItem
...
Sub AddToApp(vap As VueApp) As VSlideItem
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSlideItem
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSlideItem
...
Sub SetCaption(varText As String) As VSlideItem
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSlideItem
...
public Sub SetClasses(Classes As String) As VSlideItem
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSlideItem
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSlideItem
...
Sub SetStyles(m As Map) As VSlideItem
...
Sub SetAttrs(props As Map) As VSlideItem
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSlideItem
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSlideItem
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSlideItem
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSlideItem
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSlideItem
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSlideItem
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSlideItem
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSlideItem
...
'set text color
Sub SetTextColor1(varColor As String) As VSlideItem
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSlideItem
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSlideItem
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSlideItem
	If sVShow = "" Then
		Log($"VSlideItem.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSlideItem
	If sVShow = "" Then
		Log($"VSlideItem.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSlideItem
	If sVShow = "" Then
		Log($"VSlideItem.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSlideItem
	if svBindClass = "" then
		Log($"VSlideItem.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSlideItem
	if svBindStyle = "" then
		Log($"VSlideItem.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSlideItem
'	If sRequired = "" Then
'		Log($"VSlideItem.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSlideItem
'	If sReadonly = "" Then
'		Log($"VSlideItem.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSlideItem
'	If sDisabled = "" Then
'		Log($"VSlideItem.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
