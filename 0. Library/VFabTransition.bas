2020-07-08 02:38:22 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VFabTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-fab-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VFabTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VFabTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VFabTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VFabTransition
...
'set key
Sub SetKey(varKey As String) As VFabTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VFabTransition
...
'set mode
Sub SetMode(varMode As String) As VFabTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VFabTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VFabTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VFabTransition
...
'set ref
Sub SetRef(varRef As String) As VFabTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VFabTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VFabTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VFabTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VFabTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VFabTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VFabTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VFabTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VFabTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VFabTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VFabTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VFabTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VFabTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VFabTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VFabTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VFabTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VFabTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VFabTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VFabTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VFabTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VFabTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VFabTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VFabTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VFabTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VFabTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VFabTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VFabTransition
...
Sub AddComponent(child As String) As VFabTransition
...
Sub SetID(varText As String) As VFabTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VFabTransition
...
Sub AddToApp(vap As VueApp) As VFabTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VFabTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VFabTransition
...
Sub SetCaption(varText As String) As VFabTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VFabTransition
...
public Sub SetClasses(Classes As String) As VFabTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VFabTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VFabTransition
...
Sub SetStyles(m As Map) As VFabTransition
...
Sub SetAttrs(props As Map) As VFabTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VFabTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VFabTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VFabTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VFabTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VFabTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VFabTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VFabTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VFabTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VFabTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VFabTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VFabTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VFabTransition
	If sVShow = "" Then
		Log($"VFabTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VFabTransition
	If sVShow = "" Then
		Log($"VFabTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VFabTransition
	If sVShow = "" Then
		Log($"VFabTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VFabTransition
	if svBindClass = "" then
		Log($"VFabTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VFabTransition
	if svBindStyle = "" then
		Log($"VFabTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VFabTransition
'	If sRequired = "" Then
'		Log($"VFabTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VFabTransition
'	If sReadonly = "" Then
'		Log($"VFabTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VFabTransition
'	If sDisabled = "" Then
'		Log($"VFabTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
