...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VParallax
#IgnoreWarnings:12
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VParallax 
mName = Name 
...
'set alt
Sub SetAlt(varAlt As String) As VParallax
sAlt = varAlt
SetAttr("alt", sAlt)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VParallax
...
'set height
Sub SetHeight(varHeight As String) As VParallax
sHeight = varHeight
...
'set key
Sub SetKey(varKey As String) As VParallax
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VParallax
...
'set readonly
Sub SetReadonly(varReadonly As String) As VParallax
...
'set ref
Sub SetRef(varRef As String) As VParallax
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VParallax
...
'set src
Sub SetSrc(varSrc As String) As VParallax
sSrc = varSrc
SetAttr("src", sSrc)
Return Me
End Sub
...
'set srcset
Sub SetSrcset(varSrcset As String) As VParallax
sSrcset = varSrcset
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VParallax
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VParallax
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VParallax
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VParallax
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VParallax
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VParallax
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VParallax
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VParallax
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VParallax
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VParallax
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VParallax
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VParallax
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VParallax
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VParallax
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VParallax
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VParallax
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VParallax
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VParallax
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VParallax
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VParallax
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VParallax
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VParallax
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VParallax
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VParallax
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VParallax
...
Sub AddComponent(child As String) As VParallax
...
Sub SetID(varText As String) As VParallax
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VParallax
...
Sub AddToApp(vap As VueApp) As VParallax
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VParallax
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VParallax
...
Sub SetCaption(varText As String) As VParallax
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VParallax
...
public Sub SetClasses(Classes As String) As VParallax
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VParallax
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VParallax
...
Sub SetStyles(m As Map) As VParallax
...
Sub SetAttrs(props As Map) As VParallax
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VParallax
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VParallax
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VParallax
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VParallax
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VParallax
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VParallax
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VParallax
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VParallax
...
'set text color
Sub SetTextColor1(varColor As String) As VParallax
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VParallax
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VParallax
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VParallax
	If sVShow = "" Then
		Log($"VParallax.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VParallax
	If sVShow = "" Then
		Log($"VParallax.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VParallax
	If sVShow = "" Then
		Log($"VParallax.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VParallax
	if svBindClass = "" then
		Log($"VParallax.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VParallax
	if svBindStyle = "" then
		Log($"VParallax.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VParallax
'	If sRequired = "" Then
'		Log($"VParallax.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VParallax
'	If sReadonly = "" Then
'		Log($"VParallax.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VParallax
'	If sDisabled = "" Then
'		Log($"VParallax.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
