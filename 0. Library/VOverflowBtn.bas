...
#DesignerProperty: Key: AllowOverflow, DisplayName: AllowOverflow, FieldType: Boolean, DefaultValue: true , Description: Set allow-overflow
...
#DesignerProperty: Key: AutoSelectFirst, DisplayName: AutoSelectFirst, FieldType: Boolean, DefaultValue: false , Description: Set auto-select-first
...
#DesignerProperty: Key: Editable, DisplayName: Editable, FieldType: Boolean, DefaultValue: false , Description: Set editable
...
#DesignerProperty: Key: HideNoData, DisplayName: HideNoData, FieldType: Boolean, DefaultValue: false , Description: Set hide-no-data
...
#DesignerProperty: Key: NoFilter, DisplayName: NoFilter, FieldType: Boolean, DefaultValue: false , Description: Set no-filter
...
#DesignerProperty: Key: SearchInput, DisplayName: SearchInput, FieldType: String, DefaultValue: , Description: Set search-input
#DesignerProperty: Key: Segmented, DisplayName: Segmented, FieldType: Boolean, DefaultValue: false , Description: Set segmented
...
Sub Class_Globals
	...
	Public bEditable As Boolean = false
	...
	Public bHideNoData As Boolean = false
	...
	Public bNoFilter As Boolean = false
	...
	Public sSearchInput As String = ""
	Public bSegmented As Boolean = false
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bAutoSelectFirst, "b", "auto-select-first")
		...
		AddAttr(Attributes, bEditable, "b", "editable")
		...
		AddAttr(Attributes, bHideNoData, "b", "hide-no-data")
		...
		AddAttr(Attributes, bNoFilter, "b", "no-filter")
		...
		AddAttr(Attributes, sSearchInput, "s", "search-input")
		AddAttr(Attributes, bSegmented, "b", "segmented")
...
Sub SetAutoSelectFirst(varAutoSelectFirst As Boolean)
	bAutoSelectFirst = varAutoSelectFirst
	mElement.SetAttr("auto-select-first", bAutoSelectFirst)
End Sub
...
'set editable
Sub SetEditable(varEditable As Boolean)
	bEditable = varEditable
	mElement.SetAttr("editable", bEditable)
End Sub
...
'set hide-no-data
Sub SetHideNoData(varHideNoData As Boolean)
	bHideNoData = varHideNoData
	mElement.SetAttr("hide-no-data", bHideNoData)
End Sub
...
'set no-filter
Sub SetNoFilter(varNoFilter As Boolean)
	bNoFilter = varNoFilter
	mElement.SetAttr("no-filter", bNoFilter)
End Sub
...
'set search-input
Sub SetSearchInput(varSearchInput As String)
	sSearchInput = varSearchInput
	mElement.SetAttr("search-input", sSearchInput)
End Sub

'set segmented
Sub SetSegmented(varSegmented As Boolean)
	bSegmented = varSegmented
	mElement.SetAttr("segmented", bSegmented)
End Sub
