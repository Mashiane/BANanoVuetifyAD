...
#DesignerProperty: Key: Segmented, DisplayName: Segmented, Description: , FieldType: Boolean, DefaultValue: False
...
'set counter-value
Sub SetCounterValue(varCounterValue As String) As VOverflowBtn
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As String) As VOverflowBtn
...
'set filter
Sub SetFilter(varFilter As String) As VOverflowBtn
sFilter = varFilter
...
'set item-disabled
Sub SetItemDisabled(varItemDisabled As String) As VOverflowBtn
...
'set item-text
Sub SetItemText(varItemText As String) As VOverflowBtn
...
'set item-value
Sub SetItemValue(varItemValue As String) As VOverflowBtn
...
'set menu-props
Sub SetMenuProps(varMenuProps As String) As VOverflowBtn
...
'set messages
Sub SetMessages(varMessages As String) As VOverflowBtn
...
Sub SetSuccessMessages(varSuccessMessages As String) As VOverflowBtn
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VOverflowBtn
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VOverflowBtn
...
Sub SetValueComparator(varValueComparator As String) As VOverflowBtn
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VOverflowBtn
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VOverflowBtn
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VOverflowBtn
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VOverflowBtn
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VOverflowBtn
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VOverflowBtn
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VOverflowBtn
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VOverflowBtn
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VOverflowBtn
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VOverflowBtn
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VOverflowBtn
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VOverflowBtn
...
'set on click event, updates the master events records
Sub SetOnClick1() As VOverflowBtn
	Dim sName As String = $"${mEventName}_click"$
	sName = sName.tolowercase
	If SubExists(mCallBack, sName) = False Then Return Me
	'arguments for the event
...
Sub AddToApp(vap As VueApp) As VOverflowBtn
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VOverflowBtn
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VOverflowBtn
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VOverflowBtn
...
'toggle
Sub Toggle As VOverflowBtn
	If sVShow = "" Then
		Log($"VOverflowBtn.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VOverflowBtn
	If sVShow = "" Then
		Log($"VOverflowBtn.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VOverflowBtn
	If sVShow = "" Then
		Log($"VOverflowBtn.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VOverflowBtn
	if svBindClass = "" then
		Log($"VOverflowBtn.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
Sub SetReadOnlyOnOff(b As Boolean) As VOverflowBtn
	If sReadonly = "" Then
		Log($"VOverflowBtn.ReadOnly - the readonly for ${mName} has not been set!"$)
		Return Me
	End If
