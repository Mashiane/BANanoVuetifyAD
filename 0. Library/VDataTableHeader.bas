...
#DesignerProperty: Key: EveryItem, DisplayName: EveryItem, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Key, DisplayName: Key, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Mobile, DisplayName: Mobile, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: SomeItems, DisplayName: SomeItems, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: SortIcon, DisplayName: SortIcon, Description: , FieldType: String, DefaultValue: 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VDataTableHeader
...
'set options
Sub SetOptions(varOptions As String) As VDataTableHeader
sOptions = varOptions
...
'set parent-id
Sub SetParentId(varParentId As String) As VDataTableHeader
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDataTableHeader
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDataTableHeader
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDataTableHeader
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDataTableHeader
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDataTableHeader
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDataTableHeader
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDataTableHeader
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDataTableHeader
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDataTableHeader
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDataTableHeader
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDataTableHeader
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDataTableHeader
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDataTableHeader
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDataTableHeader
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDataTableHeader
...
Sub AddToApp(vap As VueApp) As VDataTableHeader
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDataTableHeader
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VDataTableHeader
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDataTableHeader
...
'toggle
Sub Toggle As VDataTableHeader
	If sVShow = "" Then
		Log($"VDataTableHeader.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDataTableHeader
	If sVShow = "" Then
		Log($"VDataTableHeader.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDataTableHeader
	If sVShow = "" Then
		Log($"VDataTableHeader.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDataTableHeader
	if svBindClass = "" then
		Log($"VDataTableHeader.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDataTableHeader
	if svBindStyle = "" then
		Log($"VDataTableHeader.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDataTableHeader
'	If sRequired = "" Then
'		Log($"VDataTableHeader.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDataTableHeader
'	If sReadonly = "" Then
'		Log($"VDataTableHeader.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDataTableHeader
'	If sDisabled = "" Then
'		Log($"VDataTableHeader.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
