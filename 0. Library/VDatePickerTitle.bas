...
#DesignerProperty: Key: Date, DisplayName: Date, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: SelectingYear, DisplayName: SelectingYear, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Year, DisplayName: Year, Description: , FieldType: String, DefaultValue: 
...
'set parent-id
Sub SetParentId(varParentId As String) As VDatePickerTitle
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDatePickerTitle
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDatePickerTitle
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDatePickerTitle
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDatePickerTitle
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDatePickerTitle
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDatePickerTitle
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDatePickerTitle
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDatePickerTitle
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDatePickerTitle
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDatePickerTitle
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDatePickerTitle
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDatePickerTitle
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDatePickerTitle
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDatePickerTitle
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDatePickerTitle
...
Sub AddToApp(vap As VueApp) As VDatePickerTitle
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDatePickerTitle
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VDatePickerTitle
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDatePickerTitle
...
'toggle
Sub Toggle As VDatePickerTitle
	If sVShow = "" Then
		Log($"VDatePickerTitle.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDatePickerTitle
	If sVShow = "" Then
		Log($"VDatePickerTitle.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDatePickerTitle
	If sVShow = "" Then
		Log($"VDatePickerTitle.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDatePickerTitle
	if svBindClass = "" then
		Log($"VDatePickerTitle.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDatePickerTitle
	if svBindStyle = "" then
		Log($"VDatePickerTitle.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDatePickerTitle
'	If sRequired = "" Then
'		Log($"VDatePickerTitle.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDatePickerTitle
'	If sReadonly = "" Then
'		Log($"VDatePickerTitle.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDatePickerTitle
'	If sDisabled = "" Then
'		Log($"VDatePickerTitle.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
