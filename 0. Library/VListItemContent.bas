...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VListItemContent
#IgnoreWarnings:12
...
Private mTagName As String = "v-list-item-content" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VListItemContent 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemContent
...
'set key
Sub SetKey(varKey As String) As VListItemContent
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemContent
...
'set readonly
Sub SetReadonly(varReadonly As String) As VListItemContent
...
'set ref
Sub SetRef(varRef As String) As VListItemContent
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VListItemContent
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemContent
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemContent
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VListItemContent
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VListItemContent
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemContent
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VListItemContent
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VListItemContent
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VListItemContent
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VListItemContent
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VListItemContent
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VListItemContent
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VListItemContent
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VListItemContent
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemContent
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemContent
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemContent
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemContent
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemContent
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemContent
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemContent
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemContent
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemContent
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemContent
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemContent
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemContent
...
Sub AddComponent(child As String) As VListItemContent
...
Sub SetID(varText As String) As VListItemContent
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VListItemContent
...
Sub AddToApp(vap As VueApp) As VListItemContent
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemContent
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VListItemContent
...
Sub SetCaption(varText As String) As VListItemContent
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VListItemContent
...
public Sub SetClasses(Classes As String) As VListItemContent
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VListItemContent
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VListItemContent
...
Sub SetStyles(m As Map) As VListItemContent
...
Sub SetAttrs(props As Map) As VListItemContent
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VListItemContent
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VListItemContent
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VListItemContent
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VListItemContent
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VListItemContent
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemContent
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VListItemContent
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VListItemContent
...
'set text color
Sub SetTextColor1(varColor As String) As VListItemContent
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VListItemContent
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VListItemContent
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VListItemContent
	If sVShow = "" Then
		Log($"VListItemContent.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemContent
	If sVShow = "" Then
		Log($"VListItemContent.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemContent
	If sVShow = "" Then
		Log($"VListItemContent.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemContent
	if svBindClass = "" then
		Log($"VListItemContent.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemContent
	if svBindStyle = "" then
		Log($"VListItemContent.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemContent
'	If sRequired = "" Then
'		Log($"VListItemContent.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemContent
'	If sReadonly = "" Then
'		Log($"VListItemContent.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemContent
'	If sDisabled = "" Then
'		Log($"VListItemContent.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
