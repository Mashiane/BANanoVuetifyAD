2020-07-08 02:39:10 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VResponsive
#IgnoreWarnings:12
...
Private mTagName As String = "v-responsive" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VResponsive 
mName = Name 
...
'set aspect-ratio
Sub SetAspectRatio(varAspectRatio As String) As VResponsive
...
'set disabled
Sub SetDisabled(varDisabled As String) As VResponsive
...
'set height
Sub SetHeight(varHeight As String) As VResponsive
sHeight = varHeight
...
'set key
Sub SetKey(varKey As String) As VResponsive
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set max-height
Sub SetMaxHeight(varMaxHeight As String) As VResponsive
...
'set max-width
Sub SetMaxWidth(varMaxWidth As String) As VResponsive
...
'set min-height
Sub SetMinHeight(varMinHeight As String) As VResponsive
...
'set min-width
Sub SetMinWidth(varMinWidth As String) As VResponsive
...
'set parent-id
Sub SetParentId(varParentId As String) As VResponsive
...
'set readonly
Sub SetReadonly(varReadonly As String) As VResponsive
...
'set ref
Sub SetRef(varRef As String) As VResponsive
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VResponsive
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VResponsive
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VResponsive
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VResponsive
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VResponsive
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VResponsive
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VResponsive
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VResponsive
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VResponsive
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VResponsive
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VResponsive
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VResponsive
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VResponsive
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VResponsive
sVText = varVText
...
'set width
Sub SetWidth(varWidth As String) As VResponsive
sWidth = varWidth
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VResponsive
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VResponsive
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VResponsive
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VResponsive
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VResponsive
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VResponsive
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VResponsive
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VResponsive
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VResponsive
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VResponsive
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VResponsive
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VResponsive
...
Sub AddComponent(child As String) As VResponsive
...
Sub SetID(varText As String) As VResponsive
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VResponsive
...
Sub AddToApp(vap As VueApp) As VResponsive
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VResponsive
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VResponsive
...
Sub SetCaption(varText As String) As VResponsive
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VResponsive
...
public Sub SetClasses(Classes As String) As VResponsive
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VResponsive
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VResponsive
...
Sub SetStyles(m As Map) As VResponsive
...
Sub SetAttrs(props As Map) As VResponsive
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VResponsive
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VResponsive
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VResponsive
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VResponsive
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VResponsive
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VResponsive
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VResponsive
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VResponsive
...
'set text color
Sub SetTextColor1(varColor As String) As VResponsive
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VResponsive
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VResponsive
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VResponsive
	If sVShow = "" Then
		Log($"VResponsive.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VResponsive
	If sVShow = "" Then
		Log($"VResponsive.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VResponsive
	If sVShow = "" Then
		Log($"VResponsive.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VResponsive
	if svBindClass = "" then
		Log($"VResponsive.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VResponsive
	if svBindStyle = "" then
		Log($"VResponsive.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VResponsive
'	If sRequired = "" Then
'		Log($"VResponsive.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VResponsive
'	If sReadonly = "" Then
'		Log($"VResponsive.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VResponsive
'	If sDisabled = "" Then
'		Log($"VResponsive.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
