...
#DesignerProperty: Key: Fluid, DisplayName: Fluid, FieldType: Boolean, DefaultValue: false , Description: Set fluid
...
Sub Class_Globals
	...
	Public bFluid As Boolean = false
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bFluid, "b", "fluid")
...
'set fluid
Sub SetFluid(varFluid As Boolean)
	bFluid = varFluid
	mElement.SetAttr("fluid", bFluid)
End Sub
