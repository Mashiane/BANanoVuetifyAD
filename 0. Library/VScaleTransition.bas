2020-07-08 02:39:14 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VScaleTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-scale-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VScaleTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VScaleTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VScaleTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VScaleTransition
...
'set key
Sub SetKey(varKey As String) As VScaleTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VScaleTransition
...
'set mode
Sub SetMode(varMode As String) As VScaleTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VScaleTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VScaleTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VScaleTransition
...
'set ref
Sub SetRef(varRef As String) As VScaleTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VScaleTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VScaleTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VScaleTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VScaleTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VScaleTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VScaleTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VScaleTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VScaleTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VScaleTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VScaleTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VScaleTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VScaleTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VScaleTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VScaleTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VScaleTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VScaleTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VScaleTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VScaleTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VScaleTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VScaleTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VScaleTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VScaleTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VScaleTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VScaleTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VScaleTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VScaleTransition
...
Sub AddComponent(child As String) As VScaleTransition
...
Sub SetID(varText As String) As VScaleTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VScaleTransition
...
Sub AddToApp(vap As VueApp) As VScaleTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VScaleTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VScaleTransition
...
Sub SetCaption(varText As String) As VScaleTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VScaleTransition
...
public Sub SetClasses(Classes As String) As VScaleTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VScaleTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VScaleTransition
...
Sub SetStyles(m As Map) As VScaleTransition
...
Sub SetAttrs(props As Map) As VScaleTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VScaleTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VScaleTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VScaleTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VScaleTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VScaleTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VScaleTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VScaleTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VScaleTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VScaleTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VScaleTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VScaleTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VScaleTransition
	If sVShow = "" Then
		Log($"VScaleTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VScaleTransition
	If sVShow = "" Then
		Log($"VScaleTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VScaleTransition
	If sVShow = "" Then
		Log($"VScaleTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VScaleTransition
	if svBindClass = "" then
		Log($"VScaleTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VScaleTransition
	if svBindStyle = "" then
		Log($"VScaleTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VScaleTransition
'	If sRequired = "" Then
'		Log($"VScaleTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VScaleTransition
'	If sReadonly = "" Then
'		Log($"VScaleTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VScaleTransition
'	If sDisabled = "" Then
'		Log($"VScaleTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
