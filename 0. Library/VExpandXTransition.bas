2020-07-08 02:38:15 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VExpandXTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-expand-x-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VExpandXTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VExpandXTransition
...
'set key
Sub SetKey(varKey As String) As VExpandXTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set mode
Sub SetMode(varMode As String) As VExpandXTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VExpandXTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VExpandXTransition
...
'set ref
Sub SetRef(varRef As String) As VExpandXTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VExpandXTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VExpandXTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VExpandXTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VExpandXTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VExpandXTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VExpandXTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VExpandXTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VExpandXTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VExpandXTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VExpandXTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VExpandXTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VExpandXTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VExpandXTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VExpandXTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VExpandXTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VExpandXTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VExpandXTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VExpandXTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VExpandXTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VExpandXTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VExpandXTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VExpandXTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VExpandXTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VExpandXTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VExpandXTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VExpandXTransition
...
Sub AddComponent(child As String) As VExpandXTransition
...
Sub SetID(varText As String) As VExpandXTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VExpandXTransition
...
Sub AddToApp(vap As VueApp) As VExpandXTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VExpandXTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VExpandXTransition
...
Sub SetCaption(varText As String) As VExpandXTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VExpandXTransition
...
public Sub SetClasses(Classes As String) As VExpandXTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VExpandXTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VExpandXTransition
...
Sub SetStyles(m As Map) As VExpandXTransition
...
Sub SetAttrs(props As Map) As VExpandXTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VExpandXTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VExpandXTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VExpandXTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VExpandXTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VExpandXTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VExpandXTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VExpandXTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VExpandXTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VExpandXTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VExpandXTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VExpandXTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VExpandXTransition
	If sVShow = "" Then
		Log($"VExpandXTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VExpandXTransition
	If sVShow = "" Then
		Log($"VExpandXTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VExpandXTransition
	If sVShow = "" Then
		Log($"VExpandXTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VExpandXTransition
	if svBindClass = "" then
		Log($"VExpandXTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VExpandXTransition
	if svBindStyle = "" then
		Log($"VExpandXTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VExpandXTransition
'	If sRequired = "" Then
'		Log($"VExpandXTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VExpandXTransition
'	If sReadonly = "" Then
'		Log($"VExpandXTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VExpandXTransition
'	If sDisabled = "" Then
'		Log($"VExpandXTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
