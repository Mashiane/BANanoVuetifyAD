...
'set counter-value
Sub SetCounterValue(varCounterValue As Object) As VTextField
...
'set enabled
Sub SetEnabled(varEnabled As String) As VTextField
sEnabled = varEnabled
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As Object) As VTextField
...
'set messages
Sub SetMessages(varMessages As Object) As VTextField
...
Sub SetSuccessMessages(varSuccessMessages As Object) As VTextField
...
Sub AddToApp(va As VueApp) As VTextField
