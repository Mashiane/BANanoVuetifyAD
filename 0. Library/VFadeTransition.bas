2020-07-08 02:38:24 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VFadeTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-fade-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VFadeTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VFadeTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VFadeTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VFadeTransition
...
'set key
Sub SetKey(varKey As String) As VFadeTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VFadeTransition
...
'set mode
Sub SetMode(varMode As String) As VFadeTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VFadeTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VFadeTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VFadeTransition
...
'set ref
Sub SetRef(varRef As String) As VFadeTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VFadeTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VFadeTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VFadeTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VFadeTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VFadeTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VFadeTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VFadeTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VFadeTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VFadeTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VFadeTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VFadeTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VFadeTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VFadeTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VFadeTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VFadeTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VFadeTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VFadeTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VFadeTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VFadeTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VFadeTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VFadeTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VFadeTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VFadeTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VFadeTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VFadeTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VFadeTransition
...
Sub AddComponent(child As String) As VFadeTransition
...
Sub SetID(varText As String) As VFadeTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VFadeTransition
...
Sub AddToApp(vap As VueApp) As VFadeTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VFadeTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VFadeTransition
...
Sub SetCaption(varText As String) As VFadeTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VFadeTransition
...
public Sub SetClasses(Classes As String) As VFadeTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VFadeTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VFadeTransition
...
Sub SetStyles(m As Map) As VFadeTransition
...
Sub SetAttrs(props As Map) As VFadeTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VFadeTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VFadeTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VFadeTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VFadeTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VFadeTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VFadeTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VFadeTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VFadeTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VFadeTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VFadeTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VFadeTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VFadeTransition
	If sVShow = "" Then
		Log($"VFadeTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VFadeTransition
	If sVShow = "" Then
		Log($"VFadeTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VFadeTransition
	If sVShow = "" Then
		Log($"VFadeTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VFadeTransition
	if svBindClass = "" then
		Log($"VFadeTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VFadeTransition
	if svBindStyle = "" then
		Log($"VFadeTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VFadeTransition
'	If sRequired = "" Then
'		Log($"VFadeTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VFadeTransition
'	If sReadonly = "" Then
'		Log($"VFadeTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VFadeTransition
'	If sDisabled = "" Then
'		Log($"VFadeTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
