2020-07-08 02:39:16 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VScrollXTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-scroll-x-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VScrollXTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VScrollXTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VScrollXTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VScrollXTransition
...
'set key
Sub SetKey(varKey As String) As VScrollXTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VScrollXTransition
...
'set mode
Sub SetMode(varMode As String) As VScrollXTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VScrollXTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VScrollXTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VScrollXTransition
...
'set ref
Sub SetRef(varRef As String) As VScrollXTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VScrollXTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VScrollXTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VScrollXTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VScrollXTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VScrollXTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VScrollXTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VScrollXTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VScrollXTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VScrollXTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VScrollXTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VScrollXTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VScrollXTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VScrollXTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VScrollXTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VScrollXTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VScrollXTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VScrollXTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VScrollXTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VScrollXTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VScrollXTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VScrollXTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VScrollXTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VScrollXTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VScrollXTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VScrollXTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VScrollXTransition
...
Sub AddComponent(child As String) As VScrollXTransition
...
Sub SetID(varText As String) As VScrollXTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VScrollXTransition
...
Sub AddToApp(vap As VueApp) As VScrollXTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VScrollXTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VScrollXTransition
...
Sub SetCaption(varText As String) As VScrollXTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VScrollXTransition
...
public Sub SetClasses(Classes As String) As VScrollXTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VScrollXTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VScrollXTransition
...
Sub SetStyles(m As Map) As VScrollXTransition
...
Sub SetAttrs(props As Map) As VScrollXTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VScrollXTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VScrollXTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VScrollXTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VScrollXTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VScrollXTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VScrollXTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VScrollXTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VScrollXTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VScrollXTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VScrollXTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VScrollXTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VScrollXTransition
	If sVShow = "" Then
		Log($"VScrollXTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VScrollXTransition
	If sVShow = "" Then
		Log($"VScrollXTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VScrollXTransition
	If sVShow = "" Then
		Log($"VScrollXTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VScrollXTransition
	if svBindClass = "" then
		Log($"VScrollXTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VScrollXTransition
	if svBindStyle = "" then
		Log($"VScrollXTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VScrollXTransition
'	If sRequired = "" Then
'		Log($"VScrollXTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VScrollXTransition
'	If sReadonly = "" Then
'		Log($"VScrollXTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VScrollXTransition
'	If sDisabled = "" Then
'		Log($"VScrollXTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
