2020-07-08 02:38:52 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VMenuTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-menu-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VMenuTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VMenuTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VMenuTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VMenuTransition
...
'set key
Sub SetKey(varKey As String) As VMenuTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VMenuTransition
...
'set mode
Sub SetMode(varMode As String) As VMenuTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VMenuTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VMenuTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VMenuTransition
...
'set ref
Sub SetRef(varRef As String) As VMenuTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VMenuTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VMenuTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VMenuTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VMenuTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VMenuTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VMenuTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VMenuTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VMenuTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VMenuTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VMenuTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VMenuTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VMenuTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VMenuTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VMenuTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VMenuTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VMenuTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VMenuTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VMenuTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VMenuTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VMenuTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VMenuTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VMenuTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VMenuTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VMenuTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VMenuTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VMenuTransition
...
Sub AddComponent(child As String) As VMenuTransition
...
Sub SetID(varText As String) As VMenuTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VMenuTransition
...
Sub AddToApp(vap As VueApp) As VMenuTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VMenuTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VMenuTransition
...
Sub SetCaption(varText As String) As VMenuTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VMenuTransition
...
public Sub SetClasses(Classes As String) As VMenuTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VMenuTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VMenuTransition
...
Sub SetStyles(m As Map) As VMenuTransition
...
Sub SetAttrs(props As Map) As VMenuTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VMenuTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VMenuTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VMenuTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VMenuTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VMenuTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VMenuTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VMenuTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VMenuTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VMenuTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMenuTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VMenuTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VMenuTransition
	If sVShow = "" Then
		Log($"VMenuTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VMenuTransition
	If sVShow = "" Then
		Log($"VMenuTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VMenuTransition
	If sVShow = "" Then
		Log($"VMenuTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VMenuTransition
	if svBindClass = "" then
		Log($"VMenuTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VMenuTransition
	if svBindStyle = "" then
		Log($"VMenuTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VMenuTransition
'	If sRequired = "" Then
'		Log($"VMenuTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VMenuTransition
'	If sReadonly = "" Then
'		Log($"VMenuTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VMenuTransition
'	If sDisabled = "" Then
'		Log($"VMenuTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
