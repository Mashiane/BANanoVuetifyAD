...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VDivider
#IgnoreWarnings:12
...
Private mTagName As String = "v-divider" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VDivider 
mName = Name 
...
'set dark
Sub SetDark(varDark As Boolean) As VDivider
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VDivider
...
'set inset
Sub SetInset(varInset As Boolean) As VDivider
bInset = varInset
...
'set key
Sub SetKey(varKey As String) As VDivider
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VDivider
bLight = varLight
...
'set parent-id
Sub SetParentId(varParentId As String) As VDivider
...
'set readonly
Sub SetReadonly(varReadonly As String) As VDivider
...
'set ref
Sub SetRef(varRef As String) As VDivider
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VDivider
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDivider
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDivider
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VDivider
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VDivider
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDivider
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VDivider
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VDivider
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VDivider
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VDivider
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VDivider
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VDivider
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VDivider
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VDivider
sVText = varVText
...
'set vertical
Sub SetVertical(varVertical As Boolean) As VDivider
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDivider
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDivider
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDivider
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDivider
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDivider
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDivider
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDivider
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDivider
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDivider
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDivider
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDivider
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDivider
...
Sub AddComponent(child As String) As VDivider
...
Sub SetID(varText As String) As VDivider
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VDivider
...
Sub AddToApp(vap As VueApp) As VDivider
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDivider
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VDivider
...
Sub SetCaption(varText As String) As VDivider
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VDivider
...
public Sub SetClasses(Classes As String) As VDivider
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VDivider
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VDivider
...
Sub SetStyles(m As Map) As VDivider
...
Sub SetAttrs(props As Map) As VDivider
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VDivider
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VDivider
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VDivider
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VDivider
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VDivider
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDivider
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VDivider
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VDivider
...
'set text color
Sub SetTextColor1(varColor As String) As VDivider
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VDivider
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VDivider
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VDivider
	If sVShow = "" Then
		Log($"VDivider.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDivider
	If sVShow = "" Then
		Log($"VDivider.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDivider
	If sVShow = "" Then
		Log($"VDivider.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDivider
	if svBindClass = "" then
		Log($"VDivider.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDivider
	if svBindStyle = "" then
		Log($"VDivider.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDivider
'	If sRequired = "" Then
'		Log($"VDivider.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDivider
'	If sReadonly = "" Then
'		Log($"VDivider.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDivider
'	If sDisabled = "" Then
'		Log($"VDivider.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
