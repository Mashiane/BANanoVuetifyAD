...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VListItemGroup
#IgnoreWarnings:12
...
Private mTagName As String = "v-list-item-group" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VListItemGroup 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VListItemGroup
...
'set color
Sub SetColor(varColor As String) As VListItemGroup
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VListItemGroup
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemGroup
...
'set key
Sub SetKey(varKey As String) As VListItemGroup
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VListItemGroup
bLight = varLight
...
'set mandatory
Sub SetMandatory(varMandatory As Boolean) As VListItemGroup
...
'set max
Sub SetMax(varMax As String) As VListItemGroup
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set multiple
Sub SetMultiple(varMultiple As Boolean) As VListItemGroup
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemGroup
...
'set readonly
Sub SetReadonly(varReadonly As String) As VListItemGroup
...
'set ref
Sub SetRef(varRef As String) As VListItemGroup
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VListItemGroup
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemGroup
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemGroup
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VListItemGroup
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VListItemGroup
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemGroup
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VListItemGroup
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VListItemGroup
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VListItemGroup
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VListItemGroup
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VListItemGroup
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VListItemGroup
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VListItemGroup
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VListItemGroup
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VListItemGroup
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemGroup
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemGroup
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemGroup
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemGroup
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemGroup
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemGroup
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemGroup
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemGroup
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemGroup
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemGroup
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemGroup
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemGroup
...
Sub SetOnChange() As VListItemGroup
...
Sub SetOnChangeE(sChange As String) As VListItemGroup
eOnchange = sChange
Return Me
End Sub
...
Sub AddComponent(child As String) As VListItemGroup
...
Sub SetID(varText As String) As VListItemGroup
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VListItemGroup
...
Sub AddToApp(vap As VueApp) As VListItemGroup
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemGroup
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VListItemGroup
...
Sub SetCaption(varText As String) As VListItemGroup
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VListItemGroup
...
public Sub SetClasses(Classes As String) As VListItemGroup
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VListItemGroup
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VListItemGroup
...
Sub SetStyles(m As Map) As VListItemGroup
...
Sub SetAttrs(props As Map) As VListItemGroup
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VListItemGroup
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VListItemGroup
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VListItemGroup
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VListItemGroup
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VListItemGroup
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemGroup
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VListItemGroup
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VListItemGroup
...
'set text color
Sub SetTextColor1(varColor As String) As VListItemGroup
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VListItemGroup
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VListItemGroup
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VListItemGroup
	If sVShow = "" Then
		Log($"VListItemGroup.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemGroup
	If sVShow = "" Then
		Log($"VListItemGroup.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemGroup
	If sVShow = "" Then
		Log($"VListItemGroup.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemGroup
	if svBindClass = "" then
		Log($"VListItemGroup.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemGroup
	if svBindStyle = "" then
		Log($"VListItemGroup.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemGroup
'	If sRequired = "" Then
'		Log($"VListItemGroup.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemGroup
'	If sReadonly = "" Then
'		Log($"VListItemGroup.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemGroup
'	If sDisabled = "" Then
'		Log($"VListItemGroup.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
