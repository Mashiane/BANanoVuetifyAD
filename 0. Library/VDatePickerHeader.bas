...
'set enabled
Sub SetEnabled(varEnabled As String) As VDatePickerHeader
sEnabled = varEnabled
...
'set format
Sub SetFormat(varFormat As Object) As VDatePickerHeader
...
Sub AddToApp(va As VueApp) As VDatePickerHeader
