2020-07-08 02:39:15 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VScrollXReverseTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-scroll-x-reverse-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VScrollXReverseTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VScrollXReverseTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VScrollXReverseTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VScrollXReverseTransition
...
'set key
Sub SetKey(varKey As String) As VScrollXReverseTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VScrollXReverseTransition
...
'set mode
Sub SetMode(varMode As String) As VScrollXReverseTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VScrollXReverseTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VScrollXReverseTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VScrollXReverseTransition
...
'set ref
Sub SetRef(varRef As String) As VScrollXReverseTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VScrollXReverseTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VScrollXReverseTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VScrollXReverseTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VScrollXReverseTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VScrollXReverseTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VScrollXReverseTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VScrollXReverseTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VScrollXReverseTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VScrollXReverseTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VScrollXReverseTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VScrollXReverseTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VScrollXReverseTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VScrollXReverseTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VScrollXReverseTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VScrollXReverseTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VScrollXReverseTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VScrollXReverseTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VScrollXReverseTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VScrollXReverseTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VScrollXReverseTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VScrollXReverseTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VScrollXReverseTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VScrollXReverseTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VScrollXReverseTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VScrollXReverseTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VScrollXReverseTransition
...
Sub AddComponent(child As String) As VScrollXReverseTransition
...
Sub SetID(varText As String) As VScrollXReverseTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VScrollXReverseTransition
...
Sub AddToApp(vap As VueApp) As VScrollXReverseTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VScrollXReverseTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VScrollXReverseTransition
...
Sub SetCaption(varText As String) As VScrollXReverseTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VScrollXReverseTransition
...
public Sub SetClasses(Classes As String) As VScrollXReverseTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VScrollXReverseTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VScrollXReverseTransition
...
Sub SetStyles(m As Map) As VScrollXReverseTransition
...
Sub SetAttrs(props As Map) As VScrollXReverseTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VScrollXReverseTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VScrollXReverseTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VScrollXReverseTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VScrollXReverseTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VScrollXReverseTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VScrollXReverseTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VScrollXReverseTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VScrollXReverseTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VScrollXReverseTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VScrollXReverseTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VScrollXReverseTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VScrollXReverseTransition
	If sVShow = "" Then
		Log($"VScrollXReverseTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VScrollXReverseTransition
	If sVShow = "" Then
		Log($"VScrollXReverseTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VScrollXReverseTransition
	If sVShow = "" Then
		Log($"VScrollXReverseTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VScrollXReverseTransition
	if svBindClass = "" then
		Log($"VScrollXReverseTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VScrollXReverseTransition
	if svBindStyle = "" then
		Log($"VScrollXReverseTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VScrollXReverseTransition
'	If sRequired = "" Then
'		Log($"VScrollXReverseTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VScrollXReverseTransition
'	If sReadonly = "" Then
'		Log($"VScrollXReverseTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VScrollXReverseTransition
'	If sDisabled = "" Then
'		Log($"VScrollXReverseTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
