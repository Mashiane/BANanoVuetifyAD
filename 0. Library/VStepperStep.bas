...
#DesignerProperty: Key: Complete, DisplayName: Complete, Description: , FieldType: String, DefaultValue: 
...
'set complete
Sub SetComplete(varComplete As String) As VStepperStep
sComplete = varComplete
SetAttr("complete", sComplete)
Return Me
End Sub
