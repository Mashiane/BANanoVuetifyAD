2020-07-08 02:38:37 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VItemGroup
#IgnoreWarnings:12
...
Private mTagName As String = "v-item-group" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VItemGroup 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VItemGroup
...
'set dark
Sub SetDark(varDark As Boolean) As VItemGroup
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VItemGroup
...
'set key
Sub SetKey(varKey As String) As VItemGroup
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VItemGroup
bLight = varLight
...
'set mandatory
Sub SetMandatory(varMandatory As Boolean) As VItemGroup
...
'set max
Sub SetMax(varMax As String) As VItemGroup
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set multiple
Sub SetMultiple(varMultiple As Boolean) As VItemGroup
...
'set parent-id
Sub SetParentId(varParentId As String) As VItemGroup
...
'set readonly
Sub SetReadonly(varReadonly As String) As VItemGroup
...
'set ref
Sub SetRef(varRef As String) As VItemGroup
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VItemGroup
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VItemGroup
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VItemGroup
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VItemGroup
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VItemGroup
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VItemGroup
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VItemGroup
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VItemGroup
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VItemGroup
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VItemGroup
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VItemGroup
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VItemGroup
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VItemGroup
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VItemGroup
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VItemGroup
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VItemGroup
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VItemGroup
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VItemGroup
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VItemGroup
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VItemGroup
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VItemGroup
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VItemGroup
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VItemGroup
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VItemGroup
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VItemGroup
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VItemGroup
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VItemGroup
...
Sub SetOnChangeE(sChange As String) As VItemGroup
eOnchange = sChange
Return Me
End Sub
...
Sub AddComponent(child As String) As VItemGroup
...
Sub SetID(varText As String) As VItemGroup
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VItemGroup
...
Sub AddToApp(vap As VueApp) As VItemGroup
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VItemGroup
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VItemGroup
...
Sub SetCaption(varText As String) As VItemGroup
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VItemGroup
...
public Sub SetClasses(Classes As String) As VItemGroup
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VItemGroup
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VItemGroup
...
Sub SetStyles(m As Map) As VItemGroup
...
Sub SetAttrs(props As Map) As VItemGroup
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VItemGroup
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VItemGroup
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VItemGroup
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VItemGroup
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VItemGroup
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VItemGroup
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VItemGroup
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VItemGroup
...
'set text color
Sub SetTextColor1(varColor As String) As VItemGroup
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VItemGroup
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VItemGroup
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VItemGroup
	If sVShow = "" Then
		Log($"VItemGroup.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VItemGroup
	If sVShow = "" Then
		Log($"VItemGroup.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VItemGroup
	If sVShow = "" Then
		Log($"VItemGroup.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VItemGroup
	if svBindClass = "" then
		Log($"VItemGroup.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VItemGroup
	if svBindStyle = "" then
		Log($"VItemGroup.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VItemGroup
'	If sRequired = "" Then
'		Log($"VItemGroup.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VItemGroup
'	If sReadonly = "" Then
'		Log($"VItemGroup.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VItemGroup
'	If sDisabled = "" Then
'		Log($"VItemGroup.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
