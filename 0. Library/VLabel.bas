...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VLabel
#IgnoreWarnings:12
...
#DesignerProperty: Key: Focused, DisplayName: Focused, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: For, DisplayName: For, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Key, DisplayName: Key, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Left, DisplayName: Left, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: Right, DisplayName: Right, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-label" 
...
Private bFocused As Boolean = False
Private sFor As String = ""
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VLabel 
mName = Name 
...
bFocused = props.Get("Focused")
sFor = props.Get("For")
sKey = props.Get("Key")
sLeft = props.Get("Left")
bLight = props.Get("Light")
sReadonly = props.Get("Readonly")
sRef = props.Get("Ref")
sRequired = props.Get("Required")
sRight = props.Get("Right")
...
'set absolute
Sub SetAbsolute(varAbsolute As Boolean) As VLabel
...
'set color
Sub SetColor(varColor As String) As VLabel
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VLabel
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VLabel
...
'set focused
Sub SetFocused(varFocused As Boolean) As VLabel
bFocused = varFocused
SetAttr("focused", bFocused)
Return Me
End Sub

'set for
Sub SetFor(varFor As String) As VLabel
sFor = varFor
SetAttr("for", sFor)
Return Me
End Sub
...
'set key
Sub SetKey(varKey As String) As VLabel
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set left
Sub SetLeft(varLeft As String) As VLabel
sLeft = varLeft
SetAttr("left", sLeft)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VLabel
bLight = varLight
...
'set readonly
Sub SetReadonly(varReadonly As String) As VLabel
...
'set ref
Sub SetRef(varRef As String) As VLabel
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VLabel
...
'set right
Sub SetRight(varRight As String) As VLabel
sRight = varRight
SetAttr("right", sRight)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VLabel
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VLabel
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VLabel
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VLabel
sVElse = varVElse
...
'set v-for
Sub SetVFor(varVFor As String) As VLabel
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VLabel
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VLabel
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VLabel
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VLabel
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VLabel
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VLabel
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VLabel
sVText = varVText
...
'set value
Sub SetValue(varValue As Boolean) As VLabel
bValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VLabel
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VLabel
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VLabel
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VLabel
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VLabel
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VLabel
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VLabel
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VLabel
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VLabel
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VLabel
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VLabel
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VLabel
...
Sub AddComponent(child As String) As VLabel
...
Sub SetID(varText As String) As VLabel
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VLabel
...
'update the state
Sub SetData(prop as string, value as object) As VLabel
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VLabel
...
Sub SetCaption(varText As String) As VLabel
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VLabel
...
public Sub SetClasses(Classes As String) As VLabel
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VLabel
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VLabel
...
Sub SetStyles(m As Map) As VLabel
...
Sub SetAttrs(props As Map) As VLabel
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VLabel
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VLabel
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VLabel
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VLabel
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VLabel
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VLabel
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VLabel
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VLabel
...
'set text color
Sub SetTextColor1(varColor As String) As VLabel
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VLabel
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VLabel
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VLabel
	If sVShow = "" Then
		Log($"VLabel.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VLabel
	If sVShow = "" Then
		Log($"VLabel.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VLabel
	If sVShow = "" Then
		Log($"VLabel.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VLabel
	if svBindClass = "" then
		Log($"VLabel.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VLabel
	if svBindStyle = "" then
		Log($"VLabel.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
Sub SetRequiredOnOff(b As Boolean) As VLabel
	If sRequired = "" Then
		Log($"VLabel.Required - the required for ${mName} has not been set!"$)
		Return Me
	End If
...
'read only
Sub SetReadOnlyOnOff(b As Boolean) As VLabel
	If sReadonly = "" Then
		Log($"VLabel.ReadOnly - the readonly for ${mName} has not been set!"$)
		Return Me
	End If
...
''disabled
'Sub SetDisabledOnOff(b As Boolean) As VLabel
'	If sDisabled = "" Then
'		Log($"VLabel.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
