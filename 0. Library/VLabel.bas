...
#DesignerProperty: Key: Focused, DisplayName: Focused, FieldType: Boolean, DefaultValue: false , Description: Set focused
#DesignerProperty: Key: For, DisplayName: For, FieldType: String, DefaultValue: , Description: Set for
#DesignerProperty: Key: Left, DisplayName: Left, FieldType: String, DefaultValue: , Description: Set left
#DesignerProperty: Key: Light, DisplayName: Light, FieldType: Boolean, DefaultValue: false , Description: Set light
#DesignerProperty: Key: Right, DisplayName: Right, FieldType: String, DefaultValue: , Description: Set right
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: Boolean, DefaultValue: false , Description: Set value
...
Sub Class_Globals
	...
	Public bFocused As Boolean = False
	Public sFor As String = ""
	Public sLeft As String = "0"
	Public bLight As Boolean = False
	Public sRight As String = "auto"
	Public bValue As Boolean = False
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bFocused, "b", "focused")
		AddAttr(Attributes, sFor, "s", "for")
		AddAttr(Attributes, sLeft, "s", "left")
		AddAttr(Attributes, bLight, "b", "light")
		AddAttr(Attributes, sRight, "s", "right")
...
'set focused
Sub SetFocused(varFocused As Boolean)
	bFocused = varFocused
	mElement.SetAttr("focused", bFocused)
End Sub

'set for
Sub SetFor(varFor As String)
	sFor = varFor
	mElement.SetAttr("for", sFor)
End Sub

'set left
Sub SetLeft(varLeft As String)
	sLeft = varLeft
	mElement.SetAttr("left", sLeft)
End Sub
...
'set right
Sub SetRight(varRight As String)
	sRight = varRight
	mElement.SetAttr("right", sRight)
End Sub
