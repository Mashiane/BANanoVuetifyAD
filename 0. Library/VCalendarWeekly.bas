...
'set day-format
Sub SetDayFormat(varDayFormat As Object) As VCalendarWeekly
SetAttr("day-format", varDayFormat)
Return Me
End Sub

'set enabled
Sub SetEnabled(varEnabled As String) As VCalendarWeekly
sEnabled = varEnabled
...
'set end
Sub SetEnd(varEnd As String) As VCalendarWeekly
sEnd = varEnd
SetAttr("end", sEnd)
Return Me
End Sub
...
'set month-format
Sub SetMonthFormat(varMonthFormat As Object) As VCalendarWeekly
...
'set start
Sub SetStart(varStart As String) As VCalendarWeekly
sStart = varStart
...
'set weekday-format
Sub SetWeekdayFormat(varWeekdayFormat As Object) As VCalendarWeekly
SetAttr("weekday-format", varWeekdayFormat)
Return Me
End Sub

'set weekdays
Sub SetWeekdays(varWeekdays As Object) As VCalendarWeekly
...
Sub AddToApp(va As VueApp) As VCalendarWeekly
