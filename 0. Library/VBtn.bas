...
#DesignerProperty: Key: Block, DisplayName: Block, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Bottom, DisplayName: Bottom, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Caption, DisplayName: Caption, Description: , FieldType: String, DefaultValue: Click Me
...
#DesignerProperty: Key: Icon, DisplayName: Icon, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: RetainFocusOnClick, DisplayName: RetainFocusOnClick, Description: , FieldType: Boolean, DefaultValue: False
...
Private bRetainFocusOnClick As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VBtn 
mName = Name 
...
'set absolute
Sub SetAbsolute(varAbsolute As Boolean) As VBtn
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VBtn
...
'set append
Sub SetAppend(varAppend As Boolean) As VBtn
bAppend = varAppend
...
'set block
Sub SetBlock(varBlock As Boolean) As VBtn
bBlock = varBlock
SetAttr("block", bBlock)
Return Me
End Sub

'set bottom
Sub SetBottom(varBottom As Boolean) As VBtn
bBottom = varBottom
...
'set color
Sub SetColor(varColor As String) As VBtn
sColor = varColor
...
'set depressed
Sub SetDepressed(varDepressed As Boolean) As VBtn
bDepressed = varDepressed
SetAttr("depressed", bDepressed)
Return Me
End Sub

'set disabled
Sub SetDisabled(varDisabled As Boolean) As VBtn
...
'set elevation
Sub SetElevation(varElevation As String) As VBtn
...
'set exact
Sub SetExact(varExact As Boolean) As VBtn
bExact = varExact
...
Sub SetExactActiveClass(varExactActiveClass As String) As VBtn
...
'set fab
Sub SetFab(varFab As Boolean) As VBtn
bFab = varFab
SetAttr("fab", bFab)
Return Me
End Sub
...
'set fixed
Sub SetFixed(varFixed As Boolean) As VBtn
bFixed = varFixed
...
'set height
Sub SetHeight(varHeight As String) As VBtn
sHeight = varHeight
...
'set href
Sub SetHref(varHref As String) As VBtn
sHref = varHref
SetAttr("href", sHref)
Return Me
End Sub
...
'set icon
Sub SetIcon(varIcon As Boolean) As VBtn
bIcon = varIcon
SetAttr("icon", bIcon)
Return Me
End Sub
...
'set input-value
Sub SetInputValue(varInputValue As String) As VBtn
...
'set key
Sub SetKey(varKey As String) As VBtn
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set large
Sub SetLarge(varLarge As Boolean) As VBtn
bLarge = varLarge
...
'set left
Sub SetLeft(varLeft As Boolean) As VBtn
bLeft = varLeft
SetAttr("left", bLeft)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VBtn
bLight = varLight
...
'set link
Sub SetLink(varLink As Boolean) As VBtn
bLink = varLink
SetAttr("link", bLink)
Return Me
End Sub
...
'set loading
Sub SetLoading(varLoading As Boolean) As VBtn
bLoading = varLoading
...
'set max-height
Sub SetMaxHeight(varMaxHeight As String) As VBtn
...
'set max-width
Sub SetMaxWidth(varMaxWidth As String) As VBtn
...
'set min-height
Sub SetMinHeight(varMinHeight As String) As VBtn
...
'set min-width
Sub SetMinWidth(varMinWidth As String) As VBtn
...
'set nuxt
Sub SetNuxt(varNuxt As Boolean) As VBtn
bNuxt = varNuxt
SetAttr("nuxt", bNuxt)
Return Me
End Sub
...
'set readonly
Sub SetReadonly(varReadonly As String) As VBtn
...
'set ref
Sub SetRef(varRef As String) As VBtn
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set replace
Sub SetReplace(varReplace As Boolean) As VBtn
bReplace = varReplace
...
'set required
Sub SetRequired(varRequired As String) As VBtn
...
Sub SetRetainFocusOnClick(varRetainFocusOnClick As Boolean) As VBtn
bRetainFocusOnClick = varRetainFocusOnClick
SetAttr("retain-focus-on-click", bRetainFocusOnClick)
Return Me
End Sub

'set right
Sub SetRight(varRight As Boolean) As VBtn
bRight = varRight
...
'set ripple
Sub SetRipple(varRipple As String) As VBtn
sRipple = varRipple
...
'set rounded
Sub SetRounded(varRounded As Boolean) As VBtn
bRounded = varRounded
...
'set shaped
Sub SetShaped(varShaped As Boolean) As VBtn
bShaped = varShaped
...
'set small
Sub SetSmall(varSmall As Boolean) As VBtn
bSmall = varSmall
...
'set tag
Sub SetTag(varTag As String) As VBtn
sTag = varTag
SetAttr("tag", sTag)
Return Me
End Sub
...
'set target
Sub SetTarget(varTarget As String) As VBtn
sTarget = varTarget
...
'set text
Sub SetText(varText As Boolean) As VBtn
bText = varText
SetAttr("text", bText)
Return Me
End Sub
...
'set tile
Sub SetTile(varTile As Boolean) As VBtn
bTile = varTile
SetAttr("tile", bTile)
Return Me
End Sub
...
'set to
Sub SetTo(varTo As String) As VBtn
sTo = varTo
SetAttr("to", sTo)
Return Me
End Sub
...
'set top
Sub SetTop(varTop As Boolean) As VBtn
bTop = varTop
SetAttr("top", bTop)
Return Me
End Sub
...
'set type
Sub SetType(varType As String) As VBtn
sType = varType
SetAttr("type", sType)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VBtn
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VBtn
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VBtn
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VBtn
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VBtn
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VBtn
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VBtn
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VBtn
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VBtn
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VBtn
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VBtn
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VBtn
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VBtn
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VBtn
sValue = varValue
...
'set width
Sub SetWidth(varWidth As String) As VBtn
sWidth = varWidth
...
'set x-large
Sub SetXLarge(varXLarge As Boolean) As VBtn
bXLarge = varXLarge
...
'set x-small
Sub SetXSmall(varXSmall As Boolean) As VBtn
bXSmall = varXSmall
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VBtn
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VBtn
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VBtn
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VBtn
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VBtn
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VBtn
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VBtn
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VBtn
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VBtn
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VBtn
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VBtn
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VBtn
...
AddAttr(bRetainFocusOnClick, "retain-focus-on-click")
...
Sub AddComponent(child As String) As VBtn
...
public Sub AddToParent(targetID As String) As VBtn
...
Sub AddToApp(vap As VueApp) As VBtn
	appLink = vap
	data = vap.data	
...
'set an event
Sub SetVOn(event As String) As VBtn
...
Sub SetCaption(varText As String) As VBtn
	If mElement <> Null Then
...
public Sub SetClasses(Classes As String) As VBtn
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VBtn
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VBtn
...
Sub SetStyles(m As Map) As VBtn
...
Sub SetAttrs(props As Map) As VBtn
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VBtn
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VBtn
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VBtn
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VBtn
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VBtn
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VBtn
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VBtn
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VBtn
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VBtn
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VBtn
	methodName = methodName.ToLowerCase
...
Sub Toggle As VBtn
	If sVShow = "" Then
		Log($"VBtn.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VBtn
	If sVShow = "" Then
		Log($"VBtn.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VBtn
	If sVShow = "" Then
		Log($"VBtn.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VBtn
	if svBindClass = "" then
		Log($"VBtn.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VBtn
	if svBindStyle = "" then
		Log($"VBtn.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'	If sDisabled = "" Then
'		Log($"VBtn.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
