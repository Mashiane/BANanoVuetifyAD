2020-07-08 02:37:07 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VBreadcrumbsDivider
#IgnoreWarnings:12
...
Private mTagName As String = "v-breadcrumbs-divider" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VBreadcrumbsDivider 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VBreadcrumbsDivider
...
'set key
Sub SetKey(varKey As String) As VBreadcrumbsDivider
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VBreadcrumbsDivider
...
'set readonly
Sub SetReadonly(varReadonly As String) As VBreadcrumbsDivider
...
'set ref
Sub SetRef(varRef As String) As VBreadcrumbsDivider
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VBreadcrumbsDivider
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VBreadcrumbsDivider
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VBreadcrumbsDivider
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VBreadcrumbsDivider
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VBreadcrumbsDivider
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VBreadcrumbsDivider
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VBreadcrumbsDivider
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VBreadcrumbsDivider
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VBreadcrumbsDivider
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VBreadcrumbsDivider
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VBreadcrumbsDivider
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VBreadcrumbsDivider
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VBreadcrumbsDivider
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VBreadcrumbsDivider
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VBreadcrumbsDivider
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VBreadcrumbsDivider
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VBreadcrumbsDivider
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VBreadcrumbsDivider
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VBreadcrumbsDivider
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VBreadcrumbsDivider
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VBreadcrumbsDivider
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VBreadcrumbsDivider
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VBreadcrumbsDivider
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VBreadcrumbsDivider
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VBreadcrumbsDivider
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VBreadcrumbsDivider
...
Sub AddComponent(child As String) As VBreadcrumbsDivider
...
Sub SetID(varText As String) As VBreadcrumbsDivider
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VBreadcrumbsDivider
...
Sub AddToApp(vap As VueApp) As VBreadcrumbsDivider
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VBreadcrumbsDivider
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VBreadcrumbsDivider
...
Sub SetCaption(varText As String) As VBreadcrumbsDivider
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VBreadcrumbsDivider
...
public Sub SetClasses(Classes As String) As VBreadcrumbsDivider
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VBreadcrumbsDivider
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VBreadcrumbsDivider
...
Sub SetStyles(m As Map) As VBreadcrumbsDivider
...
Sub SetAttrs(props As Map) As VBreadcrumbsDivider
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VBreadcrumbsDivider
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VBreadcrumbsDivider
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VBreadcrumbsDivider
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VBreadcrumbsDivider
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VBreadcrumbsDivider
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VBreadcrumbsDivider
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VBreadcrumbsDivider
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VBreadcrumbsDivider
...
'set text color
Sub SetTextColor1(varColor As String) As VBreadcrumbsDivider
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VBreadcrumbsDivider
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VBreadcrumbsDivider
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VBreadcrumbsDivider
	If sVShow = "" Then
		Log($"VBreadcrumbsDivider.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VBreadcrumbsDivider
	If sVShow = "" Then
		Log($"VBreadcrumbsDivider.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VBreadcrumbsDivider
	If sVShow = "" Then
		Log($"VBreadcrumbsDivider.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VBreadcrumbsDivider
	if svBindClass = "" then
		Log($"VBreadcrumbsDivider.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VBreadcrumbsDivider
	if svBindStyle = "" then
		Log($"VBreadcrumbsDivider.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VBreadcrumbsDivider
'	If sRequired = "" Then
'		Log($"VBreadcrumbsDivider.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VBreadcrumbsDivider
'	If sReadonly = "" Then
'		Log($"VBreadcrumbsDivider.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VBreadcrumbsDivider
'	If sDisabled = "" Then
'		Log($"VBreadcrumbsDivider.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
