...
#DesignerProperty: Key: BackgroundOpacity, DisplayName: BackgroundOpacity, Description: , DefaultValue: , FieldType: String
#DesignerProperty: Key: Bottom, DisplayName: Bottom, Description: , DefaultValue: false, FieldType: Boolean
#DesignerProperty: Key: BufferValue, DisplayName: BufferValue, Description: , DefaultValue: 100, FieldType: String
...
#DesignerProperty: Key: Height, DisplayName: Height, Description: , DefaultValue: 4, FieldType: String
...
#DesignerProperty: Key: Query, DisplayName: Query, Description: , DefaultValue: false, FieldType: Boolean
...
#DesignerProperty: Key: Stream, DisplayName: Stream, Description: , DefaultValue: false, FieldType: Boolean
#DesignerProperty: Key: Striped, DisplayName: Striped, Description: , DefaultValue: false, FieldType: Boolean
...
'set enabled
Sub SetEnabled(varEnabled As String) As VProgressLinear
sEnabled = varEnabled
...
Sub AddToApp(va As VueApp) As VProgressLinear
