...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VStepperItems
#IgnoreWarnings:12
...
Private mTagName As String = "v-stepper-items" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VStepperItems 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VStepperItems
...
'set key
Sub SetKey(varKey As String) As VStepperItems
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VStepperItems
...
'set readonly
Sub SetReadonly(varReadonly As String) As VStepperItems
...
'set ref
Sub SetRef(varRef As String) As VStepperItems
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VStepperItems
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VStepperItems
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VStepperItems
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VStepperItems
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VStepperItems
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VStepperItems
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VStepperItems
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VStepperItems
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VStepperItems
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VStepperItems
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VStepperItems
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VStepperItems
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VStepperItems
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VStepperItems
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VStepperItems
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VStepperItems
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VStepperItems
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VStepperItems
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VStepperItems
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VStepperItems
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VStepperItems
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VStepperItems
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VStepperItems
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VStepperItems
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VStepperItems
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VStepperItems
...
Sub AddComponent(child As String) As VStepperItems
...
Sub SetID(varText As String) As VStepperItems
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VStepperItems
...
Sub AddToApp(vap As VueApp) As VStepperItems
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VStepperItems
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VStepperItems
...
Sub SetCaption(varText As String) As VStepperItems
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VStepperItems
...
public Sub SetClasses(Classes As String) As VStepperItems
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VStepperItems
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VStepperItems
...
Sub SetStyles(m As Map) As VStepperItems
...
Sub SetAttrs(props As Map) As VStepperItems
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VStepperItems
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VStepperItems
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VStepperItems
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VStepperItems
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VStepperItems
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VStepperItems
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VStepperItems
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VStepperItems
...
'set text color
Sub SetTextColor1(varColor As String) As VStepperItems
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VStepperItems
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VStepperItems
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VStepperItems
	If sVShow = "" Then
		Log($"VStepperItems.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VStepperItems
	If sVShow = "" Then
		Log($"VStepperItems.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VStepperItems
	If sVShow = "" Then
		Log($"VStepperItems.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VStepperItems
	if svBindClass = "" then
		Log($"VStepperItems.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VStepperItems
	if svBindStyle = "" then
		Log($"VStepperItems.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VStepperItems
'	If sRequired = "" Then
'		Log($"VStepperItems.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VStepperItems
'	If sReadonly = "" Then
'		Log($"VStepperItems.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VStepperItems
'	If sDisabled = "" Then
'		Log($"VStepperItems.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
