...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VCardSubtitle
#IgnoreWarnings:12


#DesignerProperty: Key: Caption, DisplayName: Caption, Description: , FieldType: String, DefaultValue: Card Subtitle
...
Private mTagName As String = "v-card-subtitle" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCardSubtitle 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VCardSubtitle
...
'set key
Sub SetKey(varKey As String) As VCardSubtitle
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set readonly
Sub SetReadonly(varReadonly As String) As VCardSubtitle
...
'set ref
Sub SetRef(varRef As String) As VCardSubtitle
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VCardSubtitle
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCardSubtitle
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCardSubtitle
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCardSubtitle
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCardSubtitle
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VCardSubtitle
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VCardSubtitle
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCardSubtitle
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCardSubtitle
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCardSubtitle
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCardSubtitle
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCardSubtitle
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCardSubtitle
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCardSubtitle
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCardSubtitle
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCardSubtitle
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCardSubtitle
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCardSubtitle
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCardSubtitle
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCardSubtitle
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCardSubtitle
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCardSubtitle
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCardSubtitle
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCardSubtitle
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCardSubtitle
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCardSubtitle
...
Sub AddComponent(child As String) As VCardSubtitle
...
Sub SetID(varText As String) As VCardSubtitle
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCardSubtitle
...
Sub AddToApp(vap As VueApp) As VCardSubtitle
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCardSubtitle
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCardSubtitle
...
Sub SetCaption(varText As String) As VCardSubtitle
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VCardSubtitle
...
public Sub SetClasses(Classes As String) As VCardSubtitle
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCardSubtitle
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCardSubtitle
...
Sub SetStyles(m As Map) As VCardSubtitle
...
Sub SetAttrs(props As Map) As VCardSubtitle
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCardSubtitle
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCardSubtitle
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCardSubtitle
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCardSubtitle
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCardSubtitle
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCardSubtitle
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCardSubtitle
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCardSubtitle
...
'set text color
Sub SetTextColor1(varColor As String) As VCardSubtitle
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCardSubtitle
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCardSubtitle
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCardSubtitle
	If sVShow = "" Then
		Log($"VCardSubtitle.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCardSubtitle
	If sVShow = "" Then
		Log($"VCardSubtitle.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCardSubtitle
	If sVShow = "" Then
		Log($"VCardSubtitle.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCardSubtitle
	if svBindClass = "" then
		Log($"VCardSubtitle.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VCardSubtitle
	if svBindStyle = "" then
		Log($"VCardSubtitle.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
Sub SetRequiredOnOff(b As Boolean) As VCardSubtitle
	If sRequired = "" Then
		Log($"VCardSubtitle.Required - the required for ${mName} has not been set!"$)
		Return Me
	End If
...
'read only
Sub SetReadOnlyOnOff(b As Boolean) As VCardSubtitle
	If sReadonly = "" Then
		Log($"VCardSubtitle.ReadOnly - the readonly for ${mName} has not been set!"$)
		Return Me
	End If
...
'disabled
Sub SetDisabledOnOff(b As Boolean) As VCardSubtitle
	If sDisabled = "" Then
		Log($"VCardSubtitle.Disabled - the disabled for ${mName} has not been set!"$)
		Return Me
	End If
