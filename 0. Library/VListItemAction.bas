...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VListItemAction
#IgnoreWarnings:12
...
Private mTagName As String = "v-list-item-action" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VListItemAction 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemAction
...
'set key
Sub SetKey(varKey As String) As VListItemAction
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemAction
...
'set readonly
Sub SetReadonly(varReadonly As String) As VListItemAction
...
'set ref
Sub SetRef(varRef As String) As VListItemAction
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VListItemAction
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemAction
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemAction
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VListItemAction
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VListItemAction
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemAction
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VListItemAction
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VListItemAction
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VListItemAction
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VListItemAction
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VListItemAction
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VListItemAction
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VListItemAction
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VListItemAction
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemAction
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemAction
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemAction
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemAction
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemAction
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemAction
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemAction
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemAction
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemAction
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemAction
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemAction
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemAction
...
Sub AddComponent(child As String) As VListItemAction
...
Sub SetID(varText As String) As VListItemAction
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VListItemAction
...
Sub AddToApp(vap As VueApp) As VListItemAction
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemAction
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VListItemAction
...
Sub SetCaption(varText As String) As VListItemAction
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VListItemAction
...
public Sub SetClasses(Classes As String) As VListItemAction
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VListItemAction
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VListItemAction
...
Sub SetStyles(m As Map) As VListItemAction
...
Sub SetAttrs(props As Map) As VListItemAction
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VListItemAction
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VListItemAction
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VListItemAction
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VListItemAction
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VListItemAction
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemAction
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VListItemAction
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VListItemAction
...
'set text color
Sub SetTextColor1(varColor As String) As VListItemAction
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VListItemAction
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VListItemAction
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VListItemAction
	If sVShow = "" Then
		Log($"VListItemAction.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemAction
	If sVShow = "" Then
		Log($"VListItemAction.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemAction
	If sVShow = "" Then
		Log($"VListItemAction.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemAction
	if svBindClass = "" then
		Log($"VListItemAction.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemAction
	if svBindStyle = "" then
		Log($"VListItemAction.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemAction
'	If sRequired = "" Then
'		Log($"VListItemAction.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemAction
'	If sReadonly = "" Then
'		Log($"VListItemAction.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemAction
'	If sDisabled = "" Then
'		Log($"VListItemAction.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
