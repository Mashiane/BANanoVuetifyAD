2020-07-08 02:37:42 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VColorPickerCanvas
#IgnoreWarnings:12
...
Private mTagName As String = "v-color-picker-canvas" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VColorPickerCanvas 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VColorPickerCanvas
sColor = varColor
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VColorPickerCanvas
...
'set dot-size
Sub SetDotSize(varDotSize As String) As VColorPickerCanvas
sDotSize = varDotSize
...
'set height
Sub SetHeight(varHeight As String) As VColorPickerCanvas
sHeight = varHeight
...
'set key
Sub SetKey(varKey As String) As VColorPickerCanvas
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VColorPickerCanvas
...
'set readonly
Sub SetReadonly(varReadonly As String) As VColorPickerCanvas
...
'set ref
Sub SetRef(varRef As String) As VColorPickerCanvas
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VColorPickerCanvas
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VColorPickerCanvas
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VColorPickerCanvas
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VColorPickerCanvas
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VColorPickerCanvas
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VColorPickerCanvas
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VColorPickerCanvas
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VColorPickerCanvas
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VColorPickerCanvas
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VColorPickerCanvas
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VColorPickerCanvas
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VColorPickerCanvas
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VColorPickerCanvas
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VColorPickerCanvas
sVText = varVText
...
'set width
Sub SetWidth(varWidth As String) As VColorPickerCanvas
sWidth = varWidth
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VColorPickerCanvas
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VColorPickerCanvas
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VColorPickerCanvas
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VColorPickerCanvas
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VColorPickerCanvas
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VColorPickerCanvas
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VColorPickerCanvas
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VColorPickerCanvas
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VColorPickerCanvas
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VColorPickerCanvas
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VColorPickerCanvas
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VColorPickerCanvas
...
Sub AddComponent(child As String) As VColorPickerCanvas
...
Sub SetID(varText As String) As VColorPickerCanvas
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VColorPickerCanvas
...
Sub AddToApp(vap As VueApp) As VColorPickerCanvas
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VColorPickerCanvas
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VColorPickerCanvas
...
Sub SetCaption(varText As String) As VColorPickerCanvas
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VColorPickerCanvas
...
public Sub SetClasses(Classes As String) As VColorPickerCanvas
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VColorPickerCanvas
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VColorPickerCanvas
...
Sub SetStyles(m As Map) As VColorPickerCanvas
...
Sub SetAttrs(props As Map) As VColorPickerCanvas
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VColorPickerCanvas
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VColorPickerCanvas
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VColorPickerCanvas
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VColorPickerCanvas
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VColorPickerCanvas
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VColorPickerCanvas
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VColorPickerCanvas
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VColorPickerCanvas
...
'set text color
Sub SetTextColor1(varColor As String) As VColorPickerCanvas
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VColorPickerCanvas
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VColorPickerCanvas
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VColorPickerCanvas
	If sVShow = "" Then
		Log($"VColorPickerCanvas.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VColorPickerCanvas
	If sVShow = "" Then
		Log($"VColorPickerCanvas.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VColorPickerCanvas
	If sVShow = "" Then
		Log($"VColorPickerCanvas.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VColorPickerCanvas
	if svBindClass = "" then
		Log($"VColorPickerCanvas.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VColorPickerCanvas
	if svBindStyle = "" then
		Log($"VColorPickerCanvas.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VColorPickerCanvas
'	If sRequired = "" Then
'		Log($"VColorPickerCanvas.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VColorPickerCanvas
'	If sReadonly = "" Then
'		Log($"VColorPickerCanvas.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VColorPickerCanvas
'	If sDisabled = "" Then
'		Log($"VColorPickerCanvas.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
