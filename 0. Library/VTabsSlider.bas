2020-07-08 02:39:50 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VTabsSlider
#IgnoreWarnings:12
...
Private mTagName As String = "v-tabs-slider" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VTabsSlider 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VTabsSlider
sColor = varColor
...
'set disabled
Sub SetDisabled(varDisabled As String) As VTabsSlider
...
'set key
Sub SetKey(varKey As String) As VTabsSlider
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VTabsSlider
...
'set readonly
Sub SetReadonly(varReadonly As String) As VTabsSlider
...
'set ref
Sub SetRef(varRef As String) As VTabsSlider
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VTabsSlider
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTabsSlider
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTabsSlider
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VTabsSlider
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VTabsSlider
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTabsSlider
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VTabsSlider
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VTabsSlider
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VTabsSlider
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VTabsSlider
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VTabsSlider
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VTabsSlider
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VTabsSlider
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VTabsSlider
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTabsSlider
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTabsSlider
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTabsSlider
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTabsSlider
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTabsSlider
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTabsSlider
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTabsSlider
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTabsSlider
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTabsSlider
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTabsSlider
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTabsSlider
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTabsSlider
...
Sub AddComponent(child As String) As VTabsSlider
...
Sub SetID(varText As String) As VTabsSlider
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VTabsSlider
...
Sub AddToApp(vap As VueApp) As VTabsSlider
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTabsSlider
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VTabsSlider
...
Sub SetCaption(varText As String) As VTabsSlider
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VTabsSlider
...
public Sub SetClasses(Classes As String) As VTabsSlider
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VTabsSlider
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VTabsSlider
...
Sub SetStyles(m As Map) As VTabsSlider
...
Sub SetAttrs(props As Map) As VTabsSlider
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VTabsSlider
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VTabsSlider
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VTabsSlider
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VTabsSlider
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VTabsSlider
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTabsSlider
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VTabsSlider
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VTabsSlider
...
'set text color
Sub SetTextColor1(varColor As String) As VTabsSlider
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VTabsSlider
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VTabsSlider
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VTabsSlider
	If sVShow = "" Then
		Log($"VTabsSlider.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTabsSlider
	If sVShow = "" Then
		Log($"VTabsSlider.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTabsSlider
	If sVShow = "" Then
		Log($"VTabsSlider.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTabsSlider
	if svBindClass = "" then
		Log($"VTabsSlider.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTabsSlider
	if svBindStyle = "" then
		Log($"VTabsSlider.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTabsSlider
'	If sRequired = "" Then
'		Log($"VTabsSlider.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTabsSlider
'	If sReadonly = "" Then
'		Log($"VTabsSlider.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTabsSlider
'	If sDisabled = "" Then
'		Log($"VTabsSlider.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
