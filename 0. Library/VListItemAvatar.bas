...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemAvatar
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemAvatar
...
'set rounded
Sub SetRounded(varRounded As String) As VListItemAvatar
sRounded = varRounded
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemAvatar
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemAvatar
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemAvatar
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemAvatar
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemAvatar
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemAvatar
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemAvatar
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemAvatar
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemAvatar
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemAvatar
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemAvatar
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemAvatar
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemAvatar
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemAvatar
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemAvatar
...
Sub AddToApp(vap As VueApp) As VListItemAvatar
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemAvatar
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VListItemAvatar
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemAvatar
...
'toggle
Sub Toggle As VListItemAvatar
	If sVShow = "" Then
		Log($"VListItemAvatar.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemAvatar
	If sVShow = "" Then
		Log($"VListItemAvatar.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemAvatar
	If sVShow = "" Then
		Log($"VListItemAvatar.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemAvatar
	if svBindClass = "" then
		Log($"VListItemAvatar.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemAvatar
	if svBindStyle = "" then
		Log($"VListItemAvatar.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemAvatar
'	If sRequired = "" Then
'		Log($"VListItemAvatar.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemAvatar
'	If sReadonly = "" Then
'		Log($"VListItemAvatar.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemAvatar
'	If sDisabled = "" Then
'		Log($"VListItemAvatar.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
