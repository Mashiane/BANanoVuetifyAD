...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VListItemActionText
#IgnoreWarnings:12
...
Private mTagName As String = "v-list-item-action-text" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VListItemActionText 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemActionText
...
'set key
Sub SetKey(varKey As String) As VListItemActionText
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemActionText
...
'set readonly
Sub SetReadonly(varReadonly As String) As VListItemActionText
...
'set ref
Sub SetRef(varRef As String) As VListItemActionText
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VListItemActionText
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemActionText
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemActionText
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VListItemActionText
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VListItemActionText
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemActionText
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VListItemActionText
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VListItemActionText
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VListItemActionText
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VListItemActionText
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VListItemActionText
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VListItemActionText
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VListItemActionText
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VListItemActionText
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemActionText
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemActionText
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemActionText
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemActionText
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemActionText
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemActionText
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemActionText
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemActionText
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemActionText
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemActionText
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemActionText
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemActionText
...
Sub AddComponent(child As String) As VListItemActionText
...
Sub SetID(varText As String) As VListItemActionText
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VListItemActionText
...
Sub AddToApp(vap As VueApp) As VListItemActionText
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemActionText
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VListItemActionText
...
Sub SetCaption(varText As String) As VListItemActionText
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VListItemActionText
...
public Sub SetClasses(Classes As String) As VListItemActionText
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VListItemActionText
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VListItemActionText
...
Sub SetStyles(m As Map) As VListItemActionText
...
Sub SetAttrs(props As Map) As VListItemActionText
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VListItemActionText
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VListItemActionText
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VListItemActionText
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VListItemActionText
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VListItemActionText
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemActionText
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VListItemActionText
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VListItemActionText
...
'set text color
Sub SetTextColor1(varColor As String) As VListItemActionText
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VListItemActionText
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VListItemActionText
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VListItemActionText
	If sVShow = "" Then
		Log($"VListItemActionText.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemActionText
	If sVShow = "" Then
		Log($"VListItemActionText.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemActionText
	If sVShow = "" Then
		Log($"VListItemActionText.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemActionText
	if svBindClass = "" then
		Log($"VListItemActionText.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemActionText
	if svBindStyle = "" then
		Log($"VListItemActionText.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemActionText
'	If sRequired = "" Then
'		Log($"VListItemActionText.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemActionText
'	If sReadonly = "" Then
'		Log($"VListItemActionText.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemActionText
'	If sDisabled = "" Then
'		Log($"VListItemActionText.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
