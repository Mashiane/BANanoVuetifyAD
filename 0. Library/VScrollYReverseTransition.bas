2020-07-08 02:39:17 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VScrollYReverseTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-scroll-y-reverse-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VScrollYReverseTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VScrollYReverseTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VScrollYReverseTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VScrollYReverseTransition
...
'set key
Sub SetKey(varKey As String) As VScrollYReverseTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VScrollYReverseTransition
...
'set mode
Sub SetMode(varMode As String) As VScrollYReverseTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VScrollYReverseTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VScrollYReverseTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VScrollYReverseTransition
...
'set ref
Sub SetRef(varRef As String) As VScrollYReverseTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VScrollYReverseTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VScrollYReverseTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VScrollYReverseTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VScrollYReverseTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VScrollYReverseTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VScrollYReverseTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VScrollYReverseTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VScrollYReverseTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VScrollYReverseTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VScrollYReverseTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VScrollYReverseTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VScrollYReverseTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VScrollYReverseTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VScrollYReverseTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VScrollYReverseTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VScrollYReverseTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VScrollYReverseTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VScrollYReverseTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VScrollYReverseTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VScrollYReverseTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VScrollYReverseTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VScrollYReverseTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VScrollYReverseTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VScrollYReverseTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VScrollYReverseTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VScrollYReverseTransition
...
Sub AddComponent(child As String) As VScrollYReverseTransition
...
Sub SetID(varText As String) As VScrollYReverseTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VScrollYReverseTransition
...
Sub AddToApp(vap As VueApp) As VScrollYReverseTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VScrollYReverseTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VScrollYReverseTransition
...
Sub SetCaption(varText As String) As VScrollYReverseTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VScrollYReverseTransition
...
public Sub SetClasses(Classes As String) As VScrollYReverseTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VScrollYReverseTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VScrollYReverseTransition
...
Sub SetStyles(m As Map) As VScrollYReverseTransition
...
Sub SetAttrs(props As Map) As VScrollYReverseTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VScrollYReverseTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VScrollYReverseTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VScrollYReverseTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VScrollYReverseTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VScrollYReverseTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VScrollYReverseTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VScrollYReverseTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VScrollYReverseTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VScrollYReverseTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VScrollYReverseTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VScrollYReverseTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VScrollYReverseTransition
	If sVShow = "" Then
		Log($"VScrollYReverseTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VScrollYReverseTransition
	If sVShow = "" Then
		Log($"VScrollYReverseTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VScrollYReverseTransition
	If sVShow = "" Then
		Log($"VScrollYReverseTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VScrollYReverseTransition
	if svBindClass = "" then
		Log($"VScrollYReverseTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VScrollYReverseTransition
	if svBindStyle = "" then
		Log($"VScrollYReverseTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VScrollYReverseTransition
'	If sRequired = "" Then
'		Log($"VScrollYReverseTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VScrollYReverseTransition
'	If sReadonly = "" Then
'		Log($"VScrollYReverseTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VScrollYReverseTransition
'	If sDisabled = "" Then
'		Log($"VScrollYReverseTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
