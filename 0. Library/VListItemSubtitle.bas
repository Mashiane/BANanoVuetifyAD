...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VListItemSubtitle
#IgnoreWarnings:12
...
Private mTagName As String = "v-list-item-subtitle" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VListItemSubtitle 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemSubtitle
...
'set key
Sub SetKey(varKey As String) As VListItemSubtitle
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemSubtitle
...
'set readonly
Sub SetReadonly(varReadonly As String) As VListItemSubtitle
...
'set ref
Sub SetRef(varRef As String) As VListItemSubtitle
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VListItemSubtitle
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemSubtitle
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemSubtitle
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VListItemSubtitle
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VListItemSubtitle
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemSubtitle
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VListItemSubtitle
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VListItemSubtitle
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VListItemSubtitle
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VListItemSubtitle
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VListItemSubtitle
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VListItemSubtitle
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VListItemSubtitle
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VListItemSubtitle
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemSubtitle
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemSubtitle
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemSubtitle
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemSubtitle
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemSubtitle
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemSubtitle
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemSubtitle
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemSubtitle
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemSubtitle
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemSubtitle
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemSubtitle
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemSubtitle
...
Sub AddComponent(child As String) As VListItemSubtitle
...
Sub SetID(varText As String) As VListItemSubtitle
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VListItemSubtitle
...
Sub AddToApp(vap As VueApp) As VListItemSubtitle
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemSubtitle
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VListItemSubtitle
...
Sub SetCaption(varText As String) As VListItemSubtitle
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VListItemSubtitle
...
public Sub SetClasses(Classes As String) As VListItemSubtitle
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VListItemSubtitle
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VListItemSubtitle
...
Sub SetStyles(m As Map) As VListItemSubtitle
...
Sub SetAttrs(props As Map) As VListItemSubtitle
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VListItemSubtitle
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VListItemSubtitle
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VListItemSubtitle
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VListItemSubtitle
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VListItemSubtitle
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemSubtitle
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VListItemSubtitle
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VListItemSubtitle
...
'set text color
Sub SetTextColor1(varColor As String) As VListItemSubtitle
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VListItemSubtitle
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VListItemSubtitle
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VListItemSubtitle
	If sVShow = "" Then
		Log($"VListItemSubtitle.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemSubtitle
	If sVShow = "" Then
		Log($"VListItemSubtitle.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemSubtitle
	If sVShow = "" Then
		Log($"VListItemSubtitle.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemSubtitle
	if svBindClass = "" then
		Log($"VListItemSubtitle.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemSubtitle
	if svBindStyle = "" then
		Log($"VListItemSubtitle.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemSubtitle
'	If sRequired = "" Then
'		Log($"VListItemSubtitle.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemSubtitle
'	If sReadonly = "" Then
'		Log($"VListItemSubtitle.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemSubtitle
'	If sDisabled = "" Then
'		Log($"VListItemSubtitle.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
