...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VToolbarTitle
#IgnoreWarnings:12
...
Private mTagName As String = "v-toolbar-title" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VToolbarTitle 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VToolbarTitle
...
'set key
Sub SetKey(varKey As String) As VToolbarTitle
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VToolbarTitle
...
'set readonly
Sub SetReadonly(varReadonly As String) As VToolbarTitle
...
'set ref
Sub SetRef(varRef As String) As VToolbarTitle
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VToolbarTitle
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VToolbarTitle
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VToolbarTitle
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VToolbarTitle
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VToolbarTitle
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VToolbarTitle
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VToolbarTitle
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VToolbarTitle
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VToolbarTitle
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VToolbarTitle
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VToolbarTitle
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VToolbarTitle
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VToolbarTitle
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VToolbarTitle
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VToolbarTitle
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VToolbarTitle
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VToolbarTitle
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VToolbarTitle
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VToolbarTitle
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VToolbarTitle
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VToolbarTitle
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VToolbarTitle
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VToolbarTitle
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VToolbarTitle
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VToolbarTitle
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VToolbarTitle
...
Sub AddComponent(child As String) As VToolbarTitle
...
Sub SetID(varText As String) As VToolbarTitle
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VToolbarTitle
...
Sub AddToApp(vap As VueApp) As VToolbarTitle
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VToolbarTitle
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VToolbarTitle
...
Sub SetCaption(varText As String) As VToolbarTitle
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VToolbarTitle
...
public Sub SetClasses(Classes As String) As VToolbarTitle
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VToolbarTitle
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VToolbarTitle
...
Sub SetStyles(m As Map) As VToolbarTitle
...
Sub SetAttrs(props As Map) As VToolbarTitle
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VToolbarTitle
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VToolbarTitle
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VToolbarTitle
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VToolbarTitle
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VToolbarTitle
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VToolbarTitle
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VToolbarTitle
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VToolbarTitle
...
'set text color
Sub SetTextColor1(varColor As String) As VToolbarTitle
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VToolbarTitle
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VToolbarTitle
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VToolbarTitle
	If sVShow = "" Then
		Log($"VToolbarTitle.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VToolbarTitle
	If sVShow = "" Then
		Log($"VToolbarTitle.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VToolbarTitle
	If sVShow = "" Then
		Log($"VToolbarTitle.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VToolbarTitle
	if svBindClass = "" then
		Log($"VToolbarTitle.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VToolbarTitle
	if svBindStyle = "" then
		Log($"VToolbarTitle.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VToolbarTitle
'	If sRequired = "" Then
'		Log($"VToolbarTitle.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VToolbarTitle
'	If sReadonly = "" Then
'		Log($"VToolbarTitle.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VToolbarTitle
'	If sDisabled = "" Then
'		Log($"VToolbarTitle.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
