...
#DesignerProperty: Key: LazyValidation, DisplayName: LazyValidation, Description: , DefaultValue: false, FieldType: Boolean
...
'set enabled
Sub SetEnabled(varEnabled As String) As VForm
sEnabled = varEnabled
...
Sub AddToApp(va As VueApp) As VForm
