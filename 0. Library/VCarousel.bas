...
#DesignerProperty: Key: Continuous, DisplayName: Continuous, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Cycle, DisplayName: Cycle, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Dark, DisplayName: Dark, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: DelimiterIcon, DisplayName: DelimiterIcon, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: HideDelimiterBackground, DisplayName: HideDelimiterBackground, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: HideDelimiters, DisplayName: HideDelimiters, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Interval, DisplayName: Interval, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: ShowArrowsOnHover, DisplayName: ShowArrowsOnHover, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Touch, DisplayName: Touch, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: VerticalDelimiters, DisplayName: VerticalDelimiters, Description: , FieldType: String, DefaultValue: 
...
Private bCycle As Boolean = False
Private bDark As Boolean = False
Private sDelimiterIcon As String = ""
Private sDisabled As String = ""
Private sHeight As String = ""
Private bHideDelimiterBackground As Boolean = False
Private bHideDelimiters As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCarousel 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VCarousel
...
'set continuous
Sub SetContinuous(varContinuous As Boolean) As VCarousel
...
'set cycle
Sub SetCycle(varCycle As Boolean) As VCarousel
bCycle = varCycle
SetAttr("cycle", bCycle)
Return Me
End Sub

'set dark
Sub SetDark(varDark As Boolean) As VCarousel
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set delimiter-icon
Sub SetDelimiterIcon(varDelimiterIcon As String) As VCarousel
sDelimiterIcon = varDelimiterIcon
SetAttr("delimiter-icon", sDelimiterIcon)
Return Me
End Sub

'set disabled
Sub SetDisabled(varDisabled As String) As VCarousel
...
'set height
Sub SetHeight(varHeight As String) As VCarousel
sHeight = varHeight
...
Sub SetHideDelimiterBackground(varHideDelimiterBackground As Boolean) As VCarousel
bHideDelimiterBackground = varHideDelimiterBackground
SetAttr("hide-delimiter-background", bHideDelimiterBackground)
Return Me
End Sub

'set hide-delimiters
Sub SetHideDelimiters(varHideDelimiters As Boolean) As VCarousel
bHideDelimiters = varHideDelimiters
SetAttr("hide-delimiters", bHideDelimiters)
Return Me
End Sub

'set interval
Sub SetInterval(varInterval As String) As VCarousel
sInterval = varInterval
SetAttr("interval", sInterval)
Return Me
End Sub

'set key
Sub SetKey(varKey As String) As VCarousel
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VCarousel
bLight = varLight
...
'set mandatory
Sub SetMandatory(varMandatory As Boolean) As VCarousel
...
'set max
Sub SetMax(varMax As String) As VCarousel
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set multiple
Sub SetMultiple(varMultiple As Boolean) As VCarousel
...
'set prev-icon
Sub SetPrevIcon(varPrevIcon As String) As VCarousel
...
'set progress
Sub SetProgress(varProgress As Boolean) As VCarousel
bProgress = varProgress
SetAttr("progress", bProgress)
Return Me
End Sub

'set progress-color
Sub SetProgressColor(varProgressColor As String) As VCarousel
sProgressColor = varProgressColor
SetAttr("progress-color", sProgressColor)
Return Me
End Sub

'set readonly
Sub SetReadonly(varReadonly As String) As VCarousel
...
'set ref
Sub SetRef(varRef As String) As VCarousel
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VCarousel
...
'set reverse
Sub SetReverse(varReverse As Boolean) As VCarousel
bReverse = varReverse
...
'set show-arrows
Sub SetShowArrows(varShowArrows As Boolean) As VCarousel
...
Sub SetShowArrowsOnHover(varShowArrowsOnHover As Boolean) As VCarousel
...
'set touch
Sub SetTouch(varTouch As String) As VCarousel
sTouch = varTouch
SetAttr("touch", sTouch)
Return Me
End Sub

'set touchless
Sub SetTouchless(varTouchless As Boolean) As VCarousel
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCarousel
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCarousel
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCarousel
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCarousel
sVElse = varVElse
...
'set v-for
Sub SetVFor(varVFor As String) As VCarousel
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCarousel
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCarousel
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCarousel
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCarousel
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCarousel
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCarousel
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCarousel
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VCarousel
sValue = varValue
...
'set vertical
Sub SetVertical(varVertical As Boolean) As VCarousel
...
Sub SetVerticalDelimiters(varVerticalDelimiters As String) As VCarousel
sVerticalDelimiters = varVerticalDelimiters
SetAttr("vertical-delimiters", sVerticalDelimiters)
Return Me
End Sub

'set border-color
Sub SetBorderColor(varBorderColor As String) As VCarousel
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCarousel
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCarousel
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCarousel
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCarousel
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCarousel
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCarousel
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCarousel
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCarousel
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCarousel
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCarousel
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCarousel
...
AddAttr(bCycle, "cycle")
AddAttr(bDark, "dark")
AddAttr(sDelimiterIcon, "delimiter-icon")
AddAttr(sDisabled, "disabled")
AddAttr(sHeight, "height")
AddAttr(bHideDelimiterBackground, "hide-delimiter-background")
AddAttr(bHideDelimiters, "hide-delimiters")
AddAttr(sInterval, "interval")
AddAttr(sKey, "key")
...
AddAttr(sVerticalDelimiters, "vertical-delimiters")
SetStyleSingle("border-color", sBorderColor)
SetStyleSingle("border-style", sBorderStyle)
SetStyleSingle("border-width", sBorderWidth)
SetStyleSingle("border-radius", sBorderRadius)
...
Sub AddComponent(child As String) As VCarousel
...
Sub SetID(varText As String) As VCarousel
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCarousel
...
Sub AddToApp(vap As VueApp) As VCarousel
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCarousel
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCarousel
...
Sub SetCaption(varText As String) As VCarousel
	If mElement <> Null Then
...
public Sub SetClasses(Classes As String) As VCarousel
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCarousel
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCarousel
...
Sub SetStyles(m As Map) As VCarousel
...
Sub SetAttrs(props As Map) As VCarousel
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCarousel
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCarousel
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCarousel
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCarousel
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCarousel
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCarousel
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCarousel
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCarousel
...
'set text color
Sub SetTextColor1(varColor As String) As VCarousel
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCarousel
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCarousel
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCarousel
	If sVShow = "" Then
		Log($"VCarousel.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCarousel
	If sVShow = "" Then
		Log($"VCarousel.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCarousel
	If sVShow = "" Then
		Log($"VCarousel.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCarousel
	if svBindClass = "" then
		Log($"VCarousel.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VCarousel
	if svBindStyle = "" then
		Log($"VCarousel.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
