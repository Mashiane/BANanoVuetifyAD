...
#DesignerProperty: Key: HideOnLeave, DisplayName: HideOnLeave, FieldType: Boolean, DefaultValue: false , Description: Set hide-on-leave
#DesignerProperty: Key: LeaveAbsolute, DisplayName: LeaveAbsolute, FieldType: Boolean, DefaultValue: false , Description: Set leave-absolute
...
Sub Class_Globals
	...
	Public bHideOnLeave As Boolean = false
	Public bLeaveAbsolute As Boolean = false
	Public sMode As String = ""
	Public sOrigin As String = "top center 0"
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bHideOnLeave, "b", "hide-on-leave")
		AddAttr(Attributes, bLeaveAbsolute, "b", "leave-absolute")
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean)
	bHideOnLeave = varHideOnLeave
	mElement.SetAttr("hide-on-leave", bHideOnLeave)
End Sub

'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean)
	bLeaveAbsolute = varLeaveAbsolute
	mElement.SetAttr("leave-absolute", bLeaveAbsolute)
End Sub
