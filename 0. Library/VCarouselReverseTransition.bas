2020-07-08 02:37:31 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VCarouselReverseTransition
#IgnoreWarnings:12
...
#DesignerProperty: Key: Group, DisplayName: Group, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: HideOnLeave, DisplayName: HideOnLeave, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Key, DisplayName: Key, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: LeaveAbsolute, DisplayName: LeaveAbsolute, Description: , FieldType: Boolean, DefaultValue: False
...
Private mTagName As String = "v-carousel-reverse-transition" 
	Public bindings As Map 
	Public methods As Map
Private sCaption As String = ""
Private sDisabled As String = ""
Private bGroup As Boolean = False
Private bHideOnLeave As Boolean = False
Private sKey As String = ""
Private bLeaveAbsolute As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCarouselReverseTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VCarouselReverseTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VCarouselReverseTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VCarouselReverseTransition
bHideOnLeave = varHideOnLeave
SetAttr("hide-on-leave", bHideOnLeave)
Return Me
End Sub

'set key
Sub SetKey(varKey As String) As VCarouselReverseTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VCarouselReverseTransition
bLeaveAbsolute = varLeaveAbsolute
SetAttr("leave-absolute", bLeaveAbsolute)
Return Me
End Sub

'set mode
Sub SetMode(varMode As String) As VCarouselReverseTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VCarouselReverseTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VCarouselReverseTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VCarouselReverseTransition
...
'set ref
Sub SetRef(varRef As String) As VCarouselReverseTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VCarouselReverseTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCarouselReverseTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCarouselReverseTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCarouselReverseTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCarouselReverseTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VCarouselReverseTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VCarouselReverseTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCarouselReverseTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCarouselReverseTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCarouselReverseTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCarouselReverseTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCarouselReverseTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCarouselReverseTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCarouselReverseTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCarouselReverseTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCarouselReverseTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCarouselReverseTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCarouselReverseTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCarouselReverseTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCarouselReverseTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCarouselReverseTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCarouselReverseTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCarouselReverseTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCarouselReverseTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCarouselReverseTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCarouselReverseTransition
...
AddAttr(bHideOnLeave, "hide-on-leave")
AddAttr(sKey, "key")
AddAttr(bLeaveAbsolute, "leave-absolute")
AddAttr(sMode, "mode")
...
Sub AddComponent(child As String) As VCarouselReverseTransition
...
Sub SetID(varText As String) As VCarouselReverseTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCarouselReverseTransition
...
Sub AddToApp(vap As VueApp) As VCarouselReverseTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCarouselReverseTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCarouselReverseTransition
...
Sub SetCaption(varText As String) As VCarouselReverseTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VCarouselReverseTransition
...
public Sub SetClasses(Classes As String) As VCarouselReverseTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCarouselReverseTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCarouselReverseTransition
...
Sub SetStyles(m As Map) As VCarouselReverseTransition
...
Sub SetAttrs(props As Map) As VCarouselReverseTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCarouselReverseTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCarouselReverseTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCarouselReverseTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCarouselReverseTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCarouselReverseTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCarouselReverseTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCarouselReverseTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCarouselReverseTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VCarouselReverseTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCarouselReverseTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCarouselReverseTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCarouselReverseTransition
	If sVShow = "" Then
		Log($"VCarouselReverseTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCarouselReverseTransition
	If sVShow = "" Then
		Log($"VCarouselReverseTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCarouselReverseTransition
	If sVShow = "" Then
		Log($"VCarouselReverseTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCarouselReverseTransition
	if svBindClass = "" then
		Log($"VCarouselReverseTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VCarouselReverseTransition
	if svBindStyle = "" then
		Log($"VCarouselReverseTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VCarouselReverseTransition
'	If sRequired = "" Then
'		Log($"VCarouselReverseTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VCarouselReverseTransition
'	If sReadonly = "" Then
'		Log($"VCarouselReverseTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VCarouselReverseTransition
'	If sDisabled = "" Then
'		Log($"VCarouselReverseTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
