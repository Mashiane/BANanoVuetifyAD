2020-07-08 02:39:19 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VScrollYTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-scroll-y-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VScrollYTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VScrollYTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VScrollYTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VScrollYTransition
...
'set key
Sub SetKey(varKey As String) As VScrollYTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VScrollYTransition
...
'set mode
Sub SetMode(varMode As String) As VScrollYTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VScrollYTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VScrollYTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VScrollYTransition
...
'set ref
Sub SetRef(varRef As String) As VScrollYTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VScrollYTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VScrollYTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VScrollYTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VScrollYTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VScrollYTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VScrollYTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VScrollYTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VScrollYTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VScrollYTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VScrollYTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VScrollYTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VScrollYTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VScrollYTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VScrollYTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VScrollYTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VScrollYTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VScrollYTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VScrollYTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VScrollYTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VScrollYTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VScrollYTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VScrollYTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VScrollYTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VScrollYTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VScrollYTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VScrollYTransition
...
Sub AddComponent(child As String) As VScrollYTransition
...
Sub SetID(varText As String) As VScrollYTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VScrollYTransition
...
Sub AddToApp(vap As VueApp) As VScrollYTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VScrollYTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VScrollYTransition
...
Sub SetCaption(varText As String) As VScrollYTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VScrollYTransition
...
public Sub SetClasses(Classes As String) As VScrollYTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VScrollYTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VScrollYTransition
...
Sub SetStyles(m As Map) As VScrollYTransition
...
Sub SetAttrs(props As Map) As VScrollYTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VScrollYTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VScrollYTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VScrollYTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VScrollYTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VScrollYTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VScrollYTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VScrollYTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VScrollYTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VScrollYTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VScrollYTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VScrollYTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VScrollYTransition
	If sVShow = "" Then
		Log($"VScrollYTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VScrollYTransition
	If sVShow = "" Then
		Log($"VScrollYTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VScrollYTransition
	If sVShow = "" Then
		Log($"VScrollYTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VScrollYTransition
	if svBindClass = "" then
		Log($"VScrollYTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VScrollYTransition
	if svBindStyle = "" then
		Log($"VScrollYTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VScrollYTransition
'	If sRequired = "" Then
'		Log($"VScrollYTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VScrollYTransition
'	If sReadonly = "" Then
'		Log($"VScrollYTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VScrollYTransition
'	If sDisabled = "" Then
'		Log($"VScrollYTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
