...
#DesignerProperty: Key: AmpmReadonly, DisplayName: AmpmReadonly, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Second, DisplayName: Second, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Selecting, DisplayName: Selecting, Description: , FieldType: String, DefaultValue: 
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTimePickerTitle
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTimePickerTitle
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTimePickerTitle
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTimePickerTitle
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTimePickerTitle
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTimePickerTitle
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTimePickerTitle
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTimePickerTitle
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTimePickerTitle
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTimePickerTitle
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTimePickerTitle
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTimePickerTitle
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTimePickerTitle
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTimePickerTitle
...
Sub SetOnClick1() As VTimePickerTitle
...
Sub AddToApp(vap As VueApp) As VTimePickerTitle
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTimePickerTitle
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VTimePickerTitle
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTimePickerTitle
...
'toggle
Sub Toggle As VTimePickerTitle
	If sVShow = "" Then
		Log($"VTimePickerTitle.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTimePickerTitle
	If sVShow = "" Then
		Log($"VTimePickerTitle.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTimePickerTitle
	If sVShow = "" Then
		Log($"VTimePickerTitle.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTimePickerTitle
	if svBindClass = "" then
		Log($"VTimePickerTitle.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTimePickerTitle
	if svBindStyle = "" then
		Log($"VTimePickerTitle.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
