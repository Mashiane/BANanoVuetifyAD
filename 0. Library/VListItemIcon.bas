...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VListItemIcon
#IgnoreWarnings:12
...
Private mTagName As String = "v-list-item-icon" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VListItemIcon 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemIcon
...
'set key
Sub SetKey(varKey As String) As VListItemIcon
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemIcon
...
'set readonly
Sub SetReadonly(varReadonly As String) As VListItemIcon
...
'set ref
Sub SetRef(varRef As String) As VListItemIcon
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VListItemIcon
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemIcon
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemIcon
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VListItemIcon
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VListItemIcon
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemIcon
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VListItemIcon
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VListItemIcon
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VListItemIcon
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VListItemIcon
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VListItemIcon
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VListItemIcon
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VListItemIcon
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VListItemIcon
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemIcon
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemIcon
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemIcon
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemIcon
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemIcon
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemIcon
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemIcon
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemIcon
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemIcon
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemIcon
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemIcon
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemIcon
...
Sub AddComponent(child As String) As VListItemIcon
...
Sub SetID(varText As String) As VListItemIcon
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VListItemIcon
...
Sub AddToApp(vap As VueApp) As VListItemIcon
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemIcon
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VListItemIcon
...
Sub SetCaption(varText As String) As VListItemIcon
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VListItemIcon
...
public Sub SetClasses(Classes As String) As VListItemIcon
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VListItemIcon
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VListItemIcon
...
Sub SetStyles(m As Map) As VListItemIcon
...
Sub SetAttrs(props As Map) As VListItemIcon
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VListItemIcon
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VListItemIcon
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VListItemIcon
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VListItemIcon
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VListItemIcon
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemIcon
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VListItemIcon
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VListItemIcon
...
'set text color
Sub SetTextColor1(varColor As String) As VListItemIcon
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VListItemIcon
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VListItemIcon
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VListItemIcon
	If sVShow = "" Then
		Log($"VListItemIcon.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemIcon
	If sVShow = "" Then
		Log($"VListItemIcon.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemIcon
	If sVShow = "" Then
		Log($"VListItemIcon.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemIcon
	if svBindClass = "" then
		Log($"VListItemIcon.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemIcon
	if svBindStyle = "" then
		Log($"VListItemIcon.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemIcon
'	If sRequired = "" Then
'		Log($"VListItemIcon.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemIcon
'	If sReadonly = "" Then
'		Log($"VListItemIcon.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemIcon
'	If sDisabled = "" Then
'		Log($"VListItemIcon.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
