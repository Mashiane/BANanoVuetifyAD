2020-07-08 02:39:46 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VTabTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-tab-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VTabTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VTabTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VTabTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VTabTransition
...
'set key
Sub SetKey(varKey As String) As VTabTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VTabTransition
...
'set mode
Sub SetMode(varMode As String) As VTabTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VTabTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VTabTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VTabTransition
...
'set ref
Sub SetRef(varRef As String) As VTabTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VTabTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTabTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTabTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VTabTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VTabTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTabTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VTabTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VTabTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VTabTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VTabTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VTabTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VTabTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VTabTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VTabTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTabTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTabTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTabTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTabTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTabTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTabTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTabTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTabTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTabTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTabTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTabTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTabTransition
...
Sub AddComponent(child As String) As VTabTransition
...
Sub SetID(varText As String) As VTabTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VTabTransition
...
Sub AddToApp(vap As VueApp) As VTabTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTabTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VTabTransition
...
Sub SetCaption(varText As String) As VTabTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VTabTransition
...
public Sub SetClasses(Classes As String) As VTabTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VTabTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VTabTransition
...
Sub SetStyles(m As Map) As VTabTransition
...
Sub SetAttrs(props As Map) As VTabTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VTabTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VTabTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VTabTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VTabTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VTabTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTabTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VTabTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VTabTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VTabTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VTabTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VTabTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VTabTransition
	If sVShow = "" Then
		Log($"VTabTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTabTransition
	If sVShow = "" Then
		Log($"VTabTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTabTransition
	If sVShow = "" Then
		Log($"VTabTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTabTransition
	if svBindClass = "" then
		Log($"VTabTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTabTransition
	if svBindStyle = "" then
		Log($"VTabTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTabTransition
'	If sRequired = "" Then
'		Log($"VTabTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTabTransition
'	If sReadonly = "" Then
'		Log($"VTabTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTabTransition
'	If sDisabled = "" Then
'		Log($"VTabTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
