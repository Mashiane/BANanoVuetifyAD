...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VExpansionPanelHeader
#IgnoreWarnings:12
...
#DesignerProperty: Key: DisableIconRotate, DisplayName: DisableIconRotate, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: HideActions, DisplayName: HideActions, Description: , FieldType: Boolean, DefaultValue: False
...
Private mTagName As String = "v-expansion-panel-header" 
	Public bindings As Map 
	Public methods As Map
Private sCaption As String = ""
Private sColor As String = ""
Private bDisableIconRotate As Boolean = False
Private sDisabled As String = ""
Private sExpandIcon As String = ""
Private bHideActions As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VExpansionPanelHeader 
mName = Name 
...
bDisableIconRotate = props.Get("DisableIconRotate")
sDisabled = props.Get("Disabled")
sExpandIcon = props.Get("ExpandIcon")
bHideActions = props.Get("HideActions")
sKey = props.Get("Key")
...
'set color
Sub SetColor(varColor As String) As VExpansionPanelHeader
sColor = varColor
SetAttr("color", sColor)
Return Me
End Sub

'set disable-icon-rotate
Sub SetDisableIconRotate(varDisableIconRotate As Boolean) As VExpansionPanelHeader
bDisableIconRotate = varDisableIconRotate
SetAttr("disable-icon-rotate", bDisableIconRotate)
Return Me
End Sub

'set disabled
Sub SetDisabled(varDisabled As String) As VExpansionPanelHeader
...
'set expand-icon
Sub SetExpandIcon(varExpandIcon As String) As VExpansionPanelHeader
...
'set hide-actions
Sub SetHideActions(varHideActions As Boolean) As VExpansionPanelHeader
bHideActions = varHideActions
SetAttr("hide-actions", bHideActions)
Return Me
End Sub

'set key
Sub SetKey(varKey As String) As VExpansionPanelHeader
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VExpansionPanelHeader
...
'set readonly
Sub SetReadonly(varReadonly As String) As VExpansionPanelHeader
...
'set ref
Sub SetRef(varRef As String) As VExpansionPanelHeader
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VExpansionPanelHeader
...
'set ripple
Sub SetRipple(varRipple As String) As VExpansionPanelHeader
sRipple = varRipple
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VExpansionPanelHeader
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VExpansionPanelHeader
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VExpansionPanelHeader
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VExpansionPanelHeader
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VExpansionPanelHeader
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VExpansionPanelHeader
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VExpansionPanelHeader
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VExpansionPanelHeader
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VExpansionPanelHeader
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VExpansionPanelHeader
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VExpansionPanelHeader
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VExpansionPanelHeader
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VExpansionPanelHeader
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VExpansionPanelHeader
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VExpansionPanelHeader
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VExpansionPanelHeader
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VExpansionPanelHeader
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VExpansionPanelHeader
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VExpansionPanelHeader
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VExpansionPanelHeader
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VExpansionPanelHeader
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VExpansionPanelHeader
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VExpansionPanelHeader
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VExpansionPanelHeader
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VExpansionPanelHeader
...
Sub SetOnClick() As VExpansionPanelHeader
...
Sub SetOnClickE(sClick As String) As VExpansionPanelHeader
eOnclick = sClick
Return Me
End Sub
...
AddAttr(bDisableIconRotate, "disable-icon-rotate")
AddAttr(sDisabled, "disabled")
AddAttr(sExpandIcon, "expand-icon")
AddAttr(bHideActions, "hide-actions")
AddAttr(sKey, "key")
...
Sub AddComponent(child As String) As VExpansionPanelHeader
...
Sub SetID(varText As String) As VExpansionPanelHeader
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VExpansionPanelHeader
...
Sub AddToApp(vap As VueApp) As VExpansionPanelHeader
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VExpansionPanelHeader
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VExpansionPanelHeader
...
Sub SetCaption(varText As String) As VExpansionPanelHeader
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VExpansionPanelHeader
...
public Sub SetClasses(Classes As String) As VExpansionPanelHeader
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VExpansionPanelHeader
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VExpansionPanelHeader
...
Sub SetStyles(m As Map) As VExpansionPanelHeader
...
Sub SetAttrs(props As Map) As VExpansionPanelHeader
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VExpansionPanelHeader
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VExpansionPanelHeader
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VExpansionPanelHeader
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VExpansionPanelHeader
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VExpansionPanelHeader
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VExpansionPanelHeader
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VExpansionPanelHeader
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VExpansionPanelHeader
...
'set text color
Sub SetTextColor1(varColor As String) As VExpansionPanelHeader
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VExpansionPanelHeader
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VExpansionPanelHeader
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VExpansionPanelHeader
	If sVShow = "" Then
		Log($"VExpansionPanelHeader.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VExpansionPanelHeader
	If sVShow = "" Then
		Log($"VExpansionPanelHeader.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VExpansionPanelHeader
	If sVShow = "" Then
		Log($"VExpansionPanelHeader.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VExpansionPanelHeader
	if svBindClass = "" then
		Log($"VExpansionPanelHeader.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VExpansionPanelHeader
	if svBindStyle = "" then
		Log($"VExpansionPanelHeader.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VExpansionPanelHeader
'	If sRequired = "" Then
'		Log($"VExpansionPanelHeader.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VExpansionPanelHeader
'	If sReadonly = "" Then
'		Log($"VExpansionPanelHeader.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VExpansionPanelHeader
'	If sDisabled = "" Then
'		Log($"VExpansionPanelHeader.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
