...
#DesignerProperty: Key: DisableIconRotate, DisplayName: DisableIconRotate, FieldType: Boolean, DefaultValue: false , Description: Set disable-icon-rotate
#DesignerProperty: Key: ExpandIcon, DisplayName: ExpandIcon, FieldType: String, DefaultValue: , Description: Set expand-icon
#DesignerProperty: Key: HideActions, DisplayName: HideActions, FieldType: Boolean, DefaultValue: false , Description: Set hide-actions
...
Sub Class_Globals
	...
	Public bDisableIconRotate As Boolean = false
	Public sExpandIcon As String = "$expand"
	Public bHideActions As Boolean = false
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bDisableIconRotate, "b", "disable-icon-rotate")
		AddAttr(Attributes, sExpandIcon, "s", "expand-icon")
		AddAttr(Attributes, bHideActions, "b", "hide-actions")
...
Sub SetDisableIconRotate(varDisableIconRotate As Boolean)
	bDisableIconRotate = varDisableIconRotate
	mElement.SetAttr("disable-icon-rotate", bDisableIconRotate)
End Sub
...
'set hide-actions
Sub SetHideActions(varHideActions As Boolean)
	bHideActions = varHideActions
	mElement.SetAttr("hide-actions", bHideActions)
End Sub
