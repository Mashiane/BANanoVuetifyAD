...
#DesignerProperty: Key: Horizontal, DisplayName: Horizontal, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: InputValue, DisplayName: InputValue, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Shift, DisplayName: Shift, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Onupdateinputvalue, DisplayName: Onupdateinputvalue, FieldType: String, DefaultValue: , Description: Event arguments to be passed to the attribute.
...
Private bInputValue As Boolean = False
...
Private eOnupdateinputvalue As String = ""
...
eOnupdateinputvalue = props.Get("Onupdateinputvalue")
...
SetOnChange
'This activates UpdateInputValue the event exists on the module
...
'set disabled
Sub SetDisabled(varDisabled As String) As VBottomNavigation
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VBottomNavigation
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VBottomNavigation
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VBottomNavigation
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VBottomNavigation
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VBottomNavigation
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VBottomNavigation
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VBottomNavigation
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VBottomNavigation
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VBottomNavigation
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VBottomNavigation
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VBottomNavigation
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VBottomNavigation
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VBottomNavigation
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VBottomNavigation
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VBottomNavigation
...
sName = sName.tolowercase
If SubExists(mCallBack, sName) = False Then Return Me
Dim sCode As String = $"${sName}(${eOnupdateinputvalue})"$
SetAttr("v-on:update:input-value", sCode)
'arguments for the event
...
Sub AddToApp(vap As VueApp) As VBottomNavigation
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VBottomNavigation
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VBottomNavigation
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VBottomNavigation
...
'toggle
Sub Toggle As VBottomNavigation
	If sVShow = "" Then
		Log($"VBottomNavigation.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VBottomNavigation
	If sVShow = "" Then
		Log($"VBottomNavigation.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VBottomNavigation
	If sVShow = "" Then
		Log($"VBottomNavigation.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VBottomNavigation
	if svBindClass = "" then
		Log($"VBottomNavigation.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VBottomNavigation
	if svBindStyle = "" then
		Log($"VBottomNavigation.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
Sub SetRequiredOnOff(b As Boolean) As VBottomNavigation
	If sRequired = "" Then
		Log($"VBottomNavigation.Required - the required for ${mName} has not been set!"$)
		Return Me
	End If
...
'read only
Sub SetReadOnlyOnOff(b As Boolean) As VBottomNavigation
	If sReadonly = "" Then
		Log($"VBottomNavigation.ReadOnly - the readonly for ${mName} has not been set!"$)
		Return Me
	End If
...
'disabled
Sub SetDisabledOnOff(b As Boolean) As VBottomNavigation
	If sDisabled = "" Then
		Log($"VBottomNavigation.Disabled - the disabled for ${mName} has not been set!"$)
		Return Me
	End If
