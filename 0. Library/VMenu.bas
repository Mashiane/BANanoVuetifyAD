...
#DesignerProperty: Key: Auto, DisplayName: Auto, FieldType: Boolean, DefaultValue: false , Description: Set auto
...
#DesignerProperty: Key: CloseOnClick, DisplayName: CloseOnClick, FieldType: Boolean, DefaultValue: true , Description: Set close-on-click
#DesignerProperty: Key: CloseOnContentClick, DisplayName: CloseOnContentClick, FieldType: Boolean, DefaultValue: true , Description: Set close-on-content-click
...
#DesignerProperty: Key: DisableKeys, DisplayName: DisableKeys, FieldType: Boolean, DefaultValue: false , Description: Set disable-keys
...
#DesignerProperty: Key: OffsetX, DisplayName: OffsetX, FieldType: Boolean, DefaultValue: false , Description: Set offset-x
#DesignerProperty: Key: OffsetY, DisplayName: OffsetY, FieldType: Boolean, DefaultValue: false , Description: Set offset-y
#DesignerProperty: Key: OpenDelay, DisplayName: OpenDelay, FieldType: String, DefaultValue: , Description: Set open-delay
#DesignerProperty: Key: OpenOnClick, DisplayName: OpenOnClick, FieldType: Boolean, DefaultValue: true , Description: Set open-on-click
...
Sub Class_Globals
	...
	Public bAuto As Boolean = false
	Public bBottom As Boolean = false
	Public sCloseDelay As String = "0"
	Public bCloseOnClick As Boolean = true
	Public bCloseOnContentClick As Boolean = true
	Public sContentClass As String = ""
	Public bDark As Boolean = false
	Public bDisableKeys As Boolean = false
	...
	Public sMaxHeight As String = "auto"
	...
	Public bOffsetX As Boolean = false
	Public bOffsetY As Boolean = false
	Public sOpenDelay As String = "0"
	Public bOpenOnClick As Boolean = true
	Public bOpenOnHover As Boolean = false
	Public sOrigin As String = "top left"
	...
	Public sTransition As String = "v-menu-transition"
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bAuto, "b", "auto")
		AddAttr(Attributes, bBottom, "b", "bottom")
		AddAttr(Attributes, sCloseDelay, "s", "close-delay")
		AddAttr(Attributes, bCloseOnClick, "b", "close-on-click")
		AddAttr(Attributes, bCloseOnContentClick, "b", "close-on-content-click")
		AddAttr(Attributes, sContentClass, "s", "content-class")
		AddAttr(Attributes, bDark, "b", "dark")
		AddAttr(Attributes, bDisableKeys, "b", "disable-keys")
		...
		AddAttr(Attributes, bOffsetX, "b", "offset-x")
		AddAttr(Attributes, bOffsetY, "b", "offset-y")
...
'set auto
Sub SetAuto(varAuto As Boolean)
	bAuto = varAuto
	mElement.SetAttr("auto", bAuto)
End Sub
...
'set close-on-click
Sub SetCloseOnClick(varCloseOnClick As Boolean)
	bCloseOnClick = varCloseOnClick
	mElement.SetAttr("close-on-click", bCloseOnClick)
End Sub

'set close-on-content-click
Sub SetCloseOnContentClick(varCloseOnContentClick As Boolean)
	bCloseOnContentClick = varCloseOnContentClick
	mElement.SetAttr("close-on-content-click", bCloseOnContentClick)
End Sub
...
'set disable-keys
Sub SetDisableKeys(varDisableKeys As Boolean)
	bDisableKeys = varDisableKeys
	mElement.SetAttr("disable-keys", bDisableKeys)
End Sub
...
'set offset-x
Sub SetOffsetX(varOffsetX As Boolean)
	bOffsetX = varOffsetX
	mElement.SetAttr("offset-x", bOffsetX)
End Sub

'set offset-y
Sub SetOffsetY(varOffsetY As Boolean)
	bOffsetY = varOffsetY
	mElement.SetAttr("offset-y", bOffsetY)
End Sub
