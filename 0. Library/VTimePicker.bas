...
#DesignerProperty: Key: AllowedHours, DisplayName: AllowedHours, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AllowedMinutes, DisplayName: AllowedMinutes, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AllowedSeconds, DisplayName: AllowedSeconds, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AmpmInTitle, DisplayName: AmpmInTitle, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: UseSeconds, DisplayName: UseSeconds, Description: , FieldType: Boolean, DefaultValue: False
...
Private sAllowedHours As String = ""
Private sAllowedMinutes As String = ""
Private sAllowedSeconds As String = ""
...
sAllowedHours = props.Get("AllowedHours")
sAllowedMinutes = props.Get("AllowedMinutes")
sAllowedSeconds = props.Get("AllowedSeconds")
...
'set allowed-hours
Sub SetAllowedHours(varAllowedHours As String) As VTimePicker
sAllowedHours = varAllowedHours
SetAttr("allowed-hours", sAllowedHours)
Return Me
End Sub

'set allowed-minutes
Sub SetAllowedMinutes(varAllowedMinutes As String) As VTimePicker
sAllowedMinutes = varAllowedMinutes
SetAttr("allowed-minutes", sAllowedMinutes)
Return Me
End Sub

'set allowed-seconds
Sub SetAllowedSeconds(varAllowedSeconds As String) As VTimePicker
sAllowedSeconds = varAllowedSeconds
SetAttr("allowed-seconds", sAllowedSeconds)
Return Me
End Sub
...
'set elevation
Sub SetElevation(varElevation As String) As VTimePicker
...
'set flat
Sub SetFlat(varFlat As Boolean) As VTimePicker
bFlat = varFlat
SetAttr("flat", bFlat)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VTimePicker
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTimePicker
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTimePicker
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTimePicker
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTimePicker
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTimePicker
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTimePicker
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTimePicker
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTimePicker
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTimePicker
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTimePicker
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTimePicker
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTimePicker
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTimePicker
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTimePicker
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTimePicker
...
Sub SetOnChangeE(sChange As String) As VTimePicker
eOnchange = sChange
Return Me
End Sub
...
Sub SetOnClickHourE(sClickHour As String) As VTimePicker
eOnclickhour = sClickHour
Return Me
End Sub
...
Sub SetOnClickMinuteE(sClickMinute As String) As VTimePicker
eOnclickminute = sClickMinute
Return Me
End Sub
...
Sub SetOnClickSecondE(sClickSecond As String) As VTimePicker
eOnclicksecond = sClickSecond
Return Me
End Sub
...
Sub SetOnInputE(sInput As String) As VTimePicker
eOninput = sInput
Return Me
End Sub
...
Sub SetOnUpdatePeriodE(sUpdatePeriod As String) As VTimePicker
eOnupdateperiod = sUpdatePeriod
Return Me
End Sub
...
AddAttr(sAllowedHours, "allowed-hours")
AddAttr(sAllowedMinutes, "allowed-minutes")
AddAttr(sAllowedSeconds, "allowed-seconds")
...
Sub AddToApp(vap As VueApp) As VTimePicker
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTimePicker
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VTimePicker
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTimePicker
...
'toggle
Sub Toggle As VTimePicker
	If sVShow = "" Then
		Log($"VTimePicker.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTimePicker
	If sVShow = "" Then
		Log($"VTimePicker.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTimePicker
	If sVShow = "" Then
		Log($"VTimePicker.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTimePicker
	if svBindClass = "" then
		Log($"VTimePicker.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTimePicker
	if svBindStyle = "" then
		Log($"VTimePicker.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTimePicker
'	If sRequired = "" Then
'		Log($"VTimePicker.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTimePicker
'	If sReadonly = "" Then
'		Log($"VTimePicker.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTimePicker
'	If sDisabled = "" Then
'		Log($"VTimePicker.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
