2020-07-08 02:38:08 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VDialogTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-dialog-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VDialogTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VDialogTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VDialogTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VDialogTransition
...
'set key
Sub SetKey(varKey As String) As VDialogTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VDialogTransition
...
'set mode
Sub SetMode(varMode As String) As VDialogTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VDialogTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VDialogTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VDialogTransition
...
'set ref
Sub SetRef(varRef As String) As VDialogTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VDialogTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDialogTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDialogTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VDialogTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VDialogTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDialogTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VDialogTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VDialogTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VDialogTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VDialogTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VDialogTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VDialogTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VDialogTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VDialogTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDialogTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDialogTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDialogTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDialogTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDialogTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDialogTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDialogTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDialogTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDialogTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDialogTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDialogTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDialogTransition
...
Sub AddComponent(child As String) As VDialogTransition
...
Sub SetID(varText As String) As VDialogTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VDialogTransition
...
Sub AddToApp(vap As VueApp) As VDialogTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDialogTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VDialogTransition
...
Sub SetCaption(varText As String) As VDialogTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VDialogTransition
...
public Sub SetClasses(Classes As String) As VDialogTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VDialogTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VDialogTransition
...
Sub SetStyles(m As Map) As VDialogTransition
...
Sub SetAttrs(props As Map) As VDialogTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VDialogTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VDialogTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VDialogTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VDialogTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VDialogTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDialogTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VDialogTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VDialogTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VDialogTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VDialogTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VDialogTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VDialogTransition
	If sVShow = "" Then
		Log($"VDialogTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDialogTransition
	If sVShow = "" Then
		Log($"VDialogTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDialogTransition
	If sVShow = "" Then
		Log($"VDialogTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDialogTransition
	if svBindClass = "" then
		Log($"VDialogTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDialogTransition
	if svBindStyle = "" then
		Log($"VDialogTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDialogTransition
'	If sRequired = "" Then
'		Log($"VDialogTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDialogTransition
'	If sReadonly = "" Then
'		Log($"VDialogTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDialogTransition
'	If sDisabled = "" Then
'		Log($"VDialogTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
