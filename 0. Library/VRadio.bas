...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VRadio
#IgnoreWarnings:12
...
Private mTagName As String = "v-radio" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VRadio 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VRadio
...
'set color
Sub SetColor(varColor As String) As VRadio
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VRadio
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VRadio
...
'set key
Sub SetKey(varKey As String) As VRadio
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VRadio
bLight = varLight
...
'set name
Sub SetName(varName As String) As VRadio
sName = varName
SetAttr("name", sName)
Return Me
End Sub
...
'set off-icon
Sub SetOffIcon(varOffIcon As String) As VRadio
sOffIcon = varOffIcon
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VRadio
...
'set ref
Sub SetRef(varRef As String) As VRadio
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VRadio
...
'set ripple
Sub SetRipple(varRipple As String) As VRadio
sRipple = varRipple
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VRadio
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VRadio
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VRadio
bVCloak = varVCloak
...
'set v-for
Sub SetVFor(varVFor As String) As VRadio
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VRadio
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VRadio
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VRadio
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VRadio
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VRadio
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VRadio
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VRadio
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VRadio
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VRadio
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VRadio
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VRadio
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VRadio
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VRadio
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VRadio
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VRadio
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VRadio
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VRadio
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VRadio
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VRadio
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VRadio
...
Sub SetOnClickPrepend() As VRadio
...
public Sub AddToParent(targetID As String) As VRadio
...
'update the state
Sub SetData(prop as string, value as object) As VRadio
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VRadio
...
public Sub SetClasses(Classes As String) As VRadio
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VRadio
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VRadio
...
Sub SetAttrs(props As Map) As VRadio
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VRadio
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VRadio
	If loose <> Null Then
...
'set color
Sub SetColor1(varColor As String) As VRadio
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VRadio
...
'set text color
Sub SetTextColor1(varColor As String) As VRadio
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VRadio
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VRadio
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VRadio
	If sVShow = "" Then
		Log($"VRadio.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VRadio
	If sVShow = "" Then
		Log($"VRadio.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VRadio
	If sVShow = "" Then
		Log($"VRadio.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VRadio
	if svBindClass = "" then
		Log($"VRadio.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
