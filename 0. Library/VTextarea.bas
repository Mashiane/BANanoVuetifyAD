...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VTextarea
#IgnoreWarnings:12
...
#DesignerProperty: Key: AutoGrow, DisplayName: AutoGrow, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: NoResize, DisplayName: NoResize, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: RowHeight, DisplayName: RowHeight, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Rows, DisplayName: Rows, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-textarea" 
	Public bindings As Map 
	Public methods As Map
Private sAppendIcon As String = ""
Private sAppendOuterIcon As String = ""
Private bAutoGrow As Boolean = False
...
Private bNoResize As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VTextarea 
mName = Name 
...
'set append-icon
Sub SetAppendIcon(varAppendIcon As String) As VTextarea
...
Sub SetAppendOuterIcon(varAppendOuterIcon As String) As VTextarea
...
'set auto-grow
Sub SetAutoGrow(varAutoGrow As Boolean) As VTextarea
bAutoGrow = varAutoGrow
SetAttr("auto-grow", bAutoGrow)
Return Me
End Sub

'set autofocus
Sub SetAutofocus(varAutofocus As Boolean) As VTextarea
...
Sub SetBackgroundColor(varBackgroundColor As String) As VTextarea
...
'set clear-icon
Sub SetClearIcon(varClearIcon As String) As VTextarea
...
'set clearable
Sub SetClearable(varClearable As Boolean) As VTextarea
...
'set color
Sub SetColor(varColor As String) As VTextarea
sColor = varColor
...
'set counter
Sub SetCounter(varCounter As String) As VTextarea
sCounter = varCounter
...
'set counter-value
Sub SetCounterValue(varCounterValue As String) As VTextarea
...
'set dark
Sub SetDark(varDark As Boolean) As VTextarea
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set dense
Sub SetDense(varDense As Boolean) As VTextarea
bDense = varDense
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VTextarea
...
'set error
Sub SetError(varError As Boolean) As VTextarea
bError = varError
...
'set error-count
Sub SetErrorCount(varErrorCount As String) As VTextarea
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As String) As VTextarea
...
'set filled
Sub SetFilled(varFilled As Boolean) As VTextarea
bFilled = varFilled
...
'set flat
Sub SetFlat(varFlat As Boolean) As VTextarea
bFlat = varFlat
SetAttr("flat", bFlat)
Return Me
End Sub
...
'set full-width
Sub SetFullWidth(varFullWidth As Boolean) As VTextarea
...
'set height
Sub SetHeight(varHeight As String) As VTextarea
sHeight = varHeight
...
'set hide-details
Sub SetHideDetails(varHideDetails As String) As VTextarea
...
'set hint
Sub SetHint(varHint As String) As VTextarea
sHint = varHint
SetAttr("hint", sHint)
Return Me
End Sub
...
'set key
Sub SetKey(varKey As String) As VTextarea
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set label
Sub SetLabel(varLabel As String) As VTextarea
sLabel = varLabel
...
'set light
Sub SetLight(varLight As Boolean) As VTextarea
bLight = varLight
...
'set loader-height
Sub SetLoaderHeight(varLoaderHeight As String) As VTextarea
...
'set loading
Sub SetLoading(varLoading As String) As VTextarea
sLoading = varLoading
...
'set messages
Sub SetMessages(varMessages As String) As VTextarea
...
'set no-resize
Sub SetNoResize(varNoResize As Boolean) As VTextarea
bNoResize = varNoResize
SetAttr("no-resize", bNoResize)
Return Me
End Sub

'set outlined
Sub SetOutlined(varOutlined As Boolean) As VTextarea
...
'set parent-id
Sub SetParentId(varParentId As String) As VTextarea
...
'set persistent-hint
Sub SetPersistentHint(varPersistentHint As Boolean) As VTextarea
...
'set placeholder
Sub SetPlaceholder(varPlaceholder As String) As VTextarea
...
'set prefix
Sub SetPrefix(varPrefix As String) As VTextarea
sPrefix = varPrefix
...
'set prepend-icon
Sub SetPrependIcon(varPrependIcon As String) As VTextarea
...
Sub SetPrependInnerIcon(varPrependInnerIcon As String) As VTextarea
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VTextarea
...
'set ref
Sub SetRef(varRef As String) As VTextarea
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VTextarea
...
'set reverse
Sub SetReverse(varReverse As Boolean) As VTextarea
bReverse = varReverse
...
'set rounded
Sub SetRounded(varRounded As Boolean) As VTextarea
bRounded = varRounded
...
'set row-height
Sub SetRowHeight(varRowHeight As String) As VTextarea
sRowHeight = varRowHeight
SetAttr("row-height", sRowHeight)
Return Me
End Sub

'set rows
Sub SetRows(varRows As String) As VTextarea
sRows = varRows
SetAttr("rows", sRows)
Return Me
End Sub
...
'set rules
Sub SetRules(varRules As Object) As VTextarea
SetAttr("rules", varRules)
Return Me
End Sub

'set shaped
Sub SetShaped(varShaped As Boolean) As VTextarea
bShaped = varShaped
...
'set single-line
Sub SetSingleLine(varSingleLine As Boolean) As VTextarea
...
'set solo
Sub SetSolo(varSolo As Boolean) As VTextarea
bSolo = varSolo
SetAttr("solo", bSolo)
Return Me
End Sub
...
'set solo-inverted
Sub SetSoloInverted(varSoloInverted As Boolean) As VTextarea
...
'set success
Sub SetSuccess(varSuccess As Boolean) As VTextarea
bSuccess = varSuccess
...
Sub SetSuccessMessages(varSuccessMessages As String) As VTextarea
...
'set suffix
Sub SetSuffix(varSuffix As String) As VTextarea
sSuffix = varSuffix
...
'set type
Sub SetType(varType As String) As VTextarea
sType = varType
SetAttr("type", sType)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTextarea
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTextarea
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VTextarea
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VTextarea
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTextarea
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VTextarea
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VTextarea
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VTextarea
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VTextarea
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VTextarea
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VTextarea
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VTextarea
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VTextarea
sVText = varVText
...
Sub SetValidateOnBlur(varValidateOnBlur As Boolean) As VTextarea
...
'set value
Sub SetValue(varValue As String) As VTextarea
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTextarea
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTextarea
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTextarea
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTextarea
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTextarea
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTextarea
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTextarea
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTextarea
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTextarea
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTextarea
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTextarea
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTextarea
...
Sub SetOnBlurE(sBlur As String) As VTextarea
eOnblur = sBlur
Return Me
End Sub

'set on change event, updates the master events records
Sub SetOnChange() As VTextarea
...
Sub SetOnChangeE(sChange As String) As VTextarea
eOnchange = sChange
Return Me
End Sub

'set on click event, updates the master events records
Sub SetOnClick() As VTextarea
...
Sub SetOnClickE(sClick As String) As VTextarea
eOnclick = sClick
Return Me
End Sub

'set on clickappend event, updates the master events records
Sub SetOnClickAppend() As VTextarea
...
Sub SetOnClickAppendE(sClickAppend As String) As VTextarea
eOnclickappend = sClickAppend
Return Me
End Sub

'set on clickappendouter event, updates the master events records
Sub SetOnClickAppendOuter() As VTextarea
...
Sub SetOnClickAppendOuterE(sClickAppendOuter As String) As VTextarea
eOnclickappendouter = sClickAppendOuter
Return Me
End Sub

'set on clickclear event, updates the master events records
Sub SetOnClickClear() As VTextarea
...
Sub SetOnClickClearE(sClickClear As String) As VTextarea
eOnclickclear = sClickClear
Return Me
End Sub

'set on clickprepend event, updates the master events records
Sub SetOnClickPrepend() As VTextarea
...
Sub SetOnClickPrependE(sClickPrepend As String) As VTextarea
eOnclickprepend = sClickPrepend
Return Me
End Sub

'set on clickprependinner event, updates the master events records
Sub SetOnClickPrependInner() As VTextarea
...
Sub SetOnClickPrependInnerE(sClickPrependInner As String) As VTextarea
eOnclickprependinner = sClickPrependInner
Return Me
End Sub

'set on focus event, updates the master events records
Sub SetOnFocus() As VTextarea
...
Sub SetOnFocusE(sFocus As String) As VTextarea
eOnfocus = sFocus
Return Me
End Sub

'set on input event, updates the master events records
Sub SetOnInput() As VTextarea
...
Sub SetOnInputE(sInput As String) As VTextarea
eOninput = sInput
Return Me
End Sub

'set on keydown event, updates the master events records
Sub SetOnKeydown() As VTextarea
...
Sub SetOnKeydownE(sKeydown As String) As VTextarea
eOnkeydown = sKeydown
Return Me
End Sub

'set on mousedown event, updates the master events records
Sub SetOnMousedown() As VTextarea
...
Sub SetOnMousedownE(sMousedown As String) As VTextarea
eOnmousedown = sMousedown
Return Me
End Sub

'set on mouseup event, updates the master events records
Sub SetOnMouseup() As VTextarea
...
Sub SetOnMouseupE(sMouseup As String) As VTextarea
eOnmouseup = sMouseup
Return Me
End Sub

'set on updateerror event, updates the master events records
Sub SetOnUpdateError() As VTextarea
...
Sub SetOnUpdateErrorE(sUpdateError As String) As VTextarea
...
Sub AddComponent(child As String) As VTextarea
...
Sub SetID(varText As String) As VTextarea
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VTextarea
...
Sub AddToApp(vap As VueApp) As VTextarea
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTextarea
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VTextarea
...
Sub SetCaption(varText As String) As VTextarea
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VTextarea
...
public Sub SetClasses(Classes As String) As VTextarea
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VTextarea
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VTextarea
...
Sub SetStyles(m As Map) As VTextarea
...
Sub SetAttrs(props As Map) As VTextarea
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VTextarea
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VTextarea
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VTextarea
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VTextarea
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VTextarea
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTextarea
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VTextarea
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VTextarea
...
'set text color
Sub SetTextColor1(varColor As String) As VTextarea
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VTextarea
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VTextarea
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VTextarea
	If sVShow = "" Then
		Log($"VTextarea.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTextarea
	If sVShow = "" Then
		Log($"VTextarea.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTextarea
	If sVShow = "" Then
		Log($"VTextarea.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTextarea
	if svBindClass = "" then
		Log($"VTextarea.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTextarea
	if svBindStyle = "" then
		Log($"VTextarea.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTextarea
'	If sRequired = "" Then
'		Log($"VTextarea.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTextarea
'	If sReadonly = "" Then
'		Log($"VTextarea.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTextarea
'	If sDisabled = "" Then
'		Log($"VTextarea.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
