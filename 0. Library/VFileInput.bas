...
#DesignerProperty: Key: Clearable, DisplayName: Clearable, FieldType: Boolean, DefaultValue: true , Description: Set clearable
...
#DesignerProperty: Key: CounterSizeString, DisplayName: CounterSizeString, FieldType: String, DefaultValue: , Description: Set counter-size-string
#DesignerProperty: Key: CounterString, DisplayName: CounterString, FieldType: String, DefaultValue: , Description: Set counter-string
...
#DesignerProperty: Key: ShowSize, DisplayName: ShowSize, FieldType: String, DefaultValue: , Description: Set show-size
...
#DesignerProperty: Key: TruncateLength, DisplayName: TruncateLength, FieldType: String, DefaultValue: , Description: Set truncate-length
...
Sub Class_Globals
	...
	Public bClearable As Boolean = true
	Public sColor As String = ""
	Public sCounter As String = ""
	Public sCounterSizeString As String = "$vuetify.fileInput.counterSize"
	Public sCounterString As String = "$vuetify.fileInput.counter"
	...
	Public sPrependIcon As String = "$file"
	...
	Public sShowSize As String = "false"
	...
	Public sTruncateLength As String = "22"
	Public sType As String = "file"
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, sCounterSizeString, "s", "counter-size-string")
		AddAttr(Attributes, sCounterString, "s", "counter-string")
		...
		AddAttr(Attributes, sShowSize, "s", "show-size")
		...
		AddAttr(Attributes, sTruncateLength, "s", "truncate-length")
...
Sub SetCounterSizeString(varCounterSizeString As String)
	sCounterSizeString = varCounterSizeString
	mElement.SetAttr("counter-size-string", sCounterSizeString)
End Sub

'set counter-string
Sub SetCounterString(varCounterString As String)
	sCounterString = varCounterString
	mElement.SetAttr("counter-string", sCounterString)
End Sub
...
'set show-size
Sub SetShowSize(varShowSize As String)
	sShowSize = varShowSize
	mElement.SetAttr("show-size", sShowSize)
End Sub
...
'set truncate-length
Sub SetTruncateLength(varTruncateLength As String)
	sTruncateLength = varTruncateLength
	mElement.SetAttr("truncate-length", sTruncateLength)
End Sub
