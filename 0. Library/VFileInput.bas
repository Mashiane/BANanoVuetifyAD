...
#DesignerProperty: Key: HideInput, DisplayName: HideInput, Description: , FieldType: Boolean, DefaultValue: False
...
Private bHideInput As Boolean = False
...
bHideInput = props.Get("HideInput")
...
'set hide-input
Sub SetHideInput(varHideInput As Boolean) As VFileInput
bHideInput = varHideInput
SetAttr("hide-input", bHideInput)
Return Me
End Sub
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VFileInput
sVElseIf = varVElseIf
