...
#DesignerProperty: Key: Clearable, DisplayName: Clearable, Description: , DefaultValue: true, FieldType: Boolean
...
#DesignerProperty: Key: CounterSizeString, DisplayName: CounterSizeString, Description: , DefaultValue: $vuetify.fileInput.counterSize, FieldType: String
#DesignerProperty: Key: CounterString, DisplayName: CounterString, Description: , DefaultValue: $vuetify.fileInput.counter, FieldType: String
...
#DesignerProperty: Key: PrependIcon, DisplayName: PrependIcon, Description: , DefaultValue: $file, FieldType: String
...
#DesignerProperty: Key: ShowSize, DisplayName: ShowSize, Description: , DefaultValue: false, FieldType: String
...
#DesignerProperty: Key: TruncateLength, DisplayName: TruncateLength, Description: , DefaultValue: 22, FieldType: String
#DesignerProperty: Key: Type, DisplayName: Type, Description: , DefaultValue: file, FieldType: String
...
Private bClearable As Boolean = true
Private sColor As String = ""
Private sCounter As String = ""
Private sCounterSizeString As String = "$vuetify.fileInput.counterSize"
Private sCounterString As String = "$vuetify.fileInput.counter"
...
Private sPrependIcon As String = "$file"
...
Private sShowSize As String = "false"
...
Private sTruncateLength As String = "22"
Private sType As String = "file"
...
'set counter-value
Sub SetCounterValue(varCounterValue As Object) As VFileInput
...
'set enabled
Sub SetEnabled(varEnabled As String) As VFileInput
sEnabled = varEnabled
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As Object) As VFileInput
...
'set messages
Sub SetMessages(varMessages As Object) As VFileInput
...
Sub SetSuccessMessages(varSuccessMessages As Object) As VFileInput
...
Sub AddToApp(va As VueApp) As VFileInput
