...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VChipGroup 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VChipGroup
...
'set center-active
Sub SetCenterActive(varCenterActive As Boolean) As VChipGroup
...
'set color
Sub SetColor(varColor As String) As VChipGroup
sColor = varColor
...
'set column
Sub SetColumn(varColumn As Boolean) As VChipGroup
bColumn = varColumn
...
'set dark
Sub SetDark(varDark As Boolean) As VChipGroup
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VChipGroup
...
'set key
Sub SetKey(varKey As String) As VChipGroup
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VChipGroup
bLight = varLight
...
'set mandatory
Sub SetMandatory(varMandatory As Boolean) As VChipGroup
...
'set max
Sub SetMax(varMax As String) As VChipGroup
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
Sub SetMobileBreakpoint(varMobileBreakpoint As String) As VChipGroup
...
'set multiple
Sub SetMultiple(varMultiple As Boolean) As VChipGroup
...
'set next-icon
Sub SetNextIcon(varNextIcon As String) As VChipGroup
...
'set parent-id
Sub SetParentId(varParentId As String) As VChipGroup
...
'set prev-icon
Sub SetPrevIcon(varPrevIcon As String) As VChipGroup
...
'set readonly
Sub SetReadonly(varReadonly As String) As VChipGroup
...
'set ref
Sub SetRef(varRef As String) As VChipGroup
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VChipGroup
...
'set show-arrows
Sub SetShowArrows(varShowArrows As String) As VChipGroup
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VChipGroup
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VChipGroup
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VChipGroup
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VChipGroup
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VChipGroup
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VChipGroup
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VChipGroup
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VChipGroup
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VChipGroup
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VChipGroup
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VChipGroup
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VChipGroup
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VChipGroup
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VChipGroup
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VChipGroup
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VChipGroup
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VChipGroup
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VChipGroup
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VChipGroup
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VChipGroup
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VChipGroup
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VChipGroup
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VChipGroup
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VChipGroup
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VChipGroup
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VChipGroup
...
Sub SetOnChangeE(sChange As String) As VChipGroup
eOnchange = sChange
Return Me
End Sub
...
Sub AddComponent(child As String) As VChipGroup
...
Sub SetID(varText As String) As VChipGroup
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VChipGroup
...
Sub AddToApp(vap As VueApp) As VChipGroup
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VChipGroup
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VChipGroup
...
Sub SetCaption(varText As String) As VChipGroup
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VChipGroup
...
public Sub SetClasses(Classes As String) As VChipGroup
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VChipGroup
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VChipGroup
...
Sub SetStyles(m As Map) As VChipGroup
...
Sub SetAttrs(props As Map) As VChipGroup
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VChipGroup
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VChipGroup
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VChipGroup
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VChipGroup
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VChipGroup
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VChipGroup
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VChipGroup
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VChipGroup
...
'set text color
Sub SetTextColor1(varColor As String) As VChipGroup
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VChipGroup
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VChipGroup
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VChipGroup
	If sVShow = "" Then
		Log($"VChipGroup.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VChipGroup
	If sVShow = "" Then
		Log($"VChipGroup.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VChipGroup
	If sVShow = "" Then
		Log($"VChipGroup.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VChipGroup
	if svBindClass = "" then
		Log($"VChipGroup.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VChipGroup
	if svBindStyle = "" then
		Log($"VChipGroup.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VChipGroup
'	If sRequired = "" Then
'		Log($"VChipGroup.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VChipGroup
'	If sReadonly = "" Then
'		Log($"VChipGroup.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VChipGroup
'	If sDisabled = "" Then
'		Log($"VChipGroup.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
