...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSubheader
#IgnoreWarnings:12
...
Private mTagName As String = "v-subheader" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSubheader 
mName = Name 
...
'set dark
Sub SetDark(varDark As Boolean) As VSubheader
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VSubheader
...
'set inset
Sub SetInset(varInset As Boolean) As VSubheader
bInset = varInset
...
'set key
Sub SetKey(varKey As String) As VSubheader
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VSubheader
bLight = varLight
...
'set parent-id
Sub SetParentId(varParentId As String) As VSubheader
...
'set readonly
Sub SetReadonly(varReadonly As String) As VSubheader
...
'set ref
Sub SetRef(varRef As String) As VSubheader
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSubheader
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSubheader
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSubheader
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSubheader
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSubheader
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSubheader
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSubheader
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSubheader
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSubheader
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSubheader
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSubheader
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSubheader
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSubheader
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSubheader
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSubheader
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSubheader
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSubheader
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSubheader
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSubheader
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSubheader
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSubheader
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSubheader
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSubheader
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSubheader
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSubheader
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSubheader
...
Sub AddComponent(child As String) As VSubheader
...
Sub SetID(varText As String) As VSubheader
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSubheader
...
Sub AddToApp(vap As VueApp) As VSubheader
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSubheader
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSubheader
...
Sub SetCaption(varText As String) As VSubheader
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSubheader
...
public Sub SetClasses(Classes As String) As VSubheader
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSubheader
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSubheader
...
Sub SetStyles(m As Map) As VSubheader
...
Sub SetAttrs(props As Map) As VSubheader
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSubheader
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSubheader
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSubheader
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSubheader
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSubheader
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSubheader
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSubheader
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSubheader
...
'set text color
Sub SetTextColor1(varColor As String) As VSubheader
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSubheader
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSubheader
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSubheader
	If sVShow = "" Then
		Log($"VSubheader.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSubheader
	If sVShow = "" Then
		Log($"VSubheader.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSubheader
	If sVShow = "" Then
		Log($"VSubheader.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSubheader
	if svBindClass = "" then
		Log($"VSubheader.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSubheader
	if svBindStyle = "" then
		Log($"VSubheader.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSubheader
'	If sRequired = "" Then
'		Log($"VSubheader.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSubheader
'	If sReadonly = "" Then
'		Log($"VSubheader.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSubheader
'	If sDisabled = "" Then
'		Log($"VSubheader.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
