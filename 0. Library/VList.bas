...
#DesignerProperty: Key: Expand, DisplayName: Expand, FieldType: Boolean, DefaultValue: false , Description: Set expand
...
#DesignerProperty: Key: Nav, DisplayName: Nav, FieldType: Boolean, DefaultValue: false , Description: Set nav
...
#DesignerProperty: Key: Subheader, DisplayName: Subheader, FieldType: Boolean, DefaultValue: false , Description: Set subheader
...
Sub Class_Globals
	...
	Public bExpand As Boolean = false
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bExpand, "b", "expand")
...
'set expand
Sub SetExpand(varExpand As Boolean)
	bExpand = varExpand
	mElement.SetAttr("expand", bExpand)
End Sub
...
'set nav
Sub SetNav(varNav As Boolean)
	bNav = varNav
	mElement.SetAttr("nav", bNav)
End Sub
...
'set subheader
Sub SetSubheader(varSubheader As Boolean)
	bSubheader = varSubheader
	mElement.SetAttr("subheader", bSubheader)
End Sub
