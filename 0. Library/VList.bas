...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VList
#IgnoreWarnings:12
...
#DesignerProperty: Key: Nav, DisplayName: Nav, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Subheader, DisplayName: Subheader, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Tag, DisplayName: Tag, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: ThreeLine, DisplayName: ThreeLine, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Tile, DisplayName: Tile, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: TwoLine, DisplayName: TwoLine, Description: , FieldType: Boolean, DefaultValue: False
...
Private mTagName As String = "v-list" 
...
Private bSubheader As Boolean = False
Private sTag As String = ""
Private bThreeLine As Boolean = False
Private bTile As Boolean = False
Private bTwoLine As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VList 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VList
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VList
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set dense
Sub SetDense(varDense As Boolean) As VList
bDense = varDense
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VList
...
'set elevation
Sub SetElevation(varElevation As String) As VList
...
'set expand
Sub SetExpand(varExpand As Boolean) As VList
bExpand = varExpand
SetAttr("expand", bExpand)
Return Me
End Sub

'set flat
Sub SetFlat(varFlat As Boolean) As VList
bFlat = varFlat
SetAttr("flat", bFlat)
Return Me
End Sub
...
'set height
Sub SetHeight(varHeight As String) As VList
sHeight = varHeight
...
'set key
Sub SetKey(varKey As String) As VList
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VList
bLight = varLight
...
'set max-height
Sub SetMaxHeight(varMaxHeight As String) As VList
...
'set max-width
Sub SetMaxWidth(varMaxWidth As String) As VList
...
'set min-height
Sub SetMinHeight(varMinHeight As String) As VList
...
'set min-width
Sub SetMinWidth(varMinWidth As String) As VList
...
'set nav
Sub SetNav(varNav As Boolean) As VList
bNav = varNav
SetAttr("nav", bNav)
Return Me
End Sub
...
'set outlined
Sub SetOutlined(varOutlined As Boolean) As VList
...
'set parent-id
Sub SetParentId(varParentId As String) As VList
...
'set readonly
Sub SetReadonly(varReadonly As String) As VList
...
'set ref
Sub SetRef(varRef As String) As VList
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VList
...
'set rounded
Sub SetRounded(varRounded As Boolean) As VList
bRounded = varRounded
...
'set shaped
Sub SetShaped(varShaped As Boolean) As VList
bShaped = varShaped
...
'set subheader
Sub SetSubheader(varSubheader As Boolean) As VList
bSubheader = varSubheader
SetAttr("subheader", bSubheader)
Return Me
End Sub

'set tag
Sub SetTag(varTag As String) As VList
sTag = varTag
SetAttr("tag", sTag)
Return Me
End Sub
...
'set three-line
Sub SetThreeLine(varThreeLine As Boolean) As VList
bThreeLine = varThreeLine
SetAttr("three-line", bThreeLine)
Return Me
End Sub

'set tile
Sub SetTile(varTile As Boolean) As VList
bTile = varTile
SetAttr("tile", bTile)
Return Me
End Sub
...
'set two-line
Sub SetTwoLine(varTwoLine As Boolean) As VList
bTwoLine = varTwoLine
SetAttr("two-line", bTwoLine)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VList
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VList
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VList
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VList
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VList
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VList
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VList
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VList
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VList
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VList
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VList
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VList
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VList
sVText = varVText
...
'set width
Sub SetWidth(varWidth As String) As VList
sWidth = varWidth
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VList
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VList
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VList
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VList
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VList
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VList
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VList
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VList
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VList
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VList
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VList
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VList
...
AddAttr(bSubheader, "subheader")
AddAttr(sTag, "tag")
AddAttr(bThreeLine, "three-line")
AddAttr(bTile, "tile")
AddAttr(bTwoLine, "two-line")
...
Sub AddComponent(child As String) As VList
...
Sub SetID(varText As String) As VList
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VList
...
Sub AddToApp(vap As VueApp) As VList
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VList
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VList
...
Sub SetCaption(varText As String) As VList
	If mElement <> Null Then
...
public Sub SetClasses(Classes As String) As VList
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VList
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VList
...
Sub SetStyles(m As Map) As VList
...
Sub SetAttrs(props As Map) As VList
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VList
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VList
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VList
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VList
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VList
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VList
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VList
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VList
...
'set text color
Sub SetTextColor1(varColor As String) As VList
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VList
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VList
	methodName = methodName.ToLowerCase
...
Sub Toggle As VList
	If sVShow = "" Then
		Log($"VList.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VList
	If sVShow = "" Then
		Log($"VList.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VList
	If sVShow = "" Then
		Log($"VList.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VList
	if svBindClass = "" then
		Log($"VList.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VList
	if svBindStyle = "" then
		Log($"VList.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VList
'	If sRequired = "" Then
'		Log($"VList.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VList
'	If sReadonly = "" Then
'		Log($"VList.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VList
'	If sDisabled = "" Then
'		Log($"VList.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
