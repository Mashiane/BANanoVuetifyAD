...
#DesignerProperty: Key: Expand, DisplayName: Expand, Description: , DefaultValue: false, FieldType: Boolean
...
#DesignerProperty: Key: Nav, DisplayName: Nav, Description: , DefaultValue: false, FieldType: Boolean
...
#DesignerProperty: Key: Subheader, DisplayName: Subheader, Description: , DefaultValue: false, FieldType: Boolean
#DesignerProperty: Key: Tag, DisplayName: Tag, Description: , DefaultValue: div, FieldType: String
#DesignerProperty: Key: ThreeLine, DisplayName: ThreeLine, Description: , DefaultValue: false, FieldType: Boolean
#DesignerProperty: Key: Tile, DisplayName: Tile, Description: , DefaultValue: true, FieldType: Boolean
#DesignerProperty: Key: TwoLine, DisplayName: TwoLine, Description: , DefaultValue: false, FieldType: Boolean
...
'set enabled
Sub SetEnabled(varEnabled As String) As VList
sEnabled = varEnabled
...
Sub AddToApp(va As VueApp) As VList
