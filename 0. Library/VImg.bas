...
#DesignerProperty: Key: Onerror, DisplayName: Onerror, FieldType: String, DefaultValue: , Description: Event arguments to be passed to the attribute.
#DesignerProperty: Key: Onload, DisplayName: Onload, FieldType: String, DefaultValue: , Description: Event arguments to be passed to the attribute.
...
'This activates Error the event exists on the module
SetOnError
...
'set options
Sub SetOptions(varOptions As String) As VImg
sOptions = varOptions
...
'set src
Sub SetSrc(varSrc As String) As VImg
sSrc = varSrc
SetAttr("src", sSrc)
Return Me
End Sub
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VImg
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VImg
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VImg
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VImg
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VImg
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VImg
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VImg
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VImg
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VImg
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VImg
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VImg
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VImg
...
Dim sCode As String = $"${sName}(${eOnerror})"$
SetAttr("v-on:error", sCode)
...
sName = sName.tolowercase
If SubExists(mCallBack, sName) = False Then Return Me
Dim sCode As String = $"${sName}(${eOnload})"$
SetAttr("v-on:load", sCode)
'arguments for the event
Dim argument As Object 'ignore
Dim cb As BANanoObject = BANano.CallBack(mCallBack, sName, Array(argument))
methods.Put(sName, cb)
