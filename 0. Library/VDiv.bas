...
#DesignerProperty: Key: TagName, DisplayName: TagName, Description: , DefaultValue: div, FieldType: String, List:p|a|br|div|span|h1|h2|h3|h4|h5|h6
...
'set enabled
Sub SetEnabled(varEnabled As String) As VDiv
sEnabled = varEnabled
...
Sub AddToApp(va As VueApp) As VDiv
