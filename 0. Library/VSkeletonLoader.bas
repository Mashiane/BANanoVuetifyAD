...
#DesignerProperty: Key: Boilerplate, DisplayName: Boilerplate, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Types, DisplayName: Types, Description: , FieldType: String, DefaultValue: 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VSkeletonLoader
...
'set parent-id
Sub SetParentId(varParentId As String) As VSkeletonLoader
...
'set types
Sub SetTypes(varTypes As String) As VSkeletonLoader
sTypes = varTypes
SetAttr("types", sTypes)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSkeletonLoader
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSkeletonLoader
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSkeletonLoader
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSkeletonLoader
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSkeletonLoader
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSkeletonLoader
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSkeletonLoader
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSkeletonLoader
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSkeletonLoader
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSkeletonLoader
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSkeletonLoader
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSkeletonLoader
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSkeletonLoader
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSkeletonLoader
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSkeletonLoader
...
Sub AddToApp(vap As VueApp) As VSkeletonLoader
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSkeletonLoader
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VSkeletonLoader
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSkeletonLoader
...
'toggle
Sub Toggle As VSkeletonLoader
	If sVShow = "" Then
		Log($"VSkeletonLoader.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSkeletonLoader
	If sVShow = "" Then
		Log($"VSkeletonLoader.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSkeletonLoader
	If sVShow = "" Then
		Log($"VSkeletonLoader.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSkeletonLoader
	if svBindClass = "" then
		Log($"VSkeletonLoader.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSkeletonLoader
	if svBindStyle = "" then
		Log($"VSkeletonLoader.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSkeletonLoader
'	If sRequired = "" Then
'		Log($"VSkeletonLoader.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSkeletonLoader
'	If sReadonly = "" Then
'		Log($"VSkeletonLoader.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSkeletonLoader
'	If sDisabled = "" Then
'		Log($"VSkeletonLoader.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
