2020-07-08 02:38:00 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VDatePickerMonthTable
#IgnoreWarnings:12
...
Private mTagName As String = "v-date-picker-month-table" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VDatePickerMonthTable 
mName = Name 
...
'set allowed-dates
Sub SetAllowedDates(varAllowedDates As String) As VDatePickerMonthTable
...
'set color
Sub SetColor(varColor As String) As VDatePickerMonthTable
sColor = varColor
...
'set current
Sub SetCurrent(varCurrent As String) As VDatePickerMonthTable
sCurrent = varCurrent
...
'set dark
Sub SetDark(varDark As Boolean) As VDatePickerMonthTable
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VDatePickerMonthTable
...
'set event-color
Sub SetEventColor(varEventColor As String) As VDatePickerMonthTable
...
'set events
Sub SetEvents(varEvents As String) As VDatePickerMonthTable
sEvents = varEvents
...
'set format
Sub SetFormat(varFormat As String) As VDatePickerMonthTable
sFormat = varFormat
...
'set key
Sub SetKey(varKey As String) As VDatePickerMonthTable
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VDatePickerMonthTable
bLight = varLight
...
'set locale
Sub SetLocale(varLocale As String) As VDatePickerMonthTable
sLocale = varLocale
...
'set max
Sub SetMax(varMax As String) As VDatePickerMonthTable
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set min
Sub SetMin(varMin As String) As VDatePickerMonthTable
sMin = varMin
SetAttr("min", sMin)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VDatePickerMonthTable
...
'set range
Sub SetRange(varRange As Boolean) As VDatePickerMonthTable
bRange = varRange
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VDatePickerMonthTable
...
'set ref
Sub SetRef(varRef As String) As VDatePickerMonthTable
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VDatePickerMonthTable
...
'set scrollable
Sub SetScrollable(varScrollable As Boolean) As VDatePickerMonthTable
...
'set table-date
Sub SetTableDate(varTableDate As String) As VDatePickerMonthTable
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDatePickerMonthTable
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDatePickerMonthTable
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VDatePickerMonthTable
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VDatePickerMonthTable
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDatePickerMonthTable
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VDatePickerMonthTable
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VDatePickerMonthTable
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VDatePickerMonthTable
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VDatePickerMonthTable
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VDatePickerMonthTable
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VDatePickerMonthTable
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VDatePickerMonthTable
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VDatePickerMonthTable
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VDatePickerMonthTable
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDatePickerMonthTable
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDatePickerMonthTable
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDatePickerMonthTable
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDatePickerMonthTable
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDatePickerMonthTable
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDatePickerMonthTable
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDatePickerMonthTable
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDatePickerMonthTable
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDatePickerMonthTable
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDatePickerMonthTable
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDatePickerMonthTable
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDatePickerMonthTable
...
Sub AddComponent(child As String) As VDatePickerMonthTable
...
Sub SetID(varText As String) As VDatePickerMonthTable
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VDatePickerMonthTable
...
Sub AddToApp(vap As VueApp) As VDatePickerMonthTable
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDatePickerMonthTable
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VDatePickerMonthTable
...
Sub SetCaption(varText As String) As VDatePickerMonthTable
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VDatePickerMonthTable
...
public Sub SetClasses(Classes As String) As VDatePickerMonthTable
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VDatePickerMonthTable
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VDatePickerMonthTable
...
Sub SetStyles(m As Map) As VDatePickerMonthTable
...
Sub SetAttrs(props As Map) As VDatePickerMonthTable
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VDatePickerMonthTable
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VDatePickerMonthTable
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VDatePickerMonthTable
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VDatePickerMonthTable
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VDatePickerMonthTable
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDatePickerMonthTable
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VDatePickerMonthTable
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VDatePickerMonthTable
...
'set text color
Sub SetTextColor1(varColor As String) As VDatePickerMonthTable
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VDatePickerMonthTable
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VDatePickerMonthTable
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VDatePickerMonthTable
	If sVShow = "" Then
		Log($"VDatePickerMonthTable.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDatePickerMonthTable
	If sVShow = "" Then
		Log($"VDatePickerMonthTable.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDatePickerMonthTable
	If sVShow = "" Then
		Log($"VDatePickerMonthTable.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDatePickerMonthTable
	if svBindClass = "" then
		Log($"VDatePickerMonthTable.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDatePickerMonthTable
	if svBindStyle = "" then
		Log($"VDatePickerMonthTable.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDatePickerMonthTable
'	If sRequired = "" Then
'		Log($"VDatePickerMonthTable.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDatePickerMonthTable
'	If sReadonly = "" Then
'		Log($"VDatePickerMonthTable.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDatePickerMonthTable
'	If sDisabled = "" Then
'		Log($"VDatePickerMonthTable.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
