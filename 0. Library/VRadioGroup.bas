...
'set parent-id
Sub SetParentId(varParentId As String) As VRadioGroup
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VRadioGroup
sVElseIf = varVElseIf
...
Sub SetOnChangeE(sChange As String) As VRadioGroup
eOnchange = sChange
Return Me
End Sub
...
Sub SetOnClickAppendE(sClickAppend As String) As VRadioGroup
...
Sub SetOnClickPrependE(sClickPrepend As String) As VRadioGroup
...
Sub SetOnMousedownE(sMousedown As String) As VRadioGroup
...
Sub SetOnMouseupE(sMouseup As String) As VRadioGroup
eOnmouseup = sMouseup
Return Me
End Sub
...
Sub SetOnUpdateErrorE(sUpdateError As String) As VRadioGroup
