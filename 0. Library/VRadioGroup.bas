...
#DesignerProperty: Key: Column, DisplayName: Column, FieldType: Boolean, DefaultValue: true , Description: Set column
...
#DesignerProperty: Key: Name, DisplayName: Name, FieldType: String, DefaultValue: , Description: Set name
...
#DesignerProperty: Key: Row, DisplayName: Row, FieldType: Boolean, DefaultValue: false , Description: Set row
...
Sub Class_Globals
	...
	Public bColumn As Boolean = True
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, sName, "s", "name")
...
'set name
Sub SetName(varName As String)
	sName = varName
	mElement.SetAttr("name", sName)
End Sub
