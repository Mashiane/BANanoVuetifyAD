...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VAppBarNavIcon
#IgnoreWarnings:12
...
Private mTagName As String = "v-app-bar-nav-icon" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VAppBarNavIcon 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VAppBarNavIcon
...
'set key
Sub SetKey(varKey As String) As VAppBarNavIcon
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VAppBarNavIcon
...
'set readonly
Sub SetReadonly(varReadonly As String) As VAppBarNavIcon
...
'set ref
Sub SetRef(varRef As String) As VAppBarNavIcon
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VAppBarNavIcon
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VAppBarNavIcon
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VAppBarNavIcon
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VAppBarNavIcon
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VAppBarNavIcon
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VAppBarNavIcon
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VAppBarNavIcon
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VAppBarNavIcon
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VAppBarNavIcon
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VAppBarNavIcon
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VAppBarNavIcon
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VAppBarNavIcon
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VAppBarNavIcon
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VAppBarNavIcon
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VAppBarNavIcon
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VAppBarNavIcon
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VAppBarNavIcon
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VAppBarNavIcon
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VAppBarNavIcon
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VAppBarNavIcon
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VAppBarNavIcon
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VAppBarNavIcon
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VAppBarNavIcon
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VAppBarNavIcon
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VAppBarNavIcon
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VAppBarNavIcon
...
Sub SetOnClick() As VAppBarNavIcon
...
Sub SetOnClickE(sClick As String) As VAppBarNavIcon
eOnclick = sClick
Return Me
End Sub

'set on clickstop event, updates the master events records
Sub SetOnClickStop() As VAppBarNavIcon
...
Sub SetOnClickStopE(sClickStop As String) As VAppBarNavIcon
...
Sub AddComponent(child As String) As VAppBarNavIcon
...
Sub SetID(varText As String) As VAppBarNavIcon
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VAppBarNavIcon
...
Sub AddToApp(vap As VueApp) As VAppBarNavIcon
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VAppBarNavIcon
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VAppBarNavIcon
...
Sub SetCaption(varText As String) As VAppBarNavIcon
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VAppBarNavIcon
...
public Sub SetClasses(Classes As String) As VAppBarNavIcon
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VAppBarNavIcon
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VAppBarNavIcon
...
Sub SetStyles(m As Map) As VAppBarNavIcon
...
Sub SetAttrs(props As Map) As VAppBarNavIcon
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VAppBarNavIcon
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VAppBarNavIcon
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VAppBarNavIcon
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VAppBarNavIcon
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VAppBarNavIcon
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VAppBarNavIcon
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VAppBarNavIcon
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VAppBarNavIcon
...
'set text color
Sub SetTextColor1(varColor As String) As VAppBarNavIcon
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VAppBarNavIcon
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VAppBarNavIcon
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VAppBarNavIcon
	If sVShow = "" Then
		Log($"VAppBarNavIcon.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VAppBarNavIcon
	If sVShow = "" Then
		Log($"VAppBarNavIcon.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VAppBarNavIcon
	If sVShow = "" Then
		Log($"VAppBarNavIcon.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VAppBarNavIcon
	if svBindClass = "" then
		Log($"VAppBarNavIcon.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VAppBarNavIcon
	if svBindStyle = "" then
		Log($"VAppBarNavIcon.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VAppBarNavIcon
'	If sRequired = "" Then
'		Log($"VAppBarNavIcon.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VAppBarNavIcon
'	If sReadonly = "" Then
'		Log($"VAppBarNavIcon.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VAppBarNavIcon
'	If sDisabled = "" Then
'		Log($"VAppBarNavIcon.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
