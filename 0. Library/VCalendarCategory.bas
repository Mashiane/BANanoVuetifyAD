2020-07-08 02:37:15 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VCalendarCategory
#IgnoreWarnings:12
...
Private mTagName As String = "v-calendar-category" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCalendarCategory 
mName = Name 
...
'set categories
Sub SetCategories(varCategories As String) As VCalendarCategory
...
'set category-days
Sub SetCategoryDays(varCategoryDays As String) As VCalendarCategory
...
Sub SetCategoryForInvalid(varCategoryForInvalid As String) As VCalendarCategory
...
Sub SetCategoryHideDynamic(varCategoryHideDynamic As Boolean) As VCalendarCategory
...
Sub SetCategoryShowAll(varCategoryShowAll As Boolean) As VCalendarCategory
...
'set color
Sub SetColor(varColor As String) As VCalendarCategory
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VCalendarCategory
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set day-format
Sub SetDayFormat(varDayFormat As String) As VCalendarCategory
...
'set disabled
Sub SetDisabled(varDisabled As String) As VCalendarCategory
...
'set end
Sub SetEnd(varEnd As Object) As VCalendarCategory
SetAttr("end", varEnd)
Return Me
End Sub

'set first-interval
Sub SetFirstInterval(varFirstInterval As String) As VCalendarCategory
...
'set first-time
Sub SetFirstTime(varFirstTime As String) As VCalendarCategory
...
'set hide-header
Sub SetHideHeader(varHideHeader As Boolean) As VCalendarCategory
...
'set interval-count
Sub SetIntervalCount(varIntervalCount As String) As VCalendarCategory
...
'set interval-format
Sub SetIntervalFormat(varIntervalFormat As String) As VCalendarCategory
...
'set interval-height
Sub SetIntervalHeight(varIntervalHeight As String) As VCalendarCategory
...
Sub SetIntervalMinutes(varIntervalMinutes As String) As VCalendarCategory
...
'set interval-style
Sub SetIntervalStyle(varIntervalStyle As String) As VCalendarCategory
...
'set interval-width
Sub SetIntervalWidth(varIntervalWidth As String) As VCalendarCategory
...
'set key
Sub SetKey(varKey As String) As VCalendarCategory
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VCalendarCategory
bLight = varLight
...
'set locale
Sub SetLocale(varLocale As String) As VCalendarCategory
sLocale = varLocale
...
'set max-days
Sub SetMaxDays(varMaxDays As String) As VCalendarCategory
sMaxDays = varMaxDays
...
'set now
Sub SetNow(varNow As String) As VCalendarCategory
sNow = varNow
SetAttr("now", sNow)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VCalendarCategory
...
'set readonly
Sub SetReadonly(varReadonly As String) As VCalendarCategory
...
'set ref
Sub SetRef(varRef As String) As VCalendarCategory
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VCalendarCategory
...
'set short-intervals
Sub SetShortIntervals(varShortIntervals As Boolean) As VCalendarCategory
...
'set short-weekdays
Sub SetShortWeekdays(varShortWeekdays As Boolean) As VCalendarCategory
...
Sub SetShowIntervalLabel(varShowIntervalLabel As String) As VCalendarCategory
...
'set start
Sub SetStart(varStart As Object) As VCalendarCategory
SetAttr("start", varStart)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCalendarCategory
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCalendarCategory
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCalendarCategory
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCalendarCategory
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VCalendarCategory
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VCalendarCategory
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCalendarCategory
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCalendarCategory
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCalendarCategory
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCalendarCategory
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCalendarCategory
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCalendarCategory
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCalendarCategory
sVText = varVText
...
'set weekday-format
Sub SetWeekdayFormat(varWeekdayFormat As String) As VCalendarCategory
...
'set weekdays
Sub SetWeekdays(varWeekdays As String) As VCalendarCategory
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCalendarCategory
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCalendarCategory
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCalendarCategory
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCalendarCategory
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCalendarCategory
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCalendarCategory
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCalendarCategory
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCalendarCategory
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCalendarCategory
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCalendarCategory
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCalendarCategory
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCalendarCategory
...
Sub AddComponent(child As String) As VCalendarCategory
...
Sub SetID(varText As String) As VCalendarCategory
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCalendarCategory
...
Sub AddToApp(vap As VueApp) As VCalendarCategory
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCalendarCategory
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCalendarCategory
...
Sub SetCaption(varText As String) As VCalendarCategory
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VCalendarCategory
...
public Sub SetClasses(Classes As String) As VCalendarCategory
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCalendarCategory
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCalendarCategory
...
Sub SetStyles(m As Map) As VCalendarCategory
...
Sub SetAttrs(props As Map) As VCalendarCategory
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCalendarCategory
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCalendarCategory
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCalendarCategory
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCalendarCategory
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCalendarCategory
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCalendarCategory
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCalendarCategory
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCalendarCategory
...
'set text color
Sub SetTextColor1(varColor As String) As VCalendarCategory
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCalendarCategory
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCalendarCategory
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCalendarCategory
	If sVShow = "" Then
		Log($"VCalendarCategory.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCalendarCategory
	If sVShow = "" Then
		Log($"VCalendarCategory.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCalendarCategory
	If sVShow = "" Then
		Log($"VCalendarCategory.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCalendarCategory
	if svBindClass = "" then
		Log($"VCalendarCategory.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VCalendarCategory
	if svBindStyle = "" then
		Log($"VCalendarCategory.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VCalendarCategory
'	If sRequired = "" Then
'		Log($"VCalendarCategory.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VCalendarCategory
'	If sReadonly = "" Then
'		Log($"VCalendarCategory.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VCalendarCategory
'	If sDisabled = "" Then
'		Log($"VCalendarCategory.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
