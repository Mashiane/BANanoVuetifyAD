...
#DesignerProperty: Key: Img, DisplayName: Img, FieldType: String, DefaultValue: , Description: Set img
...
#DesignerProperty: Key: Raised, DisplayName: Raised, FieldType: Boolean, DefaultValue: false , Description: Set raised
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bRaised, "b", "raised")
...
'set img
Sub SetImg(varImg As String)
	sImg = varImg
	mElement.SetAttr("img", sImg)
End Sub
...
'set raised
Sub SetRaised(varRaised As Boolean)
	bRaised = varRaised
	mElement.SetAttr("raised", bRaised)
End Sub
