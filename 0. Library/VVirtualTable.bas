2020-07-08 02:40:09 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VVirtualTable
#IgnoreWarnings:12


#DesignerProperty: Key: Caption, DisplayName: Caption, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: ChunkSize, DisplayName: ChunkSize, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: HeaderHeight, DisplayName: HeaderHeight, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-virtual-table" 
	Public bindings As Map 
	Public methods As Map
Private sCaption As String = ""
Private sChunkSize As String = ""
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VVirtualTable 
mName = Name 
...
'set chunk-size
Sub SetChunkSize(varChunkSize As String) As VVirtualTable
sChunkSize = varChunkSize
SetAttr("chunk-size", sChunkSize)
Return Me
End Sub

'set dark
Sub SetDark(varDark As Boolean) As VVirtualTable
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set dense
Sub SetDense(varDense As Boolean) As VVirtualTable
bDense = varDense
...
'set disabled
Sub SetDisabled(varDisabled As String) As VVirtualTable
...
'set fixed-header
Sub SetFixedHeader(varFixedHeader As Boolean) As VVirtualTable
...
'set header-height
Sub SetHeaderHeight(varHeaderHeight As String) As VVirtualTable
sHeaderHeight = varHeaderHeight
SetAttr("header-height", sHeaderHeight)
Return Me
End Sub

'set height
Sub SetHeight(varHeight As String) As VVirtualTable
sHeight = varHeight
...
'set items
Sub SetItems(varItems As Object) As VVirtualTable
SetAttr("items", varItems)
Return Me
End Sub

'set key
Sub SetKey(varKey As String) As VVirtualTable
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VVirtualTable
bLight = varLight
...
'set parent-id
Sub SetParentId(varParentId As String) As VVirtualTable
...
'set readonly
Sub SetReadonly(varReadonly As String) As VVirtualTable
...
'set ref
Sub SetRef(varRef As String) As VVirtualTable
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VVirtualTable
...
'set row-height
Sub SetRowHeight(varRowHeight As String) As VVirtualTable
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VVirtualTable
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VVirtualTable
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VVirtualTable
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VVirtualTable
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VVirtualTable
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VVirtualTable
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VVirtualTable
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VVirtualTable
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VVirtualTable
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VVirtualTable
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VVirtualTable
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VVirtualTable
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VVirtualTable
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VVirtualTable
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VVirtualTable
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VVirtualTable
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VVirtualTable
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VVirtualTable
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VVirtualTable
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VVirtualTable
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VVirtualTable
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VVirtualTable
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VVirtualTable
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VVirtualTable
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VVirtualTable
...
Sub AddComponent(child As String) As VVirtualTable
...
Sub SetID(varText As String) As VVirtualTable
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VVirtualTable
...
Sub AddToApp(vap As VueApp) As VVirtualTable
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VVirtualTable
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VVirtualTable
...
Sub SetCaption(varText As String) As VVirtualTable
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VVirtualTable
...
public Sub SetClasses(Classes As String) As VVirtualTable
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VVirtualTable
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VVirtualTable
...
Sub SetStyles(m As Map) As VVirtualTable
...
Sub SetAttrs(props As Map) As VVirtualTable
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VVirtualTable
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VVirtualTable
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VVirtualTable
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VVirtualTable
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VVirtualTable
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VVirtualTable
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VVirtualTable
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VVirtualTable
...
'set text color
Sub SetTextColor1(varColor As String) As VVirtualTable
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VVirtualTable
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VVirtualTable
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VVirtualTable
	If sVShow = "" Then
		Log($"VVirtualTable.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VVirtualTable
	If sVShow = "" Then
		Log($"VVirtualTable.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VVirtualTable
	If sVShow = "" Then
		Log($"VVirtualTable.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VVirtualTable
	if svBindClass = "" then
		Log($"VVirtualTable.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VVirtualTable
	if svBindStyle = "" then
		Log($"VVirtualTable.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VVirtualTable
'	If sRequired = "" Then
'		Log($"VVirtualTable.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VVirtualTable
'	If sReadonly = "" Then
'		Log($"VVirtualTable.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VVirtualTable
'	If sDisabled = "" Then
'		Log($"VVirtualTable.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
