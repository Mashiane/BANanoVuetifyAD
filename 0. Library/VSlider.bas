...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSlider
#IgnoreWarnings:12
...
Private mTagName As String = "v-slider" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSlider 
mName = Name 
...
'set append-icon
Sub SetAppendIcon(varAppendIcon As String) As VSlider
...
Sub SetBackgroundColor(varBackgroundColor As String) As VSlider
...
'set color
Sub SetColor(varColor As String) As VSlider
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VSlider
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set dense
Sub SetDense(varDense As Boolean) As VSlider
bDense = varDense
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VSlider
...
'set error
Sub SetError(varError As Boolean) As VSlider
bError = varError
...
'set error-count
Sub SetErrorCount(varErrorCount As String) As VSlider
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As String) As VSlider
...
'set height
Sub SetHeight(varHeight As String) As VSlider
sHeight = varHeight
...
'set hide-details
Sub SetHideDetails(varHideDetails As String) As VSlider
...
'set hint
Sub SetHint(varHint As String) As VSlider
sHint = varHint
SetAttr("hint", sHint)
Return Me
End Sub
...
'set inverse-label
Sub SetInverseLabel(varInverseLabel As Boolean) As VSlider
...
'set key
Sub SetKey(varKey As String) As VSlider
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set label
Sub SetLabel(varLabel As String) As VSlider
sLabel = varLabel
...
'set light
Sub SetLight(varLight As Boolean) As VSlider
bLight = varLight
...
'set loader-height
Sub SetLoaderHeight(varLoaderHeight As String) As VSlider
...
'set loading
Sub SetLoading(varLoading As String) As VSlider
sLoading = varLoading
...
'set max
Sub SetMax(varMax As String) As VSlider
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set messages
Sub SetMessages(varMessages As String) As VSlider
...
'set min
Sub SetMin(varMin As String) As VSlider
sMin = varMin
SetAttr("min", sMin)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VSlider
...
'set persistent-hint
Sub SetPersistentHint(varPersistentHint As Boolean) As VSlider
...
'set prepend-icon
Sub SetPrependIcon(varPrependIcon As String) As VSlider
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VSlider
...
'set ref
Sub SetRef(varRef As String) As VSlider
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSlider
...
'set rules
Sub SetRules(varRules As Object) As VSlider
SetAttr("rules", varRules)
Return Me
End Sub

'set step
Sub SetStep(varStep As String) As VSlider
sStep = varStep
SetAttr("step", sStep)
Return Me
End Sub
...
'set success
Sub SetSuccess(varSuccess As Boolean) As VSlider
bSuccess = varSuccess
...
Sub SetSuccessMessages(varSuccessMessages As String) As VSlider
...
'set thumb-color
Sub SetThumbColor(varThumbColor As String) As VSlider
...
'set thumb-label
Sub SetThumbLabel(varThumbLabel As String) As VSlider
...
'set thumb-size
Sub SetThumbSize(varThumbSize As String) As VSlider
...
'set tick-labels
Sub SetTickLabels(varTickLabels As Object) As VSlider
SetAttr("tick-labels", varTickLabels)
Return Me
End Sub

'set tick-size
Sub SetTickSize(varTickSize As String) As VSlider
...
'set ticks
Sub SetTicks(varTicks As String) As VSlider
sTicks = varTicks
...
'set track-color
Sub SetTrackColor(varTrackColor As String) As VSlider
...
Sub SetTrackFillColor(varTrackFillColor As String) As VSlider
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSlider
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSlider
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSlider
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSlider
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSlider
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSlider
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSlider
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSlider
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSlider
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSlider
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSlider
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSlider
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSlider
sVText = varVText
...
Sub SetValidateOnBlur(varValidateOnBlur As Boolean) As VSlider
...
'set value
Sub SetValue(varValue As String) As VSlider
sValue = varValue
...
'set vertical
Sub SetVertical(varVertical As Boolean) As VSlider
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSlider
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSlider
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSlider
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSlider
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSlider
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSlider
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSlider
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSlider
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSlider
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSlider
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSlider
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSlider
...
Sub SetOnClickE(sClick As String) As VSlider
eOnclick = sClick
Return Me
End Sub

'set on clickappend event, updates the master events records
Sub SetOnClickAppend() As VSlider
...
Sub SetOnClickAppendE(sClickAppend As String) As VSlider
eOnclickappend = sClickAppend
Return Me
End Sub

'set on clickprepend event, updates the master events records
Sub SetOnClickPrepend() As VSlider
...
Sub SetOnClickPrependE(sClickPrepend As String) As VSlider
eOnclickprepend = sClickPrepend
Return Me
End Sub

'set on end event, updates the master events records
Sub SetOnEnd() As VSlider
...
Sub SetOnEndE(sEnd As String) As VSlider
eOnend = sEnd
Return Me
End Sub

'set on mousedown event, updates the master events records
Sub SetOnMousedown() As VSlider
...
Sub SetOnMousedownE(sMousedown As String) As VSlider
eOnmousedown = sMousedown
Return Me
End Sub

'set on mouseup event, updates the master events records
Sub SetOnMouseup() As VSlider
...
Sub SetOnMouseupE(sMouseup As String) As VSlider
eOnmouseup = sMouseup
Return Me
End Sub

'set on start event, updates the master events records
Sub SetOnStart() As VSlider
...
Sub SetOnStartE(sStart As String) As VSlider
eOnstart = sStart
Return Me
End Sub

'set on updateerror event, updates the master events records
Sub SetOnUpdateError() As VSlider
...
Sub SetOnUpdateErrorE(sUpdateError As String) As VSlider
...
Sub AddComponent(child As String) As VSlider
...
Sub SetID(varText As String) As VSlider
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSlider
...
Sub AddToApp(vap As VueApp) As VSlider
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSlider
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSlider
...
Sub SetCaption(varText As String) As VSlider
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSlider
...
public Sub SetClasses(Classes As String) As VSlider
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSlider
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSlider
...
Sub SetStyles(m As Map) As VSlider
...
Sub SetAttrs(props As Map) As VSlider
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSlider
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSlider
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSlider
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSlider
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSlider
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSlider
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSlider
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSlider
...
'set text color
Sub SetTextColor1(varColor As String) As VSlider
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSlider
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSlider
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSlider
	If sVShow = "" Then
		Log($"VSlider.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VSlider
	If sVShow = "" Then
		Log($"VSlider.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VSlider
	If sVShow = "" Then
		Log($"VSlider.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSlider
	if svBindClass = "" then
		Log($"VSlider.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSlider
	if svBindStyle = "" then
		Log($"VSlider.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSlider
'	If sRequired = "" Then
'		Log($"VSlider.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSlider
'	If sReadonly = "" Then
'		Log($"VSlider.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSlider
'	If sDisabled = "" Then
'		Log($"VSlider.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
