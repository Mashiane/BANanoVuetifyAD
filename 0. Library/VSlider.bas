...
'set enabled
Sub SetEnabled(varEnabled As String) As VSlider
sEnabled = varEnabled
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As Object) As VSlider
...
'set messages
Sub SetMessages(varMessages As Object) As VSlider
...
Sub SetSuccessMessages(varSuccessMessages As Object) As VSlider
...
Sub AddToApp(va As VueApp) As VSlider
