2020-07-08 02:39:58 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VTimeline
#IgnoreWarnings:12


#DesignerProperty: Key: AlignTop, DisplayName: AlignTop, Description: , FieldType: Boolean, DefaultValue: False
...
Private mTagName As String = "v-timeline" 
	Public bindings As Map 
	Public methods As Map
Private bAlignTop As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VTimeline 
mName = Name 
...
'set align-top
Sub SetAlignTop(varAlignTop As Boolean) As VTimeline
bAlignTop = varAlignTop
SetAttr("align-top", bAlignTop)
Return Me
End Sub

'set dark
Sub SetDark(varDark As Boolean) As VTimeline
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set dense
Sub SetDense(varDense As Boolean) As VTimeline
bDense = varDense
...
'set disabled
Sub SetDisabled(varDisabled As String) As VTimeline
...
'set key
Sub SetKey(varKey As String) As VTimeline
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VTimeline
bLight = varLight
...
'set parent-id
Sub SetParentId(varParentId As String) As VTimeline
...
'set readonly
Sub SetReadonly(varReadonly As String) As VTimeline
...
'set ref
Sub SetRef(varRef As String) As VTimeline
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VTimeline
...
'set reverse
Sub SetReverse(varReverse As Boolean) As VTimeline
bReverse = varReverse
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTimeline
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTimeline
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VTimeline
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VTimeline
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTimeline
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VTimeline
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VTimeline
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VTimeline
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VTimeline
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VTimeline
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VTimeline
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VTimeline
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VTimeline
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTimeline
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTimeline
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTimeline
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTimeline
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTimeline
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTimeline
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTimeline
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTimeline
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTimeline
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTimeline
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTimeline
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTimeline
...
Sub AddComponent(child As String) As VTimeline
...
Sub SetID(varText As String) As VTimeline
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VTimeline
...
Sub AddToApp(vap As VueApp) As VTimeline
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTimeline
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VTimeline
...
Sub SetCaption(varText As String) As VTimeline
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VTimeline
...
public Sub SetClasses(Classes As String) As VTimeline
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VTimeline
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VTimeline
...
Sub SetStyles(m As Map) As VTimeline
...
Sub SetAttrs(props As Map) As VTimeline
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VTimeline
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VTimeline
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VTimeline
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VTimeline
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VTimeline
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTimeline
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VTimeline
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VTimeline
...
'set text color
Sub SetTextColor1(varColor As String) As VTimeline
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VTimeline
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VTimeline
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VTimeline
	If sVShow = "" Then
		Log($"VTimeline.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTimeline
	If sVShow = "" Then
		Log($"VTimeline.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTimeline
	If sVShow = "" Then
		Log($"VTimeline.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTimeline
	if svBindClass = "" then
		Log($"VTimeline.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTimeline
	if svBindStyle = "" then
		Log($"VTimeline.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTimeline
'	If sRequired = "" Then
'		Log($"VTimeline.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTimeline
'	If sReadonly = "" Then
'		Log($"VTimeline.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTimeline
'	If sDisabled = "" Then
'		Log($"VTimeline.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
