2020-07-08 02:39:45 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VTabReverseTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-tab-reverse-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VTabReverseTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VTabReverseTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VTabReverseTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VTabReverseTransition
...
'set key
Sub SetKey(varKey As String) As VTabReverseTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VTabReverseTransition
...
'set mode
Sub SetMode(varMode As String) As VTabReverseTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VTabReverseTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VTabReverseTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VTabReverseTransition
...
'set ref
Sub SetRef(varRef As String) As VTabReverseTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VTabReverseTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTabReverseTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTabReverseTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VTabReverseTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VTabReverseTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTabReverseTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VTabReverseTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VTabReverseTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VTabReverseTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VTabReverseTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VTabReverseTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VTabReverseTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VTabReverseTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VTabReverseTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTabReverseTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTabReverseTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTabReverseTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTabReverseTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTabReverseTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTabReverseTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTabReverseTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTabReverseTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTabReverseTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTabReverseTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTabReverseTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTabReverseTransition
...
Sub AddComponent(child As String) As VTabReverseTransition
...
Sub SetID(varText As String) As VTabReverseTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VTabReverseTransition
...
Sub AddToApp(vap As VueApp) As VTabReverseTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTabReverseTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VTabReverseTransition
...
Sub SetCaption(varText As String) As VTabReverseTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VTabReverseTransition
...
public Sub SetClasses(Classes As String) As VTabReverseTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VTabReverseTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VTabReverseTransition
...
Sub SetStyles(m As Map) As VTabReverseTransition
...
Sub SetAttrs(props As Map) As VTabReverseTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VTabReverseTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VTabReverseTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VTabReverseTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VTabReverseTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VTabReverseTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTabReverseTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VTabReverseTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VTabReverseTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VTabReverseTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VTabReverseTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VTabReverseTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VTabReverseTransition
	If sVShow = "" Then
		Log($"VTabReverseTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTabReverseTransition
	If sVShow = "" Then
		Log($"VTabReverseTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTabReverseTransition
	If sVShow = "" Then
		Log($"VTabReverseTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTabReverseTransition
	if svBindClass = "" then
		Log($"VTabReverseTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTabReverseTransition
	if svBindStyle = "" then
		Log($"VTabReverseTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTabReverseTransition
'	If sRequired = "" Then
'		Log($"VTabReverseTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTabReverseTransition
'	If sReadonly = "" Then
'		Log($"VTabReverseTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTabReverseTransition
'	If sDisabled = "" Then
'		Log($"VTabReverseTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
