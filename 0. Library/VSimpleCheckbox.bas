...
#DesignerProperty: Key: Ripple, DisplayName: Ripple, Description: , DefaultValue: true, FieldType: Boolean
...
#DesignerProperty: Key: Value, DisplayName: Value, Description: , DefaultValue: false, FieldType: Boolean
...
Private bRipple As Boolean = true
...
'set enabled
Sub SetEnabled(varEnabled As String) As VSimpleCheckbox
sEnabled = varEnabled
...
Sub AddToApp(va As VueApp) As VSimpleCheckbox
