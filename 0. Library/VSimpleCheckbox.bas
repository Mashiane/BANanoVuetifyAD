2020-07-08 02:39:23 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSimpleCheckbox
#IgnoreWarnings:12
#Event: input (argument As BANanoEvent)
...
#DesignerProperty: Key: Ripple, DisplayName: Ripple, Description: , FieldType: Boolean, DefaultValue: False
...
Private mTagName As String = "v-simple-checkbox" 
...
Private bRipple As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSimpleCheckbox 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VSimpleCheckbox
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VSimpleCheckbox
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VSimpleCheckbox
...
'set indeterminate
Sub SetIndeterminate(varIndeterminate As Boolean) As VSimpleCheckbox
...
Sub SetIndeterminateIcon(varIndeterminateIcon As String) As VSimpleCheckbox
...
'set key
Sub SetKey(varKey As String) As VSimpleCheckbox
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VSimpleCheckbox
bLight = varLight
...
'set off-icon
Sub SetOffIcon(varOffIcon As String) As VSimpleCheckbox
sOffIcon = varOffIcon
...
'set on-icon
Sub SetOnIcon(varOnIcon As String) As VSimpleCheckbox
sOnIcon = varOnIcon
...
'set parent-id
Sub SetParentId(varParentId As String) As VSimpleCheckbox
...
'set readonly
Sub SetReadonly(varReadonly As String) As VSimpleCheckbox
...
'set ref
Sub SetRef(varRef As String) As VSimpleCheckbox
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSimpleCheckbox
...
'set ripple
Sub SetRipple(varRipple As Boolean) As VSimpleCheckbox
bRipple = varRipple
SetAttr("ripple", bRipple)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSimpleCheckbox
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSimpleCheckbox
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSimpleCheckbox
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSimpleCheckbox
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSimpleCheckbox
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSimpleCheckbox
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSimpleCheckbox
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSimpleCheckbox
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSimpleCheckbox
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSimpleCheckbox
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSimpleCheckbox
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSimpleCheckbox
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSimpleCheckbox
sVText = varVText
...
'set value
Sub SetValue(varValue As Boolean) As VSimpleCheckbox
bValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSimpleCheckbox
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSimpleCheckbox
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSimpleCheckbox
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSimpleCheckbox
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSimpleCheckbox
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSimpleCheckbox
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSimpleCheckbox
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSimpleCheckbox
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSimpleCheckbox
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSimpleCheckbox
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSimpleCheckbox
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSimpleCheckbox
...
Sub SetOnInput() As VSimpleCheckbox
...
Sub SetOnInputE(sInput As String) As VSimpleCheckbox
eOninput = sInput
Return Me
End Sub
...
Sub AddComponent(child As String) As VSimpleCheckbox
...
Sub SetID(varText As String) As VSimpleCheckbox
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSimpleCheckbox
...
Sub AddToApp(vap As VueApp) As VSimpleCheckbox
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSimpleCheckbox
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSimpleCheckbox
...
Sub SetCaption(varText As String) As VSimpleCheckbox
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSimpleCheckbox
...
public Sub SetClasses(Classes As String) As VSimpleCheckbox
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSimpleCheckbox
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSimpleCheckbox
...
Sub SetStyles(m As Map) As VSimpleCheckbox
...
Sub SetAttrs(props As Map) As VSimpleCheckbox
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSimpleCheckbox
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSimpleCheckbox
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSimpleCheckbox
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSimpleCheckbox
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSimpleCheckbox
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSimpleCheckbox
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSimpleCheckbox
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSimpleCheckbox
...
'set text color
Sub SetTextColor1(varColor As String) As VSimpleCheckbox
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSimpleCheckbox
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSimpleCheckbox
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSimpleCheckbox
	If sVShow = "" Then
		Log($"VSimpleCheckbox.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSimpleCheckbox
	If sVShow = "" Then
		Log($"VSimpleCheckbox.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSimpleCheckbox
	If sVShow = "" Then
		Log($"VSimpleCheckbox.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSimpleCheckbox
	if svBindClass = "" then
		Log($"VSimpleCheckbox.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSimpleCheckbox
	if svBindStyle = "" then
		Log($"VSimpleCheckbox.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSimpleCheckbox
'	If sRequired = "" Then
'		Log($"VSimpleCheckbox.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSimpleCheckbox
'	If sReadonly = "" Then
'		Log($"VSimpleCheckbox.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSimpleCheckbox
'	If sDisabled = "" Then
'		Log($"VSimpleCheckbox.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
