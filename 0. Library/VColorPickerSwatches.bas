2020-07-08 02:37:43 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VColorPickerSwatches
#IgnoreWarnings:12
...
Private mTagName As String = "v-color-picker-swatches" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VColorPickerSwatches 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VColorPickerSwatches
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VColorPickerSwatches
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VColorPickerSwatches
...
'set key
Sub SetKey(varKey As String) As VColorPickerSwatches
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VColorPickerSwatches
bLight = varLight
...
'set max-height
Sub SetMaxHeight(varMaxHeight As String) As VColorPickerSwatches
...
'set max-width
Sub SetMaxWidth(varMaxWidth As String) As VColorPickerSwatches
...
'set parent-id
Sub SetParentId(varParentId As String) As VColorPickerSwatches
...
'set readonly
Sub SetReadonly(varReadonly As String) As VColorPickerSwatches
...
'set ref
Sub SetRef(varRef As String) As VColorPickerSwatches
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VColorPickerSwatches
...
'set swatches
Sub SetSwatches(varSwatches As Object) As VColorPickerSwatches
SetAttr("swatches", varSwatches)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VColorPickerSwatches
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VColorPickerSwatches
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VColorPickerSwatches
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VColorPickerSwatches
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VColorPickerSwatches
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VColorPickerSwatches
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VColorPickerSwatches
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VColorPickerSwatches
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VColorPickerSwatches
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VColorPickerSwatches
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VColorPickerSwatches
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VColorPickerSwatches
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VColorPickerSwatches
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VColorPickerSwatches
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VColorPickerSwatches
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VColorPickerSwatches
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VColorPickerSwatches
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VColorPickerSwatches
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VColorPickerSwatches
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VColorPickerSwatches
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VColorPickerSwatches
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VColorPickerSwatches
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VColorPickerSwatches
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VColorPickerSwatches
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VColorPickerSwatches
...
Sub AddComponent(child As String) As VColorPickerSwatches
...
Sub SetID(varText As String) As VColorPickerSwatches
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VColorPickerSwatches
...
Sub AddToApp(vap As VueApp) As VColorPickerSwatches
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VColorPickerSwatches
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VColorPickerSwatches
...
Sub SetCaption(varText As String) As VColorPickerSwatches
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VColorPickerSwatches
...
public Sub SetClasses(Classes As String) As VColorPickerSwatches
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VColorPickerSwatches
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VColorPickerSwatches
...
Sub SetStyles(m As Map) As VColorPickerSwatches
...
Sub SetAttrs(props As Map) As VColorPickerSwatches
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VColorPickerSwatches
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VColorPickerSwatches
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VColorPickerSwatches
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VColorPickerSwatches
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VColorPickerSwatches
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VColorPickerSwatches
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VColorPickerSwatches
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VColorPickerSwatches
...
'set text color
Sub SetTextColor1(varColor As String) As VColorPickerSwatches
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VColorPickerSwatches
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VColorPickerSwatches
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VColorPickerSwatches
	If sVShow = "" Then
		Log($"VColorPickerSwatches.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VColorPickerSwatches
	If sVShow = "" Then
		Log($"VColorPickerSwatches.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VColorPickerSwatches
	If sVShow = "" Then
		Log($"VColorPickerSwatches.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VColorPickerSwatches
	if svBindClass = "" then
		Log($"VColorPickerSwatches.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VColorPickerSwatches
	if svBindStyle = "" then
		Log($"VColorPickerSwatches.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VColorPickerSwatches
'	If sRequired = "" Then
'		Log($"VColorPickerSwatches.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VColorPickerSwatches
'	If sReadonly = "" Then
'		Log($"VColorPickerSwatches.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VColorPickerSwatches
'	If sDisabled = "" Then
'		Log($"VColorPickerSwatches.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
