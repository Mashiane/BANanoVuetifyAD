2020-07-08 02:38:13 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VExpandTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-expand-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VExpandTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VExpandTransition
...
'set key
Sub SetKey(varKey As String) As VExpandTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set mode
Sub SetMode(varMode As String) As VExpandTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VExpandTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VExpandTransition
...
'set ref
Sub SetRef(varRef As String) As VExpandTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VExpandTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VExpandTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VExpandTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VExpandTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VExpandTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VExpandTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VExpandTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VExpandTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VExpandTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VExpandTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VExpandTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VExpandTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VExpandTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VExpandTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VExpandTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VExpandTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VExpandTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VExpandTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VExpandTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VExpandTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VExpandTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VExpandTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VExpandTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VExpandTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VExpandTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VExpandTransition
...
Sub AddComponent(child As String) As VExpandTransition
...
Sub SetID(varText As String) As VExpandTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VExpandTransition
...
Sub AddToApp(vap As VueApp) As VExpandTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VExpandTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VExpandTransition
...
Sub SetCaption(varText As String) As VExpandTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VExpandTransition
...
public Sub SetClasses(Classes As String) As VExpandTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VExpandTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VExpandTransition
...
Sub SetStyles(m As Map) As VExpandTransition
...
Sub SetAttrs(props As Map) As VExpandTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VExpandTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VExpandTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VExpandTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VExpandTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VExpandTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VExpandTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VExpandTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VExpandTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VExpandTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VExpandTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VExpandTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VExpandTransition
	If sVShow = "" Then
		Log($"VExpandTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VExpandTransition
	If sVShow = "" Then
		Log($"VExpandTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VExpandTransition
	If sVShow = "" Then
		Log($"VExpandTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VExpandTransition
	if svBindClass = "" then
		Log($"VExpandTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VExpandTransition
	if svBindStyle = "" then
		Log($"VExpandTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VExpandTransition
'	If sRequired = "" Then
'		Log($"VExpandTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VExpandTransition
'	If sReadonly = "" Then
'		Log($"VExpandTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VExpandTransition
'	If sDisabled = "" Then
'		Log($"VExpandTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
