...
'set disabled
Sub SetDisabled(varDisabled As String) As VFooter
...
'set parent-id
Sub SetParentId(varParentId As String) As VFooter
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VFooter
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VFooter
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VFooter
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VFooter
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VFooter
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VFooter
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VFooter
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VFooter
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VFooter
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VFooter
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VFooter
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VFooter
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VFooter
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VFooter
...
'update the state
Sub SetData(prop as string, value as object) As VFooter
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VFooter
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VFooter
...
'toggle
Sub Toggle As VFooter
	If sVShow = "" Then
		Log($"VFooter.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VFooter
	If sVShow = "" Then
		Log($"VFooter.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VFooter
	If sVShow = "" Then
		Log($"VFooter.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VFooter
'	If sRequired = "" Then
'		Log($"VFooter.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VFooter
'	If sReadonly = "" Then
'		Log($"VFooter.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VFooter
'	If sDisabled = "" Then
'		Log($"VFooter.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
