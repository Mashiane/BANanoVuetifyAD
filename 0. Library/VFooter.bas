...
#DesignerProperty: Key: Padless, DisplayName: Padless, FieldType: Boolean, DefaultValue: false , Description: Set padless
...
Sub Class_Globals
	...
	Public bPadless As Boolean = false
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bPadless, "b", "padless")
...
'set padless
Sub SetPadless(varPadless As Boolean)
	bPadless = varPadless
	mElement.SetAttr("padless", bPadless)
End Sub
