2020-07-08 02:39:28 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSlideXReverseTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-slide-x-reverse-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSlideXReverseTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VSlideXReverseTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VSlideXReverseTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VSlideXReverseTransition
...
'set key
Sub SetKey(varKey As String) As VSlideXReverseTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VSlideXReverseTransition
...
'set mode
Sub SetMode(varMode As String) As VSlideXReverseTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VSlideXReverseTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VSlideXReverseTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VSlideXReverseTransition
...
'set ref
Sub SetRef(varRef As String) As VSlideXReverseTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSlideXReverseTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSlideXReverseTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSlideXReverseTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSlideXReverseTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSlideXReverseTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSlideXReverseTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSlideXReverseTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSlideXReverseTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSlideXReverseTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSlideXReverseTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSlideXReverseTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSlideXReverseTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSlideXReverseTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSlideXReverseTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSlideXReverseTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSlideXReverseTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSlideXReverseTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSlideXReverseTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSlideXReverseTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSlideXReverseTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSlideXReverseTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSlideXReverseTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSlideXReverseTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSlideXReverseTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSlideXReverseTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSlideXReverseTransition
...
Sub AddComponent(child As String) As VSlideXReverseTransition
...
Sub SetID(varText As String) As VSlideXReverseTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSlideXReverseTransition
...
Sub AddToApp(vap As VueApp) As VSlideXReverseTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSlideXReverseTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSlideXReverseTransition
...
Sub SetCaption(varText As String) As VSlideXReverseTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSlideXReverseTransition
...
public Sub SetClasses(Classes As String) As VSlideXReverseTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSlideXReverseTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSlideXReverseTransition
...
Sub SetStyles(m As Map) As VSlideXReverseTransition
...
Sub SetAttrs(props As Map) As VSlideXReverseTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSlideXReverseTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSlideXReverseTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSlideXReverseTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSlideXReverseTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSlideXReverseTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSlideXReverseTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSlideXReverseTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSlideXReverseTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VSlideXReverseTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSlideXReverseTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSlideXReverseTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSlideXReverseTransition
	If sVShow = "" Then
		Log($"VSlideXReverseTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSlideXReverseTransition
	If sVShow = "" Then
		Log($"VSlideXReverseTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSlideXReverseTransition
	If sVShow = "" Then
		Log($"VSlideXReverseTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSlideXReverseTransition
	if svBindClass = "" then
		Log($"VSlideXReverseTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSlideXReverseTransition
	if svBindStyle = "" then
		Log($"VSlideXReverseTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSlideXReverseTransition
'	If sRequired = "" Then
'		Log($"VSlideXReverseTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSlideXReverseTransition
'	If sReadonly = "" Then
'		Log($"VSlideXReverseTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSlideXReverseTransition
'	If sDisabled = "" Then
'		Log($"VSlideXReverseTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
