...
#DesignerProperty: Key: Align, DisplayName: Align, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignContent, DisplayName: AlignContent, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignContentLg, DisplayName: AlignContentLg, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignContentMd, DisplayName: AlignContentMd, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignContentSm, DisplayName: AlignContentSm, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignContentXl, DisplayName: AlignContentXl, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignLg, DisplayName: AlignLg, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignMd, DisplayName: AlignMd, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignSm, DisplayName: AlignSm, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: AlignXl, DisplayName: AlignXl, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: Justify, DisplayName: Justify, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: JustifyLg, DisplayName: JustifyLg, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: JustifyMd, DisplayName: JustifyMd, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: JustifySm, DisplayName: JustifySm, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: JustifyXl, DisplayName: JustifyXl, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Key, DisplayName: Key, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: NoGutters, DisplayName: NoGutters, Description: , FieldType: Boolean, DefaultValue: False
...
'set disabled
Sub SetDisabled(varDisabled As String) As VRow
...
'set parent-id
Sub SetParentId(varParentId As String) As VRow
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VRow
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VRow
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VRow
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VRow
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VRow
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VRow
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VRow
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VRow
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VRow
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VRow
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VRow
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VRow
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VRow
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VRow
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VRow
...
Sub AddToApp(vap As VueApp) As VRow
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VRow
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VRow
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VRow
...
Sub Toggle As VRow
	If sVShow = "" Then
		Log($"VRow.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VRow
	If sVShow = "" Then
		Log($"VRow.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VRow
	If sVShow = "" Then
		Log($"VRow.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VRow
	if svBindClass = "" then
		Log($"VRow.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VRow
	if svBindStyle = "" then
		Log($"VRow.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VRow
'	If sRequired = "" Then
'		Log($"VRow.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VRow
'	If sReadonly = "" Then
'		Log($"VRow.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VRow
'	If sDisabled = "" Then
'		Log($"VRow.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
