...
#DesignerProperty: Key: LightsOut, DisplayName: LightsOut, FieldType: Boolean, DefaultValue: false , Description: Set lights-out
#DesignerProperty: Key: Window, DisplayName: Window, FieldType: Boolean, DefaultValue: false , Description: Set window
...
Sub Class_Globals
	...
	Public bLightsOut As Boolean = False
	Public bWindow As Boolean = False
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, bLightsOut, "b", "lights-out")
		AddAttr(Attributes, bWindow, "b", "window")
...
'set lights-out
Sub SetLightsOut(varLightsOut As Boolean)
	bLightsOut = varLightsOut
	mElement.SetAttr("lights-out", bLightsOut)
End Sub

'set window
Sub SetWindow(varWindow As Boolean)
	bWindow = varWindow
	mElement.SetAttr("window", bWindow)
End Sub
