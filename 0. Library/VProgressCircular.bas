...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VProgressCircular
#IgnoreWarnings:12


#DesignerProperty: Key: Button, DisplayName: Button, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Rotate, DisplayName: Rotate, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Size, DisplayName: Size, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-progress-circular" 
	Public bindings As Map 
	Public methods As Map
Private bButton As Boolean = False
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VProgressCircular 
mName = Name 
...
'set button
Sub SetButton(varButton As Boolean) As VProgressCircular
bButton = varButton
SetAttr("button", bButton)
Return Me
End Sub

'set color
Sub SetColor(varColor As String) As VProgressCircular
sColor = varColor
...
'set disabled
Sub SetDisabled(varDisabled As String) As VProgressCircular
...
'set indeterminate
Sub SetIndeterminate(varIndeterminate As Boolean) As VProgressCircular
...
'set key
Sub SetKey(varKey As String) As VProgressCircular
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VProgressCircular
...
'set readonly
Sub SetReadonly(varReadonly As String) As VProgressCircular
...
'set ref
Sub SetRef(varRef As String) As VProgressCircular
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VProgressCircular
...
'set rotate
Sub SetRotate(varRotate As String) As VProgressCircular
sRotate = varRotate
...
'set size
Sub SetSize(varSize As String) As VProgressCircular
sSize = varSize
SetAttr("size", sSize)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VProgressCircular
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VProgressCircular
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VProgressCircular
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VProgressCircular
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VProgressCircular
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VProgressCircular
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VProgressCircular
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VProgressCircular
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VProgressCircular
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VProgressCircular
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VProgressCircular
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VProgressCircular
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VProgressCircular
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VProgressCircular
sValue = varValue
...
'set width
Sub SetWidth(varWidth As String) As VProgressCircular
sWidth = varWidth
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VProgressCircular
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VProgressCircular
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VProgressCircular
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VProgressCircular
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VProgressCircular
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VProgressCircular
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VProgressCircular
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VProgressCircular
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VProgressCircular
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VProgressCircular
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VProgressCircular
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VProgressCircular
...
Sub AddComponent(child As String) As VProgressCircular
...
Sub SetID(varText As String) As VProgressCircular
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VProgressCircular
...
Sub AddToApp(vap As VueApp) As VProgressCircular
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VProgressCircular
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VProgressCircular
...
Sub SetCaption(varText As String) As VProgressCircular
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VProgressCircular
...
public Sub SetClasses(Classes As String) As VProgressCircular
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VProgressCircular
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VProgressCircular
...
Sub SetStyles(m As Map) As VProgressCircular
...
Sub SetAttrs(props As Map) As VProgressCircular
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VProgressCircular
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VProgressCircular
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VProgressCircular
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VProgressCircular
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VProgressCircular
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VProgressCircular
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VProgressCircular
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VProgressCircular
...
'set text color
Sub SetTextColor1(varColor As String) As VProgressCircular
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VProgressCircular
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VProgressCircular
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VProgressCircular
	If sVShow = "" Then
		Log($"VProgressCircular.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VProgressCircular
	If sVShow = "" Then
		Log($"VProgressCircular.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VProgressCircular
	If sVShow = "" Then
		Log($"VProgressCircular.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VProgressCircular
	if svBindClass = "" then
		Log($"VProgressCircular.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VProgressCircular
	if svBindStyle = "" then
		Log($"VProgressCircular.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VProgressCircular
'	If sRequired = "" Then
'		Log($"VProgressCircular.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VProgressCircular
'	If sReadonly = "" Then
'		Log($"VProgressCircular.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VProgressCircular
'	If sDisabled = "" Then
'		Log($"VProgressCircular.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
