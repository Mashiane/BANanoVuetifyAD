...
'set parent-id
Sub SetParentId(varParentId As String) As VColorPicker
...
Sub SetOnInputE(sInput As String) As VColorPicker
eOninput = sInput
Return Me
End Sub
...
Sub SetOnUpdateColorE(sUpdateColor As String) As VColorPicker
eOnupdatecolor = sUpdateColor
Return Me
End Sub
...
Sub SetOnUpdateModeE(sUpdateMode As String) As VColorPicker
eOnupdatemode = sUpdateMode
Return Me
End Sub
