2020-07-08 02:38:07 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VDialogBottomTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-dialog-bottom-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VDialogBottomTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VDialogBottomTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VDialogBottomTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VDialogBottomTransition
...
'set key
Sub SetKey(varKey As String) As VDialogBottomTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VDialogBottomTransition
...
'set mode
Sub SetMode(varMode As String) As VDialogBottomTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VDialogBottomTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VDialogBottomTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VDialogBottomTransition
...
'set ref
Sub SetRef(varRef As String) As VDialogBottomTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VDialogBottomTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDialogBottomTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDialogBottomTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VDialogBottomTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VDialogBottomTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDialogBottomTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VDialogBottomTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VDialogBottomTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VDialogBottomTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VDialogBottomTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VDialogBottomTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VDialogBottomTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VDialogBottomTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VDialogBottomTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDialogBottomTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDialogBottomTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDialogBottomTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDialogBottomTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDialogBottomTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDialogBottomTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDialogBottomTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDialogBottomTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDialogBottomTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDialogBottomTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDialogBottomTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDialogBottomTransition
...
Sub AddComponent(child As String) As VDialogBottomTransition
...
Sub SetID(varText As String) As VDialogBottomTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VDialogBottomTransition
...
Sub AddToApp(vap As VueApp) As VDialogBottomTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDialogBottomTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VDialogBottomTransition
...
Sub SetCaption(varText As String) As VDialogBottomTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VDialogBottomTransition
...
public Sub SetClasses(Classes As String) As VDialogBottomTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VDialogBottomTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VDialogBottomTransition
...
Sub SetStyles(m As Map) As VDialogBottomTransition
...
Sub SetAttrs(props As Map) As VDialogBottomTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VDialogBottomTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VDialogBottomTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VDialogBottomTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VDialogBottomTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VDialogBottomTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDialogBottomTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VDialogBottomTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VDialogBottomTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VDialogBottomTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VDialogBottomTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VDialogBottomTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VDialogBottomTransition
	If sVShow = "" Then
		Log($"VDialogBottomTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDialogBottomTransition
	If sVShow = "" Then
		Log($"VDialogBottomTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDialogBottomTransition
	If sVShow = "" Then
		Log($"VDialogBottomTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDialogBottomTransition
	if svBindClass = "" then
		Log($"VDialogBottomTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDialogBottomTransition
	if svBindStyle = "" then
		Log($"VDialogBottomTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDialogBottomTransition
'	If sRequired = "" Then
'		Log($"VDialogBottomTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDialogBottomTransition
'	If sReadonly = "" Then
'		Log($"VDialogBottomTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDialogBottomTransition
'	If sDisabled = "" Then
'		Log($"VDialogBottomTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
