...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VExpansionPanelContent
#IgnoreWarnings:12
...
Private mTagName As String = "v-expansion-panel-content" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VExpansionPanelContent 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VExpansionPanelContent
sColor = varColor
...
'set disabled
Sub SetDisabled(varDisabled As String) As VExpansionPanelContent
...
'set eager
Sub SetEager(varEager As Boolean) As VExpansionPanelContent
bEager = varEager
...
'set key
Sub SetKey(varKey As String) As VExpansionPanelContent
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VExpansionPanelContent
...
'set readonly
Sub SetReadonly(varReadonly As String) As VExpansionPanelContent
...
'set ref
Sub SetRef(varRef As String) As VExpansionPanelContent
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VExpansionPanelContent
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VExpansionPanelContent
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VExpansionPanelContent
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VExpansionPanelContent
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VExpansionPanelContent
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VExpansionPanelContent
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VExpansionPanelContent
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VExpansionPanelContent
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VExpansionPanelContent
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VExpansionPanelContent
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VExpansionPanelContent
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VExpansionPanelContent
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VExpansionPanelContent
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VExpansionPanelContent
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VExpansionPanelContent
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VExpansionPanelContent
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VExpansionPanelContent
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VExpansionPanelContent
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VExpansionPanelContent
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VExpansionPanelContent
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VExpansionPanelContent
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VExpansionPanelContent
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VExpansionPanelContent
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VExpansionPanelContent
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VExpansionPanelContent
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VExpansionPanelContent
...
Sub AddComponent(child As String) As VExpansionPanelContent
...
Sub SetID(varText As String) As VExpansionPanelContent
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VExpansionPanelContent
...
Sub AddToApp(vap As VueApp) As VExpansionPanelContent
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VExpansionPanelContent
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VExpansionPanelContent
...
Sub SetCaption(varText As String) As VExpansionPanelContent
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VExpansionPanelContent
...
public Sub SetClasses(Classes As String) As VExpansionPanelContent
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VExpansionPanelContent
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VExpansionPanelContent
...
Sub SetStyles(m As Map) As VExpansionPanelContent
...
Sub SetAttrs(props As Map) As VExpansionPanelContent
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VExpansionPanelContent
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VExpansionPanelContent
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VExpansionPanelContent
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VExpansionPanelContent
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VExpansionPanelContent
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VExpansionPanelContent
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VExpansionPanelContent
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VExpansionPanelContent
...
'set text color
Sub SetTextColor1(varColor As String) As VExpansionPanelContent
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VExpansionPanelContent
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VExpansionPanelContent
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VExpansionPanelContent
	If sVShow = "" Then
		Log($"VExpansionPanelContent.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VExpansionPanelContent
	If sVShow = "" Then
		Log($"VExpansionPanelContent.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VExpansionPanelContent
	If sVShow = "" Then
		Log($"VExpansionPanelContent.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VExpansionPanelContent
	if svBindClass = "" then
		Log($"VExpansionPanelContent.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VExpansionPanelContent
	if svBindStyle = "" then
		Log($"VExpansionPanelContent.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VExpansionPanelContent
'	If sRequired = "" Then
'		Log($"VExpansionPanelContent.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VExpansionPanelContent
'	If sReadonly = "" Then
'		Log($"VExpansionPanelContent.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VExpansionPanelContent
'	If sDisabled = "" Then
'		Log($"VExpansionPanelContent.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
