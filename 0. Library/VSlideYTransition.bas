2020-07-08 02:39:31 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSlideYTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-slide-y-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSlideYTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VSlideYTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VSlideYTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VSlideYTransition
...
'set key
Sub SetKey(varKey As String) As VSlideYTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VSlideYTransition
...
'set mode
Sub SetMode(varMode As String) As VSlideYTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VSlideYTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VSlideYTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VSlideYTransition
...
'set ref
Sub SetRef(varRef As String) As VSlideYTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSlideYTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSlideYTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSlideYTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSlideYTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSlideYTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSlideYTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSlideYTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSlideYTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSlideYTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSlideYTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSlideYTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSlideYTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSlideYTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSlideYTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSlideYTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSlideYTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSlideYTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSlideYTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSlideYTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSlideYTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSlideYTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSlideYTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSlideYTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSlideYTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSlideYTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSlideYTransition
...
Sub AddComponent(child As String) As VSlideYTransition
...
Sub SetID(varText As String) As VSlideYTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSlideYTransition
...
Sub AddToApp(vap As VueApp) As VSlideYTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSlideYTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSlideYTransition
...
Sub SetCaption(varText As String) As VSlideYTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSlideYTransition
...
public Sub SetClasses(Classes As String) As VSlideYTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSlideYTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSlideYTransition
...
Sub SetStyles(m As Map) As VSlideYTransition
...
Sub SetAttrs(props As Map) As VSlideYTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSlideYTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSlideYTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSlideYTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSlideYTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSlideYTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSlideYTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSlideYTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSlideYTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VSlideYTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSlideYTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSlideYTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSlideYTransition
	If sVShow = "" Then
		Log($"VSlideYTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSlideYTransition
	If sVShow = "" Then
		Log($"VSlideYTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSlideYTransition
	If sVShow = "" Then
		Log($"VSlideYTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSlideYTransition
	if svBindClass = "" then
		Log($"VSlideYTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSlideYTransition
	if svBindStyle = "" then
		Log($"VSlideYTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSlideYTransition
'	If sRequired = "" Then
'		Log($"VSlideYTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSlideYTransition
'	If sReadonly = "" Then
'		Log($"VSlideYTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSlideYTransition
'	If sDisabled = "" Then
'		Log($"VSlideYTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
