...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VListItemTitle
#IgnoreWarnings:12
...
Private mTagName As String = "v-list-item-title" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VListItemTitle 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VListItemTitle
...
'set key
Sub SetKey(varKey As String) As VListItemTitle
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VListItemTitle
...
'set readonly
Sub SetReadonly(varReadonly As String) As VListItemTitle
...
'set ref
Sub SetRef(varRef As String) As VListItemTitle
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VListItemTitle
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VListItemTitle
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VListItemTitle
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VListItemTitle
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VListItemTitle
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VListItemTitle
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VListItemTitle
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VListItemTitle
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VListItemTitle
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VListItemTitle
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VListItemTitle
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VListItemTitle
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VListItemTitle
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VListItemTitle
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VListItemTitle
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VListItemTitle
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VListItemTitle
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VListItemTitle
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VListItemTitle
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VListItemTitle
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VListItemTitle
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VListItemTitle
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VListItemTitle
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VListItemTitle
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VListItemTitle
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VListItemTitle
...
Sub AddComponent(child As String) As VListItemTitle
...
Sub SetID(varText As String) As VListItemTitle
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VListItemTitle
...
Sub AddToApp(vap As VueApp) As VListItemTitle
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VListItemTitle
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VListItemTitle
...
Sub SetCaption(varText As String) As VListItemTitle
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VListItemTitle
...
public Sub SetClasses(Classes As String) As VListItemTitle
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VListItemTitle
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VListItemTitle
...
Sub SetStyles(m As Map) As VListItemTitle
...
Sub SetAttrs(props As Map) As VListItemTitle
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VListItemTitle
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VListItemTitle
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VListItemTitle
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VListItemTitle
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VListItemTitle
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VListItemTitle
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VListItemTitle
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VListItemTitle
...
'set text color
Sub SetTextColor1(varColor As String) As VListItemTitle
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VListItemTitle
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VListItemTitle
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VListItemTitle
	If sVShow = "" Then
		Log($"VListItemTitle.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VListItemTitle
	If sVShow = "" Then
		Log($"VListItemTitle.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VListItemTitle
	If sVShow = "" Then
		Log($"VListItemTitle.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VListItemTitle
	if svBindClass = "" then
		Log($"VListItemTitle.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VListItemTitle
	if svBindStyle = "" then
		Log($"VListItemTitle.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VListItemTitle
'	If sRequired = "" Then
'		Log($"VListItemTitle.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VListItemTitle
'	If sReadonly = "" Then
'		Log($"VListItemTitle.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VListItemTitle
'	If sDisabled = "" Then
'		Log($"VListItemTitle.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
