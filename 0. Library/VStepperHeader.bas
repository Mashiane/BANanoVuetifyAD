...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VStepperHeader
#IgnoreWarnings:12
...
Private mTagName As String = "v-stepper-header" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VStepperHeader 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VStepperHeader
...
'set key
Sub SetKey(varKey As String) As VStepperHeader
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VStepperHeader
...
'set readonly
Sub SetReadonly(varReadonly As String) As VStepperHeader
...
'set ref
Sub SetRef(varRef As String) As VStepperHeader
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VStepperHeader
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VStepperHeader
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VStepperHeader
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VStepperHeader
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VStepperHeader
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VStepperHeader
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VStepperHeader
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VStepperHeader
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VStepperHeader
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VStepperHeader
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VStepperHeader
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VStepperHeader
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VStepperHeader
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VStepperHeader
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VStepperHeader
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VStepperHeader
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VStepperHeader
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VStepperHeader
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VStepperHeader
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VStepperHeader
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VStepperHeader
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VStepperHeader
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VStepperHeader
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VStepperHeader
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VStepperHeader
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VStepperHeader
...
Sub AddComponent(child As String) As VStepperHeader
...
Sub SetID(varText As String) As VStepperHeader
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VStepperHeader
...
Sub AddToApp(vap As VueApp) As VStepperHeader
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VStepperHeader
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VStepperHeader
...
Sub SetCaption(varText As String) As VStepperHeader
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VStepperHeader
...
public Sub SetClasses(Classes As String) As VStepperHeader
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VStepperHeader
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VStepperHeader
...
Sub SetStyles(m As Map) As VStepperHeader
...
Sub SetAttrs(props As Map) As VStepperHeader
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VStepperHeader
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VStepperHeader
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VStepperHeader
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VStepperHeader
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VStepperHeader
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VStepperHeader
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VStepperHeader
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VStepperHeader
...
'set text color
Sub SetTextColor1(varColor As String) As VStepperHeader
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VStepperHeader
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VStepperHeader
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VStepperHeader
	If sVShow = "" Then
		Log($"VStepperHeader.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VStepperHeader
	If sVShow = "" Then
		Log($"VStepperHeader.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VStepperHeader
	If sVShow = "" Then
		Log($"VStepperHeader.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VStepperHeader
	if svBindClass = "" then
		Log($"VStepperHeader.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VStepperHeader
	if svBindStyle = "" then
		Log($"VStepperHeader.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VStepperHeader
'	If sRequired = "" Then
'		Log($"VStepperHeader.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VStepperHeader
'	If sReadonly = "" Then
'		Log($"VStepperHeader.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VStepperHeader
'	If sDisabled = "" Then
'		Log($"VStepperHeader.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
