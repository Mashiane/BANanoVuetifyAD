...
#DesignerProperty: Key: ReturnObject, DisplayName: ReturnObject, FieldType: Boolean, DefaultValue: true , Description: Set return-object
...
Sub Class_Globals
	...
	Public bReturnObject As Boolean = True
...
'set delimiters
Sub SetDelimiters(varDelimiters As List)
	mElement.SetAttr("delimiters", varDelimiters)
End Sub
