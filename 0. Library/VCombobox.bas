...
#DesignerProperty: Key: ReturnObject, DisplayName: ReturnObject, Description: , DefaultValue: true, FieldType: Boolean
...
Private bReturnObject As Boolean = true
...
'set counter-value
Sub SetCounterValue(varCounterValue As Object) As VCombobox
...
'set enabled
Sub SetEnabled(varEnabled As String) As VCombobox
sEnabled = varEnabled
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As Object) As VCombobox
...
'set filter
Sub SetFilter(varFilter As Object) As VCombobox
...
'set item-disabled
Sub SetItemDisabled(varItemDisabled As Object) As VCombobox
SetAttr("item-disabled", varItemDisabled)
Return Me
End Sub

'set item-text
Sub SetItemText(varItemText As Object) As VCombobox
SetAttr("item-text", varItemText)
Return Me
End Sub

'set item-value
Sub SetItemValue(varItemValue As Object) As VCombobox
...
'set menu-props
Sub SetMenuProps(varMenuProps As Object) As VCombobox
SetAttr("menu-props", varMenuProps)
Return Me
End Sub

'set messages
Sub SetMessages(varMessages As Object) As VCombobox
...
Sub SetSuccessMessages(varSuccessMessages As Object) As VCombobox
...
Sub SetValueComparator(varValueComparator As Object) As VCombobox
...
Sub AddToApp(va As VueApp) As VCombobox
