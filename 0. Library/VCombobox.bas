2020-06-21 22:40:03 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VCombobox
#IgnoreWarnings:12
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCombobox 
mName = Name 
...
'set allow-overflow
Sub SetAllowOverflow(varAllowOverflow As Boolean) As VCombobox
...
'set append-icon
Sub SetAppendIcon(varAppendIcon As String) As VCombobox
...
Sub SetAppendOuterIcon(varAppendOuterIcon As String) As VCombobox
...
'set attach
Sub SetAttach(varAttach As String) As VCombobox
sAttach = varAttach
...
Sub SetAutoSelectFirst(varAutoSelectFirst As Boolean) As VCombobox
...
'set autofocus
Sub SetAutofocus(varAutofocus As Boolean) As VCombobox
...
Sub SetBackgroundColor(varBackgroundColor As String) As VCombobox
...
'set cache-items
Sub SetCacheItems(varCacheItems As Boolean) As VCombobox
...
'set chips
Sub SetChips(varChips As Boolean) As VCombobox
bChips = varChips
...
'set clear-icon
Sub SetClearIcon(varClearIcon As String) As VCombobox
...
'set clearable
Sub SetClearable(varClearable As Boolean) As VCombobox
...
'set color
Sub SetColor(varColor As String) As VCombobox
sColor = varColor
...
'set counter
Sub SetCounter(varCounter As String) As VCombobox
sCounter = varCounter
...
'set counter-value
Sub SetCounterValue(varCounterValue As String) As VCombobox
...
'set dark
Sub SetDark(varDark As Boolean) As VCombobox
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set deletable-chips
Sub SetDeletableChips(varDeletableChips As Boolean) As VCombobox
...
'set delimiters
Sub SetDelimiters(varDelimiters As Object) As VCombobox
SetAttr("delimiters", varDelimiters)
Return Me
End Sub

'set dense
Sub SetDense(varDense As Boolean) As VCombobox
bDense = varDense
...
'set disable-lookup
Sub SetDisableLookup(varDisableLookup As Boolean) As VCombobox
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VCombobox
...
'set eager
Sub SetEager(varEager As Boolean) As VCombobox
bEager = varEager
...
'set error
Sub SetError(varError As Boolean) As VCombobox
bError = varError
...
'set error-count
Sub SetErrorCount(varErrorCount As String) As VCombobox
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As String) As VCombobox
...
'set filled
Sub SetFilled(varFilled As Boolean) As VCombobox
bFilled = varFilled
...
'set filter
Sub SetFilter(varFilter As String) As VCombobox
sFilter = varFilter
...
'set flat
Sub SetFlat(varFlat As Boolean) As VCombobox
bFlat = varFlat
SetAttr("flat", bFlat)
Return Me
End Sub
...
'set full-width
Sub SetFullWidth(varFullWidth As Boolean) As VCombobox
...
'set height
Sub SetHeight(varHeight As String) As VCombobox
sHeight = varHeight
...
'set hide-details
Sub SetHideDetails(varHideDetails As String) As VCombobox
...
'set hide-no-data
Sub SetHideNoData(varHideNoData As Boolean) As VCombobox
...
'set hide-selected
Sub SetHideSelected(varHideSelected As Boolean) As VCombobox
...
'set hint
Sub SetHint(varHint As String) As VCombobox
sHint = varHint
SetAttr("hint", sHint)
Return Me
End Sub
...
'set item-color
Sub SetItemColor(varItemColor As String) As VCombobox
...
'set item-disabled
Sub SetItemDisabled(varItemDisabled As String) As VCombobox
...
'set item-text
Sub SetItemText(varItemText As String) As VCombobox
...
'set item-value
Sub SetItemValue(varItemValue As String) As VCombobox
...
'set items
Sub SetItems(varItems As Object) As VCombobox
SetAttr("items", varItems)
Return Me
End Sub

'set key
Sub SetKey(varKey As String) As VCombobox
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set label
Sub SetLabel(varLabel As String) As VCombobox
sLabel = varLabel
...
'set light
Sub SetLight(varLight As Boolean) As VCombobox
bLight = varLight
...
'set loader-height
Sub SetLoaderHeight(varLoaderHeight As String) As VCombobox
...
'set loading
Sub SetLoading(varLoading As String) As VCombobox
sLoading = varLoading
...
'set menu-props
Sub SetMenuProps(varMenuProps As String) As VCombobox
...
'set messages
Sub SetMessages(varMessages As String) As VCombobox
...
'set multiple
Sub SetMultiple(varMultiple As Boolean) As VCombobox
...
'set no-data-text
Sub SetNoDataText(varNoDataText As String) As VCombobox
...
'set no-filter
Sub SetNoFilter(varNoFilter As Boolean) As VCombobox
...
'set open-on-clear
Sub SetOpenOnClear(varOpenOnClear As Boolean) As VCombobox
...
'set outlined
Sub SetOutlined(varOutlined As Boolean) As VCombobox
...
'set placeholder
Sub SetPlaceholder(varPlaceholder As String) As VCombobox
...
'set prefix
Sub SetPrefix(varPrefix As String) As VCombobox
sPrefix = varPrefix
...
'set prepend-icon
Sub SetPrependIcon(varPrependIcon As String) As VCombobox
...
Sub SetPrependInnerIcon(varPrependInnerIcon As String) As VCombobox
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VCombobox
...
'set ref
Sub SetRef(varRef As String) As VCombobox
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VCombobox
...
'set return-object
Sub SetReturnObject(varReturnObject As Boolean) As VCombobox
...
'set reverse
Sub SetReverse(varReverse As Boolean) As VCombobox
bReverse = varReverse
...
'set rounded
Sub SetRounded(varRounded As Boolean) As VCombobox
bRounded = varRounded
...
'set rules
Sub SetRules(varRules As Object) As VCombobox
SetAttr("rules", varRules)
Return Me
End Sub

'set search-input
Sub SetSearchInput(varSearchInput As String) As VCombobox
...
'set shaped
Sub SetShaped(varShaped As Boolean) As VCombobox
bShaped = varShaped
...
'set single-line
Sub SetSingleLine(varSingleLine As Boolean) As VCombobox
...
'set small-chips
Sub SetSmallChips(varSmallChips As Boolean) As VCombobox
...
'set solo
Sub SetSolo(varSolo As Boolean) As VCombobox
bSolo = varSolo
SetAttr("solo", bSolo)
Return Me
End Sub
...
'set solo-inverted
Sub SetSoloInverted(varSoloInverted As Boolean) As VCombobox
...
'set success
Sub SetSuccess(varSuccess As Boolean) As VCombobox
bSuccess = varSuccess
...
Sub SetSuccessMessages(varSuccessMessages As String) As VCombobox
...
'set suffix
Sub SetSuffix(varSuffix As String) As VCombobox
sSuffix = varSuffix
...
'set type
Sub SetType(varType As String) As VCombobox
sType = varType
SetAttr("type", sType)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCombobox
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCombobox
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCombobox
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCombobox
sVElse = varVElse
...
'set v-for
Sub SetVFor(varVFor As String) As VCombobox
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCombobox
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCombobox
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCombobox
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCombobox
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCombobox
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCombobox
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCombobox
sVText = varVText
...
Sub SetValidateOnBlur(varValidateOnBlur As Boolean) As VCombobox
...
'set value
Sub SetValue(varValue As String) As VCombobox
sValue = varValue
...
Sub SetValueComparator(varValueComparator As String) As VCombobox
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCombobox
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCombobox
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCombobox
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCombobox
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCombobox
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCombobox
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCombobox
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCombobox
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCombobox
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCombobox
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCombobox
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCombobox
...
Sub SetOnClickAppendOuter() As VCombobox
...
Sub SetOnClickPrepend() As VCombobox
...
Sub SetOnUpdateListIndex() As VCombobox
...
Sub AddComponent(child As String) As VCombobox
...
Sub SetID(varText As String) As VCombobox
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCombobox
...
Sub AddToApp(vap As VueApp) As VCombobox
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCombobox
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCombobox
...
Sub SetCaption(varText As String) As VCombobox
	If mElement <> Null Then
...
public Sub SetClasses(Classes As String) As VCombobox
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCombobox
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCombobox
...
Sub SetStyles(m As Map) As VCombobox
...
Sub SetAttrs(props As Map) As VCombobox
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCombobox
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCombobox
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCombobox
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCombobox
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCombobox
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCombobox
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCombobox
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCombobox
...
'set text color
Sub SetTextColor1(varColor As String) As VCombobox
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCombobox
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCombobox
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCombobox
	If sVShow = "" Then
		Log($"VCombobox.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCombobox
	If sVShow = "" Then
		Log($"VCombobox.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCombobox
	If sVShow = "" Then
		Log($"VCombobox.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCombobox
	if svBindClass = "" then
		Log($"VCombobox.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
Sub SetReadOnlyOnOff(b As Boolean) As VCombobox
	If sReadonly = "" Then
		Log($"VCombobox.ReadOnly - the readonly for ${mName} has not been set!"$)
		Return Me
	End If
