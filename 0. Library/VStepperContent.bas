...
'set disabled
Sub SetDisabled(varDisabled As String) As VStepperContent
...
'set parent-id
Sub SetParentId(varParentId As String) As VStepperContent
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VStepperContent
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VStepperContent
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VStepperContent
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VStepperContent
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VStepperContent
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VStepperContent
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VStepperContent
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VStepperContent
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VStepperContent
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VStepperContent
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VStepperContent
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VStepperContent
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VStepperContent
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VStepperContent
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VStepperContent
...
Sub AddToApp(vap As VueApp) As VStepperContent
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VStepperContent
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VStepperContent
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VStepperContent
...
'toggle
Sub Toggle As VStepperContent
	If sVShow = "" Then
		Log($"VStepperContent.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VStepperContent
	If sVShow = "" Then
		Log($"VStepperContent.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VStepperContent
	If sVShow = "" Then
		Log($"VStepperContent.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VStepperContent
	if svBindClass = "" then
		Log($"VStepperContent.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VStepperContent
	if svBindStyle = "" then
		Log($"VStepperContent.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VStepperContent
'	If sRequired = "" Then
'		Log($"VStepperContent.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VStepperContent
'	If sReadonly = "" Then
'		Log($"VStepperContent.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VStepperContent
'	If sDisabled = "" Then
'		Log($"VStepperContent.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
