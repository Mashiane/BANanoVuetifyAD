2020-07-08 02:39:49 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VTabsItems
#IgnoreWarnings:12
...
Private mTagName As String = "v-tabs-items" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VTabsItems 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VTabsItems
...
'set continuous
Sub SetContinuous(varContinuous As Boolean) As VTabsItems
...
'set dark
Sub SetDark(varDark As Boolean) As VTabsItems
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VTabsItems
...
'set key
Sub SetKey(varKey As String) As VTabsItems
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VTabsItems
bLight = varLight
...
'set mandatory
Sub SetMandatory(varMandatory As Boolean) As VTabsItems
...
'set max
Sub SetMax(varMax As String) As VTabsItems
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set multiple
Sub SetMultiple(varMultiple As Boolean) As VTabsItems
...
'set next-icon
Sub SetNextIcon(varNextIcon As String) As VTabsItems
...
'set parent-id
Sub SetParentId(varParentId As String) As VTabsItems
...
'set prev-icon
Sub SetPrevIcon(varPrevIcon As String) As VTabsItems
...
'set readonly
Sub SetReadonly(varReadonly As String) As VTabsItems
...
'set ref
Sub SetRef(varRef As String) As VTabsItems
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VTabsItems
...
'set reverse
Sub SetReverse(varReverse As Boolean) As VTabsItems
bReverse = varReverse
...
'set show-arrows
Sub SetShowArrows(varShowArrows As Boolean) As VTabsItems
...
Sub SetShowArrowsOnHover(varShowArrowsOnHover As Boolean) As VTabsItems
...
'set touch
Sub SetTouch(varTouch As String) As VTabsItems
sTouch = varTouch
...
'set touchless
Sub SetTouchless(varTouchless As Boolean) As VTabsItems
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTabsItems
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTabsItems
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VTabsItems
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VTabsItems
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTabsItems
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VTabsItems
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VTabsItems
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VTabsItems
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VTabsItems
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VTabsItems
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VTabsItems
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VTabsItems
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VTabsItems
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VTabsItems
sValue = varValue
...
'set vertical
Sub SetVertical(varVertical As Boolean) As VTabsItems
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTabsItems
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTabsItems
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTabsItems
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTabsItems
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTabsItems
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTabsItems
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTabsItems
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTabsItems
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTabsItems
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTabsItems
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTabsItems
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTabsItems
...
Sub SetOnChangeE(sChange As String) As VTabsItems
eOnchange = sChange
Return Me
End Sub
...
Sub AddComponent(child As String) As VTabsItems
...
Sub SetID(varText As String) As VTabsItems
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VTabsItems
...
Sub AddToApp(vap As VueApp) As VTabsItems
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTabsItems
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VTabsItems
...
Sub SetCaption(varText As String) As VTabsItems
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VTabsItems
...
public Sub SetClasses(Classes As String) As VTabsItems
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VTabsItems
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VTabsItems
...
Sub SetStyles(m As Map) As VTabsItems
...
Sub SetAttrs(props As Map) As VTabsItems
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VTabsItems
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VTabsItems
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VTabsItems
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VTabsItems
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VTabsItems
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTabsItems
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VTabsItems
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VTabsItems
...
'set text color
Sub SetTextColor1(varColor As String) As VTabsItems
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VTabsItems
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VTabsItems
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VTabsItems
	If sVShow = "" Then
		Log($"VTabsItems.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTabsItems
	If sVShow = "" Then
		Log($"VTabsItems.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTabsItems
	If sVShow = "" Then
		Log($"VTabsItems.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTabsItems
	if svBindClass = "" then
		Log($"VTabsItems.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTabsItems
	if svBindStyle = "" then
		Log($"VTabsItems.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTabsItems
'	If sRequired = "" Then
'		Log($"VTabsItems.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTabsItems
'	If sReadonly = "" Then
'		Log($"VTabsItems.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTabsItems
'	If sDisabled = "" Then
'		Log($"VTabsItems.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
