2020-07-08 02:39:30 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VSlideYReverseTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-slide-y-reverse-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VSlideYReverseTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VSlideYReverseTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VSlideYReverseTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VSlideYReverseTransition
...
'set key
Sub SetKey(varKey As String) As VSlideYReverseTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VSlideYReverseTransition
...
'set mode
Sub SetMode(varMode As String) As VSlideYReverseTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VSlideYReverseTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VSlideYReverseTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VSlideYReverseTransition
...
'set ref
Sub SetRef(varRef As String) As VSlideYReverseTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VSlideYReverseTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VSlideYReverseTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VSlideYReverseTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VSlideYReverseTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VSlideYReverseTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VSlideYReverseTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VSlideYReverseTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VSlideYReverseTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VSlideYReverseTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VSlideYReverseTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VSlideYReverseTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VSlideYReverseTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VSlideYReverseTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VSlideYReverseTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VSlideYReverseTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VSlideYReverseTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VSlideYReverseTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VSlideYReverseTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VSlideYReverseTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VSlideYReverseTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VSlideYReverseTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VSlideYReverseTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VSlideYReverseTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VSlideYReverseTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VSlideYReverseTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VSlideYReverseTransition
...
Sub AddComponent(child As String) As VSlideYReverseTransition
...
Sub SetID(varText As String) As VSlideYReverseTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VSlideYReverseTransition
...
Sub AddToApp(vap As VueApp) As VSlideYReverseTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VSlideYReverseTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VSlideYReverseTransition
...
Sub SetCaption(varText As String) As VSlideYReverseTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VSlideYReverseTransition
...
public Sub SetClasses(Classes As String) As VSlideYReverseTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VSlideYReverseTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VSlideYReverseTransition
...
Sub SetStyles(m As Map) As VSlideYReverseTransition
...
Sub SetAttrs(props As Map) As VSlideYReverseTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VSlideYReverseTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VSlideYReverseTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VSlideYReverseTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VSlideYReverseTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VSlideYReverseTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VSlideYReverseTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VSlideYReverseTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VSlideYReverseTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VSlideYReverseTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VSlideYReverseTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VSlideYReverseTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VSlideYReverseTransition
	If sVShow = "" Then
		Log($"VSlideYReverseTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VSlideYReverseTransition
	If sVShow = "" Then
		Log($"VSlideYReverseTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VSlideYReverseTransition
	If sVShow = "" Then
		Log($"VSlideYReverseTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VSlideYReverseTransition
	if svBindClass = "" then
		Log($"VSlideYReverseTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VSlideYReverseTransition
	if svBindStyle = "" then
		Log($"VSlideYReverseTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VSlideYReverseTransition
'	If sRequired = "" Then
'		Log($"VSlideYReverseTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VSlideYReverseTransition
'	If sReadonly = "" Then
'		Log($"VSlideYReverseTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VSlideYReverseTransition
'	If sDisabled = "" Then
'		Log($"VSlideYReverseTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
