...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VOverlay
#IgnoreWarnings:12
...
#DesignerProperty: Key: Opacity, DisplayName: Opacity, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-overlay" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VOverlay 
mName = Name 
...
'set absolute
Sub SetAbsolute(varAbsolute As Boolean) As VOverlay
...
'set color
Sub SetColor(varColor As String) As VOverlay
sColor = varColor
...
'set dark
Sub SetDark(varDark As Boolean) As VOverlay
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As String) As VOverlay
...
'set key
Sub SetKey(varKey As String) As VOverlay
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VOverlay
bLight = varLight
...
'set opacity
Sub SetOpacity(varOpacity As String) As VOverlay
sOpacity = varOpacity
SetAttr("opacity", sOpacity)
Return Me
End Sub

'set parent-id
Sub SetParentId(varParentId As String) As VOverlay
...
'set readonly
Sub SetReadonly(varReadonly As String) As VOverlay
...
'set ref
Sub SetRef(varRef As String) As VOverlay
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VOverlay
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VOverlay
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VOverlay
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VOverlay
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VOverlay
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VOverlay
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VOverlay
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VOverlay
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VOverlay
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VOverlay
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VOverlay
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VOverlay
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VOverlay
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VOverlay
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VOverlay
sValue = varValue
...
'set z-index
Sub SetZIndex(varZIndex As String) As VOverlay
sZIndex = varZIndex
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VOverlay
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VOverlay
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VOverlay
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VOverlay
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VOverlay
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VOverlay
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VOverlay
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VOverlay
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VOverlay
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VOverlay
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VOverlay
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VOverlay
...
Sub AddComponent(child As String) As VOverlay
...
Sub SetID(varText As String) As VOverlay
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VOverlay
...
Sub AddToApp(vap As VueApp) As VOverlay
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VOverlay
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VOverlay
...
Sub SetCaption(varText As String) As VOverlay
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VOverlay
...
public Sub SetClasses(Classes As String) As VOverlay
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VOverlay
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VOverlay
...
Sub SetStyles(m As Map) As VOverlay
...
Sub SetAttrs(props As Map) As VOverlay
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VOverlay
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VOverlay
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VOverlay
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VOverlay
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VOverlay
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VOverlay
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VOverlay
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VOverlay
...
'set text color
Sub SetTextColor1(varColor As String) As VOverlay
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VOverlay
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VOverlay
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VOverlay
	If sVShow = "" Then
		Log($"VOverlay.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VOverlay
	If sVShow = "" Then
		Log($"VOverlay.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VOverlay
	If sVShow = "" Then
		Log($"VOverlay.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VOverlay
	if svBindClass = "" then
		Log($"VOverlay.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VOverlay
	if svBindStyle = "" then
		Log($"VOverlay.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VOverlay
'	If sRequired = "" Then
'		Log($"VOverlay.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VOverlay
'	If sReadonly = "" Then
'		Log($"VOverlay.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VOverlay
'	If sDisabled = "" Then
'		Log($"VOverlay.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
