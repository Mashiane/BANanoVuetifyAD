...
#DesignerProperty: Key: Dark, DisplayName: Dark, FieldType: Boolean, DefaultValue: true , Description: Set dark
#DesignerProperty: Key: Light, DisplayName: Light, FieldType: Boolean, DefaultValue: false , Description: Set light
#DesignerProperty: Key: Opacity, DisplayName: Opacity, FieldType: String, DefaultValue: , Description: Set opacity
...
Sub Class_Globals
	...
	Public sColor As String = "#212121"
	Public bDark As Boolean = true
	Public bLight As Boolean = false
	Public sOpacity As String = "0.46"
	Public sValue As String = "true"
	Public sZIndex As String = "5"
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, sOpacity, "s", "opacity")
...
'set opacity
Sub SetOpacity(varOpacity As String)
	sOpacity = varOpacity
	mElement.SetAttr("opacity", sOpacity)
End Sub
