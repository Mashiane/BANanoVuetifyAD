...
#DesignerProperty: Key: Accordion, DisplayName: Accordion, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Focusable, DisplayName: Focusable, Description: , FieldType: Boolean, DefaultValue: False
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VExpansionPanels
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VExpansionPanels
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VExpansionPanels
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VExpansionPanels
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VExpansionPanels
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VExpansionPanels
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VExpansionPanels
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VExpansionPanels
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VExpansionPanels
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VExpansionPanels
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VExpansionPanels
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VExpansionPanels
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VExpansionPanels
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VExpansionPanels
...
'update the state
Sub SetData(prop as string, value as object) As VExpansionPanels
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VExpansionPanels
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VExpansionPanels
...
'toggle
Sub Toggle As VExpansionPanels
	If sVShow = "" Then
		Log($"VExpansionPanels.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VExpansionPanels
	If sVShow = "" Then
		Log($"VExpansionPanels.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VExpansionPanels
	If sVShow = "" Then
		Log($"VExpansionPanels.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VExpansionPanels
	if svBindClass = "" then
		Log($"VExpansionPanels.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
