...
'set disabled
Sub SetDisabled(varDisabled As String) As VToolbar
...
'set outlined
Sub SetOutlined(varOutlined As Boolean) As VToolbar
...
'set parent-id
Sub SetParentId(varParentId As String) As VToolbar
...
'set rounded
Sub SetRounded(varRounded As String) As VToolbar
sRounded = varRounded
...
'set shaped
Sub SetShaped(varShaped As Boolean) As VToolbar
bShaped = varShaped
...
'set src
Sub SetSrc(varSrc As String) As VToolbar
sSrc = varSrc
SetAttr("src", sSrc)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VToolbar
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VToolbar
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VToolbar
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VToolbar
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VToolbar
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VToolbar
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VToolbar
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VToolbar
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VToolbar
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VToolbar
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VToolbar
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VToolbar
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VToolbar
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VToolbar
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VToolbar
...
Sub AddToApp(vap As VueApp) As VToolbar
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VToolbar
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VToolbar
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VToolbar
...
'toggle
Sub Toggle As VToolbar
	If sVShow = "" Then
		Log($"VToolbar.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VToolbar
	If sVShow = "" Then
		Log($"VToolbar.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VToolbar
	If sVShow = "" Then
		Log($"VToolbar.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VToolbar
	if svBindClass = "" then
		Log($"VToolbar.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VToolbar
	if svBindStyle = "" then
		Log($"VToolbar.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VToolbar
'	If sRequired = "" Then
'		Log($"VToolbar.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VToolbar
'	If sReadonly = "" Then
'		Log($"VToolbar.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VToolbar
'	If sDisabled = "" Then
'		Log($"VToolbar.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
