2020-07-08 02:37:33 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VCarouselTransition
#IgnoreWarnings:12
...
Private mTagName As String = "v-carousel-transition" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCarouselTransition 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VCarouselTransition
...
'set group
Sub SetGroup(varGroup As Boolean) As VCarouselTransition
bGroup = varGroup
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Boolean) As VCarouselTransition
...
'set key
Sub SetKey(varKey As String) As VCarouselTransition
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Boolean) As VCarouselTransition
...
'set mode
Sub SetMode(varMode As String) As VCarouselTransition
sMode = varMode
SetAttr("mode", sMode)
Return Me
End Sub
...
'set origin
Sub SetOrigin(varOrigin As String) As VCarouselTransition
sOrigin = varOrigin
...
'set parent-id
Sub SetParentId(varParentId As String) As VCarouselTransition
...
'set readonly
Sub SetReadonly(varReadonly As String) As VCarouselTransition
...
'set ref
Sub SetRef(varRef As String) As VCarouselTransition
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VCarouselTransition
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCarouselTransition
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCarouselTransition
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCarouselTransition
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCarouselTransition
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VCarouselTransition
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VCarouselTransition
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCarouselTransition
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCarouselTransition
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCarouselTransition
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCarouselTransition
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCarouselTransition
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCarouselTransition
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCarouselTransition
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCarouselTransition
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCarouselTransition
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCarouselTransition
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCarouselTransition
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCarouselTransition
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCarouselTransition
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCarouselTransition
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCarouselTransition
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCarouselTransition
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCarouselTransition
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCarouselTransition
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCarouselTransition
...
Sub AddComponent(child As String) As VCarouselTransition
...
Sub SetID(varText As String) As VCarouselTransition
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCarouselTransition
...
Sub AddToApp(vap As VueApp) As VCarouselTransition
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCarouselTransition
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCarouselTransition
...
Sub SetCaption(varText As String) As VCarouselTransition
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VCarouselTransition
...
public Sub SetClasses(Classes As String) As VCarouselTransition
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCarouselTransition
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCarouselTransition
...
Sub SetStyles(m As Map) As VCarouselTransition
...
Sub SetAttrs(props As Map) As VCarouselTransition
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCarouselTransition
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCarouselTransition
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCarouselTransition
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCarouselTransition
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCarouselTransition
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCarouselTransition
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCarouselTransition
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCarouselTransition
...
'set text color
Sub SetTextColor1(varColor As String) As VCarouselTransition
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCarouselTransition
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCarouselTransition
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCarouselTransition
	If sVShow = "" Then
		Log($"VCarouselTransition.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCarouselTransition
	If sVShow = "" Then
		Log($"VCarouselTransition.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCarouselTransition
	If sVShow = "" Then
		Log($"VCarouselTransition.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCarouselTransition
	if svBindClass = "" then
		Log($"VCarouselTransition.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VCarouselTransition
	if svBindStyle = "" then
		Log($"VCarouselTransition.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VCarouselTransition
'	If sRequired = "" Then
'		Log($"VCarouselTransition.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VCarouselTransition
'	If sReadonly = "" Then
'		Log($"VCarouselTransition.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VCarouselTransition
'	If sDisabled = "" Then
'		Log($"VCarouselTransition.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
