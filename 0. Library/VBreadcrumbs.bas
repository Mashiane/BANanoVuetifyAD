...
#DesignerProperty: Key: Divider, DisplayName: Divider, FieldType: String, DefaultValue: , Description: Set divider
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, sDivider, "s", "divider")
...
'set divider
Sub SetDivider(varDivider As String)
	sDivider = varDivider
	mElement.SetAttr("divider", sDivider)
End Sub
