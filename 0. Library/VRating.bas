...
#DesignerProperty: Key: EmptyIcon, DisplayName: EmptyIcon, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: FullIcon, DisplayName: FullIcon, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: HalfIcon, DisplayName: HalfIcon, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: HalfIncrements, DisplayName: HalfIncrements, Description: , FieldType: Boolean, DefaultValue: False
#DesignerProperty: Key: Hover, DisplayName: Hover, Description: , FieldType: Boolean, DefaultValue: False
...
'set disabled
Sub SetDisabled(varDisabled As String) As VRating
...
'set ripple
Sub SetRipple(varRipple As String) As VRating
sRipple = varRipple
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VRating
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VRating
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VRating
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VRating
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VRating
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VRating
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VRating
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VRating
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VRating
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VRating
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VRating
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VRating
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VRating
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VRating
...
Sub AddToApp(vap As VueApp) As VRating
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VRating
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VRating
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VRating
...
'toggle
Sub Toggle As VRating
	If sVShow = "" Then
		Log($"VRating.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VRating
	If sVShow = "" Then
		Log($"VRating.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VRating
	If sVShow = "" Then
		Log($"VRating.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VRating
	if svBindClass = "" then
		Log($"VRating.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
