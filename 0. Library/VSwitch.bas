...
'set parent-id
Sub SetParentId(varParentId As String) As VSwitch
...
Sub SetOnChangeE(sChange As String) As VSwitch
eOnchange = sChange
Return Me
End Sub
...
Sub SetOnClickAppendE(sClickAppend As String) As VSwitch
...
Sub SetOnClickPrependE(sClickPrepend As String) As VSwitch
...
Sub SetOnMousedownE(sMousedown As String) As VSwitch
...
Sub SetOnMouseupE(sMouseup As String) As VSwitch
eOnmouseup = sMouseup
Return Me
End Sub
...
Sub SetOnUpdateErrorE(sUpdateError As String) As VSwitch
