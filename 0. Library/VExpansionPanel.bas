...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VExpansionPanel
#IgnoreWarnings:12
...
Private mTagName As String = "v-expansion-panel" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VExpansionPanel 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VExpansionPanel
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VExpansionPanel
...
'set key
Sub SetKey(varKey As String) As VExpansionPanel
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VExpansionPanel
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VExpansionPanel
...
'set ref
Sub SetRef(varRef As String) As VExpansionPanel
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VExpansionPanel
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VExpansionPanel
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VExpansionPanel
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VExpansionPanel
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VExpansionPanel
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VExpansionPanel
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VExpansionPanel
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VExpansionPanel
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VExpansionPanel
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VExpansionPanel
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VExpansionPanel
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VExpansionPanel
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VExpansionPanel
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VExpansionPanel
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VExpansionPanel
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VExpansionPanel
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VExpansionPanel
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VExpansionPanel
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VExpansionPanel
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VExpansionPanel
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VExpansionPanel
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VExpansionPanel
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VExpansionPanel
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VExpansionPanel
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VExpansionPanel
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VExpansionPanel
...
Sub SetOnChange() As VExpansionPanel
...
Sub SetOnChangeE(sChange As String) As VExpansionPanel
eOnchange = sChange
Return Me
End Sub

'set on click event, updates the master events records
Sub SetOnClick() As VExpansionPanel
...
Sub SetOnClickE(sClick As String) As VExpansionPanel
eOnclick = sClick
Return Me
End Sub
...
Sub AddComponent(child As String) As VExpansionPanel
...
Sub SetID(varText As String) As VExpansionPanel
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VExpansionPanel
...
Sub AddToApp(vap As VueApp) As VExpansionPanel
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VExpansionPanel
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VExpansionPanel
...
Sub SetCaption(varText As String) As VExpansionPanel
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VExpansionPanel
...
public Sub SetClasses(Classes As String) As VExpansionPanel
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VExpansionPanel
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VExpansionPanel
...
Sub SetStyles(m As Map) As VExpansionPanel
...
Sub SetAttrs(props As Map) As VExpansionPanel
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VExpansionPanel
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VExpansionPanel
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VExpansionPanel
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VExpansionPanel
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VExpansionPanel
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VExpansionPanel
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VExpansionPanel
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VExpansionPanel
...
'set text color
Sub SetTextColor1(varColor As String) As VExpansionPanel
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VExpansionPanel
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VExpansionPanel
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VExpansionPanel
	If sVShow = "" Then
		Log($"VExpansionPanel.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VExpansionPanel
	If sVShow = "" Then
		Log($"VExpansionPanel.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VExpansionPanel
	If sVShow = "" Then
		Log($"VExpansionPanel.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VExpansionPanel
	if svBindClass = "" then
		Log($"VExpansionPanel.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VExpansionPanel
'	If sRequired = "" Then
'		Log($"VExpansionPanel.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
