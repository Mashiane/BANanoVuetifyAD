...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTooltip
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTooltip
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTooltip
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTooltip
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTooltip
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTooltip
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTooltip
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTooltip
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTooltip
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTooltip
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTooltip
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTooltip
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTooltip
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTooltip
...
'bind classes
Sub SetVClass(classObj as string) As VTooltip
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTooltip
...
'toggle
Sub Toggle As VTooltip
	If sVShow = "" Then
		Log($"VTooltip.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTooltip
	If sVShow = "" Then
		Log($"VTooltip.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTooltip
	If sVShow = "" Then
		Log($"VTooltip.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
