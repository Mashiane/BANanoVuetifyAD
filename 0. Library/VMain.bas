2020-07-08 02:38:50 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VMain
#IgnoreWarnings:12
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VMain 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VMain
...
'set key
Sub SetKey(varKey As String) As VMain
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VMain
...
'set readonly
Sub SetReadonly(varReadonly As String) As VMain
...
'set ref
Sub SetRef(varRef As String) As VMain
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VMain
...
'set tag
Sub SetTag(varTag As String) As VMain
sTag = varTag
SetAttr("tag", sTag)
Return Me
End Sub
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VMain
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VMain
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VMain
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VMain
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VMain
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VMain
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VMain
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VMain
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VMain
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VMain
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VMain
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VMain
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VMain
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VMain
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VMain
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VMain
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VMain
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VMain
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VMain
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VMain
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VMain
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VMain
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VMain
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VMain
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VMain
...
Sub AddComponent(child As String) As VMain
...
Sub SetID(varText As String) As VMain
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VMain
...
Sub AddToApp(vap As VueApp) As VMain
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VMain
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VMain
...
Sub SetCaption(varText As String) As VMain
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VMain
...
public Sub SetClasses(Classes As String) As VMain
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VMain
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VMain
...
Sub SetStyles(m As Map) As VMain
...
Sub SetAttrs(props As Map) As VMain
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VMain
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VMain
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VMain
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VMain
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VMain
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VMain
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VMain
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VMain
...
'set text color
Sub SetTextColor1(varColor As String) As VMain
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMain
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VMain
	methodName = methodName.ToLowerCase
...
Sub Toggle As VMain
	If sVShow = "" Then
		Log($"VMain.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Hide As VMain
	If sVShow = "" Then
		Log($"VMain.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub Show As VMain
	If sVShow = "" Then
		Log($"VMain.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VMain
	if svBindClass = "" then
		Log($"VMain.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VMain
	if svBindStyle = "" then
		Log($"VMain.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VMain
'	If sRequired = "" Then
'		Log($"VMain.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VMain
'	If sReadonly = "" Then
'		Log($"VMain.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VMain
'	If sDisabled = "" Then
'		Log($"VMain.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
