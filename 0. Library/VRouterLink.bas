...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VRouterLink
#IgnoreWarnings:12
...
Private mTagName As String = "router-link" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VRouterLink 
mName = Name 
...
'set disabled
Sub SetDisabled(varDisabled As String) As VRouterLink
...
'set key
Sub SetKey(varKey As String) As VRouterLink
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VRouterLink
...
'set readonly
Sub SetReadonly(varReadonly As String) As VRouterLink
...
'set ref
Sub SetRef(varRef As String) As VRouterLink
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VRouterLink
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VRouterLink
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VRouterLink
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VRouterLink
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VRouterLink
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VRouterLink
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VRouterLink
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VRouterLink
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VRouterLink
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VRouterLink
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VRouterLink
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VRouterLink
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VRouterLink
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VRouterLink
sVText = varVText
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VRouterLink
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VRouterLink
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VRouterLink
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VRouterLink
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VRouterLink
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VRouterLink
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VRouterLink
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VRouterLink
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VRouterLink
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VRouterLink
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VRouterLink
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VRouterLink
...
Sub AddComponent(child As String) As VRouterLink
...
Sub SetID(varText As String) As VRouterLink
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VRouterLink
...
Sub AddToApp(vap As VueApp) As VRouterLink
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VRouterLink
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VRouterLink
...
Sub SetCaption(varText As String) As VRouterLink
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VRouterLink
...
public Sub SetClasses(Classes As String) As VRouterLink
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VRouterLink
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VRouterLink
...
Sub SetStyles(m As Map) As VRouterLink
...
Sub SetAttrs(props As Map) As VRouterLink
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VRouterLink
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VRouterLink
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VRouterLink
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VRouterLink
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VRouterLink
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VRouterLink
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VRouterLink
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VRouterLink
...
'set text color
Sub SetTextColor1(varColor As String) As VRouterLink
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VRouterLink
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VRouterLink
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VRouterLink
	If sVShow = "" Then
		Log($"VRouterLink.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VRouterLink
	If sVShow = "" Then
		Log($"VRouterLink.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VRouterLink
	If sVShow = "" Then
		Log($"VRouterLink.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VRouterLink
	if svBindClass = "" then
		Log($"VRouterLink.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VRouterLink
	if svBindStyle = "" then
		Log($"VRouterLink.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VRouterLink
'	If sRequired = "" Then
'		Log($"VRouterLink.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VRouterLink
'	If sReadonly = "" Then
'		Log($"VRouterLink.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VRouterLink
'	If sDisabled = "" Then
'		Log($"VRouterLink.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
