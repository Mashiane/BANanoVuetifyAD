...
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VPagination
#IgnoreWarnings:12
#Event: input (argument As Int)
#Event: next (argument As Object)
#Event: previous (argument As Object)


#DesignerProperty: Key: Caption, DisplayName: Caption, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Circle, DisplayName: Circle, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: CurrentPageAriaLabel, DisplayName: CurrentPageAriaLabel, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: TotalVisible, DisplayName: TotalVisible, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: WrapperAriaLabel, DisplayName: WrapperAriaLabel, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: Onnext, DisplayName: Onnext, FieldType: String, DefaultValue: , Description: Event arguments to be passed to the attribute.
#DesignerProperty: Key: Onprevious, DisplayName: Onprevious, FieldType: String, DefaultValue: , Description: Event arguments to be passed to the attribute.
...
Private mTagName As String = "v-pagination" 
...
Private eOnnext As String = ""
Private eOnprevious As String = ""

End Sub

Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VPagination 
mName = Name 
...
eOnnext = props.Get("Onnext")
eOnprevious = props.Get("Onprevious")
...
SetOnInput
'This activates Next the event exists on the module
SetOnNext
'This activates Previous the event exists on the module
SetOnPrevious
...
'set circle
Sub SetCircle(varCircle As Boolean) As VPagination
bCircle = varCircle
SetAttr("circle", bCircle)
Return Me
End Sub

'set color
Sub SetColor(varColor As String) As VPagination
sColor = varColor
SetAttr("color", sColor)
Return Me
End Sub

'set current-page-aria-label
Sub SetCurrentPageAriaLabel(varCurrentPageAriaLabel As String) As VPagination
sCurrentPageAriaLabel = varCurrentPageAriaLabel
SetAttr("current-page-aria-label", sCurrentPageAriaLabel)
Return Me
End Sub

'set dark
Sub SetDark(varDark As Boolean) As VPagination
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VPagination
...
'set key
Sub SetKey(varKey As String) As VPagination
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set length
Sub SetLength(varLength As String) As VPagination
sLength = varLength
...
'set light
Sub SetLight(varLight As Boolean) As VPagination
bLight = varLight
...
'set next-aria-label
Sub SetNextAriaLabel(varNextAriaLabel As String) As VPagination
...
'set next-icon
Sub SetNextIcon(varNextIcon As String) As VPagination
...
'set prev-icon
Sub SetPrevIcon(varPrevIcon As String) As VPagination
sPrevIcon = varPrevIcon
SetAttr("prev-icon", sPrevIcon)
Return Me
End Sub

'set previous-aria-label
Sub SetPreviousAriaLabel(varPreviousAriaLabel As String) As VPagination
sPreviousAriaLabel = varPreviousAriaLabel
SetAttr("previous-aria-label", sPreviousAriaLabel)
Return Me
End Sub

'set readonly
Sub SetReadonly(varReadonly As String) As VPagination
...
'set ref
Sub SetRef(varRef As String) As VPagination
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VPagination
...
'set total-visible
Sub SetTotalVisible(varTotalVisible As String) As VPagination
sTotalVisible = varTotalVisible
SetAttr("total-visible", sTotalVisible)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VPagination
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VPagination
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VPagination
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VPagination
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VPagination
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VPagination
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VPagination
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VPagination
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VPagination
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VPagination
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VPagination
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VPagination
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VPagination
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VPagination
sValue = varValue
SetAttr("value", sValue)
Return Me
End Sub

'set wrapper-aria-label
Sub SetWrapperAriaLabel(varWrapperAriaLabel As String) As VPagination
sWrapperAriaLabel = varWrapperAriaLabel
SetAttr("wrapper-aria-label", sWrapperAriaLabel)
Return Me
End Sub

'set border-color
Sub SetBorderColor(varBorderColor As String) As VPagination
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VPagination
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VPagination
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VPagination
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VPagination
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VPagination
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VPagination
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VPagination
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VPagination
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VPagination
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VPagination
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VPagination
...
sName = sName.tolowercase
If SubExists(mCallBack, sName) = False Then Return Me
Dim sCode As String = $"${sName}(${eOnnext})"$
SetAttr("v-on:next", sCode)
'arguments for the event
...
sName = sName.tolowercase
If SubExists(mCallBack, sName) = False Then Return Me
Dim sCode As String = $"${sName}(${eOnprevious})"$
SetAttr("v-on:previous", sCode)
'arguments for the event
Dim argument As Object 'ignore
Dim cb As BANanoObject = BANano.CallBack(mCallBack, sName, Array(argument))
methods.Put(sName, cb)
...
AddAttr(bCircle, "circle")
AddAttr(sColor, "color")
AddAttr(sCurrentPageAriaLabel, "current-page-aria-label")
AddAttr(bDark, "dark")
...
AddAttr(sTotalVisible, "total-visible")
...
AddAttr(sWrapperAriaLabel, "wrapper-aria-label")
SetStyleSingle("border-color", sBorderColor)
SetStyleSingle("border-style", sBorderStyle)
SetStyleSingle("border-width", sBorderWidth)
SetStyleSingle("border-radius", sBorderRadius)
...
Sub AddComponent(child As String) As VPagination
...
Sub SetID(varText As String) As VPagination
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VPagination
...
Sub AddToApp(vap As VueApp) As VPagination
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VPagination
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VPagination
...
Sub SetCaption(varText As String) As VPagination
	If mElement <> Null Then
...
public Sub SetClasses(Classes As String) As VPagination
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VPagination
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VPagination
...
Sub SetStyles(m As Map) As VPagination
...
Sub SetAttrs(props As Map) As VPagination
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VPagination
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VPagination
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VPagination
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VPagination
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VPagination
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VPagination
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VPagination
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VPagination
...
'set text color
Sub SetTextColor1(varColor As String) As VPagination
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VPagination
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VPagination
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VPagination
	If sVShow = "" Then
		Log($"VPagination.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VPagination
	If sVShow = "" Then
		Log($"VPagination.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VPagination
	If sVShow = "" Then
		Log($"VPagination.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VPagination
	if svBindClass = "" then
		Log($"VPagination.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VPagination
	if svBindStyle = "" then
		Log($"VPagination.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
