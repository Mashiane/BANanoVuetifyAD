...
#DesignerProperty: Key: Circle, DisplayName: Circle, Description: , DefaultValue: false, FieldType: Boolean
...
#DesignerProperty: Key: Length, DisplayName: Length, Description: , DefaultValue: 0, FieldType: String
...
#DesignerProperty: Key: TotalVisible, DisplayName: TotalVisible, Description: , DefaultValue: , FieldType: String
...
'set enabled
Sub SetEnabled(varEnabled As String) As VPagination
sEnabled = varEnabled
...
Sub AddToApp(va As VueApp) As VPagination
