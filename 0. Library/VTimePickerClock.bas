...
#DesignerProperty: Key: AllowedValues, DisplayName: AllowedValues, Description: , FieldType: String, DefaultValue: 
#DesignerProperty: Key: Ampm, DisplayName: Ampm, Description: , FieldType: Boolean, DefaultValue: False
...
#DesignerProperty: Key: Double, DisplayName: Double, Description: , FieldType: Boolean, DefaultValue: False
...
Private sAllowedValues As String = ""
...
sAllowedValues = props.Get("AllowedValues")
...
'set allowed-values
Sub SetAllowedValues(varAllowedValues As String) As VTimePickerClock
sAllowedValues = varAllowedValues
SetAttr("allowed-values", sAllowedValues)
Return Me
End Sub
...
'set format
Sub SetFormat(varFormat As String) As VTimePickerClock
sFormat = varFormat
...
'set parent-id
Sub SetParentId(varParentId As String) As VTimePickerClock
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTimePickerClock
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTimePickerClock
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTimePickerClock
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTimePickerClock
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTimePickerClock
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTimePickerClock
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTimePickerClock
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTimePickerClock
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTimePickerClock
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTimePickerClock
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTimePickerClock
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTimePickerClock
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTimePickerClock
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTimePickerClock
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTimePickerClock
...
AddAttr(sAllowedValues, "allowed-values")
AddAttr(bAmpm, "ampm")
...
Sub AddToApp(vap As VueApp) As VTimePickerClock
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTimePickerClock
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VTimePickerClock
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTimePickerClock
...
'toggle
Sub Toggle As VTimePickerClock
	If sVShow = "" Then
		Log($"VTimePickerClock.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTimePickerClock
	If sVShow = "" Then
		Log($"VTimePickerClock.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTimePickerClock
	If sVShow = "" Then
		Log($"VTimePickerClock.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTimePickerClock
	if svBindClass = "" then
		Log($"VTimePickerClock.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTimePickerClock
	if svBindStyle = "" then
		Log($"VTimePickerClock.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTimePickerClock
'	If sRequired = "" Then
'		Log($"VTimePickerClock.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTimePickerClock
'	If sReadonly = "" Then
'		Log($"VTimePickerClock.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTimePickerClock
'	If sDisabled = "" Then
'		Log($"VTimePickerClock.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
