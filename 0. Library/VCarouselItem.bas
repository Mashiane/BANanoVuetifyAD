2020-07-08 02:37:30 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VCarouselItem
#IgnoreWarnings:12
...
#DesignerProperty: Key: ReverseTransition, DisplayName: ReverseTransition, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-carousel-item" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VCarouselItem 
mName = Name 
...
'set active-class
Sub SetActiveClass(varActiveClass As String) As VCarouselItem
...
'set append
Sub SetAppend(varAppend As Boolean) As VCarouselItem
bAppend = varAppend
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VCarouselItem
...
'set eager
Sub SetEager(varEager As Boolean) As VCarouselItem
bEager = varEager
...
'set exact
Sub SetExact(varExact As Boolean) As VCarouselItem
bExact = varExact
...
Sub SetExactActiveClass(varExactActiveClass As String) As VCarouselItem
...
'set href
Sub SetHref(varHref As String) As VCarouselItem
sHref = varHref
SetAttr("href", sHref)
Return Me
End Sub
...
'set key
Sub SetKey(varKey As String) As VCarouselItem
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set link
Sub SetLink(varLink As Boolean) As VCarouselItem
bLink = varLink
SetAttr("link", bLink)
Return Me
End Sub
...
'set nuxt
Sub SetNuxt(varNuxt As Boolean) As VCarouselItem
bNuxt = varNuxt
SetAttr("nuxt", bNuxt)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VCarouselItem
...
'set readonly
Sub SetReadonly(varReadonly As String) As VCarouselItem
...
'set ref
Sub SetRef(varRef As String) As VCarouselItem
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set replace
Sub SetReplace(varReplace As Boolean) As VCarouselItem
bReplace = varReplace
...
'set required
Sub SetRequired(varRequired As String) As VCarouselItem
...
Sub SetReverseTransition(varReverseTransition As String) As VCarouselItem
...
'set ripple
Sub SetRipple(varRipple As String) As VCarouselItem
sRipple = varRipple
...
'set tag
Sub SetTag(varTag As String) As VCarouselItem
sTag = varTag
SetAttr("tag", sTag)
Return Me
End Sub
...
'set target
Sub SetTarget(varTarget As String) As VCarouselItem
sTarget = varTarget
...
'set to
Sub SetTo(varTo As String) As VCarouselItem
sTo = varTo
SetAttr("to", sTo)
Return Me
End Sub
...
'set transition
Sub SetTransition(varTransition As String) As VCarouselItem
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCarouselItem
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCarouselItem
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VCarouselItem
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VCarouselItem
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VCarouselItem
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VCarouselItem
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VCarouselItem
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VCarouselItem
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VCarouselItem
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VCarouselItem
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VCarouselItem
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VCarouselItem
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VCarouselItem
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VCarouselItem
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCarouselItem
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCarouselItem
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCarouselItem
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCarouselItem
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCarouselItem
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCarouselItem
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCarouselItem
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCarouselItem
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCarouselItem
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCarouselItem
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCarouselItem
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCarouselItem
...
Sub AddComponent(child As String) As VCarouselItem
...
Sub SetID(varText As String) As VCarouselItem
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VCarouselItem
...
Sub AddToApp(vap As VueApp) As VCarouselItem
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCarouselItem
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VCarouselItem
...
Sub SetCaption(varText As String) As VCarouselItem
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VCarouselItem
...
public Sub SetClasses(Classes As String) As VCarouselItem
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VCarouselItem
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VCarouselItem
...
Sub SetStyles(m As Map) As VCarouselItem
...
Sub SetAttrs(props As Map) As VCarouselItem
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VCarouselItem
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VCarouselItem
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VCarouselItem
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VCarouselItem
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VCarouselItem
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCarouselItem
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VCarouselItem
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VCarouselItem
...
'set text color
Sub SetTextColor1(varColor As String) As VCarouselItem
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VCarouselItem
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VCarouselItem
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VCarouselItem
	If sVShow = "" Then
		Log($"VCarouselItem.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCarouselItem
	If sVShow = "" Then
		Log($"VCarouselItem.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCarouselItem
	If sVShow = "" Then
		Log($"VCarouselItem.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCarouselItem
	if svBindClass = "" then
		Log($"VCarouselItem.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VCarouselItem
	if svBindStyle = "" then
		Log($"VCarouselItem.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VCarouselItem
'	If sRequired = "" Then
'		Log($"VCarouselItem.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VCarouselItem
'	If sReadonly = "" Then
'		Log($"VCarouselItem.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VCarouselItem
'	If sDisabled = "" Then
'		Log($"VCarouselItem.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
