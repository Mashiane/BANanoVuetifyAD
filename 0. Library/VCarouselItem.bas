...
#DesignerProperty: Key: ReverseTransition, DisplayName: ReverseTransition, FieldType: String, DefaultValue: , Description: Set reverse-transition
...
Sub Class_Globals
	...
	Public sReverseTransition As String = ""
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, sReverseTransition, "s", "reverse-transition")
...
Sub SetReverseTransition(varReverseTransition As String)
	sReverseTransition = varReverseTransition
	mElement.SetAttr("reverse-transition", sReverseTransition)
End Sub
