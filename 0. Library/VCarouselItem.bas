...
'set enabled
Sub SetEnabled(varEnabled As String) As VCarouselItem
sEnabled = varEnabled
...
'set href
Sub SetHref(varHref As Object) As VCarouselItem
...
'set ripple
Sub SetRipple(varRipple As Object) As VCarouselItem
...
'set to
Sub SetTo(varTo As Object) As VCarouselItem
SetAttr("to", varTo)
Return Me
End Sub
...
Sub AddToApp(va As VueApp) As VCarouselItem
