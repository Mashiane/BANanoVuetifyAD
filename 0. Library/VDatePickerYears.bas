2020-07-08 02:38:03 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VDatePickerYears
#IgnoreWarnings:12
...
Private mTagName As String = "v-date-picker-years" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VDatePickerYears 
mName = Name 
...
'set color
Sub SetColor(varColor As String) As VDatePickerYears
sColor = varColor
...
'set disabled
Sub SetDisabled(varDisabled As String) As VDatePickerYears
...
'set format
Sub SetFormat(varFormat As String) As VDatePickerYears
sFormat = varFormat
...
'set key
Sub SetKey(varKey As String) As VDatePickerYears
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set locale
Sub SetLocale(varLocale As String) As VDatePickerYears
sLocale = varLocale
...
'set max
Sub SetMax(varMax As String) As VDatePickerYears
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set min
Sub SetMin(varMin As String) As VDatePickerYears
sMin = varMin
SetAttr("min", sMin)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VDatePickerYears
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VDatePickerYears
...
'set ref
Sub SetRef(varRef As String) As VDatePickerYears
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VDatePickerYears
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDatePickerYears
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDatePickerYears
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VDatePickerYears
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VDatePickerYears
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDatePickerYears
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VDatePickerYears
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VDatePickerYears
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VDatePickerYears
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VDatePickerYears
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VDatePickerYears
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VDatePickerYears
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VDatePickerYears
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VDatePickerYears
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VDatePickerYears
sValue = varValue
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDatePickerYears
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDatePickerYears
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDatePickerYears
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDatePickerYears
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDatePickerYears
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDatePickerYears
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDatePickerYears
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDatePickerYears
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDatePickerYears
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDatePickerYears
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDatePickerYears
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDatePickerYears
...
Sub AddComponent(child As String) As VDatePickerYears
...
Sub SetID(varText As String) As VDatePickerYears
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VDatePickerYears
...
Sub AddToApp(vap As VueApp) As VDatePickerYears
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDatePickerYears
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VDatePickerYears
...
Sub SetCaption(varText As String) As VDatePickerYears
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VDatePickerYears
...
public Sub SetClasses(Classes As String) As VDatePickerYears
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VDatePickerYears
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VDatePickerYears
...
Sub SetStyles(m As Map) As VDatePickerYears
...
Sub SetAttrs(props As Map) As VDatePickerYears
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VDatePickerYears
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VDatePickerYears
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VDatePickerYears
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VDatePickerYears
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VDatePickerYears
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDatePickerYears
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VDatePickerYears
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VDatePickerYears
...
'set text color
Sub SetTextColor1(varColor As String) As VDatePickerYears
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VDatePickerYears
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VDatePickerYears
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VDatePickerYears
	If sVShow = "" Then
		Log($"VDatePickerYears.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDatePickerYears
	If sVShow = "" Then
		Log($"VDatePickerYears.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDatePickerYears
	If sVShow = "" Then
		Log($"VDatePickerYears.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDatePickerYears
	if svBindClass = "" then
		Log($"VDatePickerYears.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDatePickerYears
	if svBindStyle = "" then
		Log($"VDatePickerYears.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDatePickerYears
'	If sRequired = "" Then
'		Log($"VDatePickerYears.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDatePickerYears
'	If sReadonly = "" Then
'		Log($"VDatePickerYears.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDatePickerYears
'	If sDisabled = "" Then
'		Log($"VDatePickerYears.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
