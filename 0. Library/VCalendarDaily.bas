...
'set day-format
Sub SetDayFormat(varDayFormat As String) As VCalendarDaily
...
'set disabled
Sub SetDisabled(varDisabled As String) As VCalendarDaily
...
'set interval-format
Sub SetIntervalFormat(varIntervalFormat As String) As VCalendarDaily
...
'set interval-style
Sub SetIntervalStyle(varIntervalStyle As String) As VCalendarDaily
...
'set parent-id
Sub SetParentId(varParentId As String) As VCalendarDaily
...
Sub SetShowIntervalLabel(varShowIntervalLabel As String) As VCalendarDaily
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VCalendarDaily
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VCalendarDaily
...
'set weekday-format
Sub SetWeekdayFormat(varWeekdayFormat As String) As VCalendarDaily
...
'set weekdays
Sub SetWeekdays(varWeekdays As String) As VCalendarDaily
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VCalendarDaily
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VCalendarDaily
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VCalendarDaily
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VCalendarDaily
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VCalendarDaily
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VCalendarDaily
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VCalendarDaily
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VCalendarDaily
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VCalendarDaily
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VCalendarDaily
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VCalendarDaily
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VCalendarDaily
...
Sub AddToApp(vap As VueApp) As VCalendarDaily
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VCalendarDaily
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VCalendarDaily
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VCalendarDaily
...
'toggle
Sub Toggle As VCalendarDaily
	If sVShow = "" Then
		Log($"VCalendarDaily.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VCalendarDaily
	If sVShow = "" Then
		Log($"VCalendarDaily.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VCalendarDaily
	If sVShow = "" Then
		Log($"VCalendarDaily.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VCalendarDaily
	if svBindClass = "" then
		Log($"VCalendarDaily.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VCalendarDaily
	if svBindStyle = "" then
		Log($"VCalendarDaily.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VCalendarDaily
'	If sRequired = "" Then
'		Log($"VCalendarDaily.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VCalendarDaily
'	If sReadonly = "" Then
'		Log($"VCalendarDaily.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VCalendarDaily
'	If sDisabled = "" Then
'		Log($"VCalendarDaily.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
