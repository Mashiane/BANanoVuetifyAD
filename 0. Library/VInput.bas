...
'set enabled
Sub SetEnabled(varEnabled As String) As VInput
sEnabled = varEnabled
...
'set error-messages
Sub SetErrorMessages(varErrorMessages As Object) As VInput
...
'set messages
Sub SetMessages(varMessages As Object) As VInput
...
Sub SetSuccessMessages(varSuccessMessages As Object) As VInput
...
Sub AddToApp(va As VueApp) As VInput
