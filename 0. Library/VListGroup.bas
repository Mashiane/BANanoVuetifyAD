...
#DesignerProperty: Key: Group, DisplayName: Group, FieldType: String, DefaultValue: , Description: Set group
#DesignerProperty: Key: NoAction, DisplayName: NoAction, FieldType: Boolean, DefaultValue: false , Description: Set no-action
#DesignerProperty: Key: PrependIcon, DisplayName: PrependIcon, FieldType: String, DefaultValue: , Description: Set prepend-icon
#DesignerProperty: Key: SubGroup, DisplayName: SubGroup, FieldType: Boolean, DefaultValue: false , Description: Set sub-group
...
Sub Class_Globals
	...
	Public sAppendIcon As String = "$expand"
	...
	Public bSubGroup As Boolean = false
...
Public Sub DesignerCreateView (Target As BANanoElement, props As Map)
	...
	If props <> Null Then
		...
		AddAttr(Attributes, sGroup, "s", "group")
		AddAttr(Attributes, bNoAction, "b", "no-action")
		AddAttr(Attributes, sPrependIcon, "s", "prepend-icon")
		AddAttr(Attributes, bSubGroup, "b", "sub-group")
...
'set group
Sub SetGroup(varGroup As String)
	sGroup = varGroup
	mElement.SetAttr("group", sGroup)
End Sub

'set no-action
Sub SetNoAction(varNoAction As Boolean)
	bNoAction = varNoAction
	mElement.SetAttr("no-action", bNoAction)
End Sub
...
'set sub-group
Sub SetSubGroup(varSubGroup As Boolean)
	bSubGroup = varSubGroup
	mElement.SetAttr("sub-group", bSubGroup)
End Sub
