...
#DesignerProperty: Key: Borderless, DisplayName: Borderless, Description: , FieldType: Boolean, DefaultValue: False
...
'set disabled
Sub SetDisabled(varDisabled As String) As VBtnToggle
...
'set parent-id
Sub SetParentId(varParentId As String) As VBtnToggle
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VBtnToggle
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VBtnToggle
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VBtnToggle
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VBtnToggle
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VBtnToggle
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VBtnToggle
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VBtnToggle
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VBtnToggle
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VBtnToggle
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VBtnToggle
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VBtnToggle
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VBtnToggle
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VBtnToggle
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VBtnToggle
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VBtnToggle
...
Sub SetOnChangeE(sChange As String) As VBtnToggle
eOnchange = sChange
Return Me
End Sub
...
Sub AddToApp(vap As VueApp) As VBtnToggle
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VBtnToggle
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VBtnToggle
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VBtnToggle
...
'toggle
Sub Toggle As VBtnToggle
	If sVShow = "" Then
		Log($"VBtnToggle.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VBtnToggle
	If sVShow = "" Then
		Log($"VBtnToggle.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VBtnToggle
	If sVShow = "" Then
		Log($"VBtnToggle.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VBtnToggle
	if svBindClass = "" then
		Log($"VBtnToggle.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VBtnToggle
	if svBindStyle = "" then
		Log($"VBtnToggle.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VBtnToggle
'	If sRequired = "" Then
'		Log($"VBtnToggle.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VBtnToggle
'	If sReadonly = "" Then
'		Log($"VBtnToggle.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VBtnToggle
'	If sDisabled = "" Then
'		Log($"VBtnToggle.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
