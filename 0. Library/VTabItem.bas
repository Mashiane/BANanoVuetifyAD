...
'set parent-id
Sub SetParentId(varParentId As String) As VTabItem
...
'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VTabItem
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VTabItem
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VTabItem
sVElseIf = varVElseIf
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VTabItem
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VTabItem
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VTabItem
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VTabItem
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VTabItem
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VTabItem
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VTabItem
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VTabItem
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VTabItem
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VTabItem
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VTabItem
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VTabItem
...
Sub AddToApp(vap As VueApp) As VTabItem
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VTabItem
	data.put(prop, value)
	Return Me
End Sub
...
'bind classes
Sub SetVClass(classObj as string) As VTabItem
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VTabItem
...
'toggle
Sub Toggle As VTabItem
	If sVShow = "" Then
		Log($"VTabItem.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VTabItem
	If sVShow = "" Then
		Log($"VTabItem.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VTabItem
	If sVShow = "" Then
		Log($"VTabItem.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VTabItem
	if svBindClass = "" then
		Log($"VTabItem.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VTabItem
	if svBindStyle = "" then
		Log($"VTabItem.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VTabItem
'	If sRequired = "" Then
'		Log($"VTabItem.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VTabItem
'	If sReadonly = "" Then
'		Log($"VTabItem.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VTabItem
'	If sDisabled = "" Then
'		Log($"VTabItem.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
