2020-07-08 02:37:57 B4J=true
Group=Default Group
ModulesStructureVersion=1
Type=Class
Version=8.3
@EndOfDesignText@
'Custom BANano View class: VDatePickerDateTable
#IgnoreWarnings:12
...
#DesignerProperty: Key: Current, DisplayName: Current, Description: , FieldType: String, DefaultValue: 
...
#DesignerProperty: Key: TableDate, DisplayName: TableDate, Description: , FieldType: String, DefaultValue: 
...
Private mTagName As String = "v-date-picker-date-table" 
...
Public Sub Initialize (CallBack As Object, Name As String, EventName As String) As VDatePickerDateTable 
mName = Name 
...
sTableDate = props.Get("TableDate")
...
'set allowed-dates
Sub SetAllowedDates(varAllowedDates As String) As VDatePickerDateTable
...
'set color
Sub SetColor(varColor As String) As VDatePickerDateTable
sColor = varColor
...
'set current
Sub SetCurrent(varCurrent As String) As VDatePickerDateTable
sCurrent = varCurrent
SetAttr("current", sCurrent)
Return Me
End Sub

'set dark
Sub SetDark(varDark As Boolean) As VDatePickerDateTable
bDark = varDark
SetAttr("dark", bDark)
Return Me
End Sub
...
'set disabled
Sub SetDisabled(varDisabled As Boolean) As VDatePickerDateTable
...
'set event-color
Sub SetEventColor(varEventColor As String) As VDatePickerDateTable
...
'set events
Sub SetEvents(varEvents As String) As VDatePickerDateTable
sEvents = varEvents
...
Sub SetFirstDayOfWeek(varFirstDayOfWeek As String) As VDatePickerDateTable
...
'set format
Sub SetFormat(varFormat As String) As VDatePickerDateTable
sFormat = varFormat
...
'set key
Sub SetKey(varKey As String) As VDatePickerDateTable
sKey = varKey
SetAttr("key", sKey)
Return Me
End Sub
...
'set light
Sub SetLight(varLight As Boolean) As VDatePickerDateTable
bLight = varLight
...
'set locale
Sub SetLocale(varLocale As String) As VDatePickerDateTable
sLocale = varLocale
...
Sub SetLocaleFirstDayOfYear(varLocaleFirstDayOfYear As String) As VDatePickerDateTable
...
'set max
Sub SetMax(varMax As String) As VDatePickerDateTable
sMax = varMax
SetAttr("max", sMax)
Return Me
End Sub
...
'set min
Sub SetMin(varMin As String) As VDatePickerDateTable
sMin = varMin
SetAttr("min", sMin)
Return Me
End Sub
...
'set parent-id
Sub SetParentId(varParentId As String) As VDatePickerDateTable
...
'set range
Sub SetRange(varRange As Boolean) As VDatePickerDateTable
bRange = varRange
...
'set readonly
Sub SetReadonly(varReadonly As Boolean) As VDatePickerDateTable
...
'set ref
Sub SetRef(varRef As String) As VDatePickerDateTable
sRef = varRef
SetAttr("ref", sRef)
Return Me
End Sub
...
'set required
Sub SetRequired(varRequired As String) As VDatePickerDateTable
...
'set scrollable
Sub SetScrollable(varScrollable As Boolean) As VDatePickerDateTable
...
'set show-week
Sub SetShowWeek(varShowWeek As Boolean) As VDatePickerDateTable
...
'set table-date
Sub SetTableDate(varTableDate As String) As VDatePickerDateTable
sTableDate = varTableDate
SetAttr("table-date", sTableDate)
Return Me
End Sub

'set v-bind:class
Sub SetVBindClass(varVBindClass As String) As VDatePickerDateTable
...
'set v-bind:style
Sub SetVBindStyle(varVBindStyle As String) As VDatePickerDateTable
...
'set v-cloak
Sub SetVCloak(varVCloak As Boolean) As VDatePickerDateTable
bVCloak = varVCloak
...
'set v-else
Sub SetVElse(varVElse As String) As VDatePickerDateTable
sVElse = varVElse
...
'set v-else-if
Sub SetVElseIf(varVElseIf As String) As VDatePickerDateTable
sVElseIf = varVElseIf
...
'set v-for
Sub SetVFor(varVFor As String) As VDatePickerDateTable
sVFor = varVFor
SetAttr("v-for", sVFor)
Return Me
End Sub
...
'set v-html
Sub SetVHtml(varVHtml As String) As VDatePickerDateTable
sVHtml = varVHtml
...
'set v-if
Sub SetVIf(varVIf As String) As VDatePickerDateTable
sVIf = varVIf
SetAttr("v-if", sVIf)
Return Me
End Sub
...
'set v-model
Sub SetVModel(varVModel As String) As VDatePickerDateTable
sVModel = varVModel
...
'set v-once
Sub SetVOnce(varVOnce As Boolean) As VDatePickerDateTable
bVOnce = varVOnce
...
'set v-pre
Sub SetVPre(varVPre As Boolean) As VDatePickerDateTable
bVPre = varVPre
SetAttr("v-pre", bVPre)
Return Me
End Sub
...
'set v-show
Sub SetVShow(varVShow As String) As VDatePickerDateTable
sVShow = varVShow
...
'set v-text
Sub SetVText(varVText As String) As VDatePickerDateTable
sVText = varVText
...
'set value
Sub SetValue(varValue As String) As VDatePickerDateTable
sValue = varValue
...
'set weekday-format
Sub SetWeekdayFormat(varWeekdayFormat As String) As VDatePickerDateTable
...
'set border-color
Sub SetBorderColor(varBorderColor As String) As VDatePickerDateTable
...
'set border-style
Sub SetBorderStyle(varBorderStyle As String) As VDatePickerDateTable
...
'set border-width
Sub SetBorderWidth(varBorderWidth As String) As VDatePickerDateTable
...
'set border-radius
Sub SetBorderRadius(varBorderRadius As String) As VDatePickerDateTable
...
'set margin-top
Sub SetMarginTop(varMarginTop As String) As VDatePickerDateTable
...
'set margin-right
Sub SetMarginRight(varMarginRight As String) As VDatePickerDateTable
...
'set margin-bottom
Sub SetMarginBottom(varMarginBottom As String) As VDatePickerDateTable
...
'set margin-left
Sub SetMarginLeft(varMarginLeft As String) As VDatePickerDateTable
...
'set padding-top
Sub SetPaddingTop(varPaddingTop As String) As VDatePickerDateTable
...
'set padding-right
Sub SetPaddingRight(varPaddingRight As String) As VDatePickerDateTable
...
'set padding-bottom
Sub SetPaddingBottom(varPaddingBottom As String) As VDatePickerDateTable
...
'set padding-left
Sub SetPaddingLeft(varPaddingLeft As String) As VDatePickerDateTable
...
Sub AddComponent(child As String) As VDatePickerDateTable
...
Sub SetID(varText As String) As VDatePickerDateTable
	mname = varText
	Return Me
End Sub
...
public Sub AddToParent(targetID As String) As VDatePickerDateTable
...
Sub AddToApp(vap As VueApp) As VDatePickerDateTable
	appLink = vap
	data = vap.data	
...
'update the state
Sub SetData(prop as string, value as object) As VDatePickerDateTable
	data.put(prop, value)
	Return Me
End Sub
...
'set an event
Sub SetVOn(event As String) As VDatePickerDateTable
...
Sub SetCaption(varText As String) As VDatePickerDateTable
	If mElement <> Null Then
...
private Sub AddAttr(varName As String, actProp As String) As VDatePickerDateTable
...
public Sub SetClasses(Classes As String) As VDatePickerDateTable
	If mElement <> Null Then
...
public Sub SetStyle(Style As String) As VDatePickerDateTable
	If mElement <> Null Then
...
Sub AddClass(classNames As List) As VDatePickerDateTable
...
Sub SetStyles(m As Map) As VDatePickerDateTable
...
Sub SetAttrs(props As Map) As VDatePickerDateTable
...
'set an attribute
Sub SetAttr(prop As String, value As String) As VDatePickerDateTable
...
'bind an attribute
Sub SetVBind(prop As String, value As String) As VDatePickerDateTable
...
'set a single style
Sub SetStyleSingle(prop As String, value As String) As VDatePickerDateTable
	If BANano.IsUndefined(prop) or BANano.IsNull(prop) Then prop = ""
	If BANano.IsUndefined(value) or BANano.IsNull(value) Then value = ""
	if prop = "" then return me
...
Sub Build(props As Map, styleProps As Map, classNames As List, loose As List) As VDatePickerDateTable
	If loose <> Null Then
...
'bind classes
Sub SetVClass(classObj as string) As VDatePickerDateTable
	SetVBind("class", classObj)
	Return Me
End Sub

'bind styles
Sub SetVStyle(styleObj as string) As VDatePickerDateTable
	SetVBind("style", styleObj)
	Return Me
End Sub

'set color
Sub SetColor1(varColor As String) As VDatePickerDateTable
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VDatePickerDateTable
...
'set text color
Sub SetTextColor1(varColor As String) As VDatePickerDateTable
...
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VDatePickerDateTable
	Dim sColor As String = $"${varColor}--text"$
...
'set direct method
Sub SetMethod(Module As Object,methodName As String) As VDatePickerDateTable
	methodName = methodName.ToLowerCase
...
'toggle
Sub Toggle As VDatePickerDateTable
	If sVShow = "" Then
		Log($"VDatePickerDateTable.Toggle - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'hide
Sub Hide As VDatePickerDateTable
	If sVShow = "" Then
		Log($"VDatePickerDateTable.Hide - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
'show
Sub Show As VDatePickerDateTable
	If sVShow = "" Then
		Log($"VDatePickerDateTable.Show - the v-show for ${mName} has not been set!"$)
		Return Me
	End If
...
Sub SetClassOnOff(clsName as string, clsValue As Boolean) As VDatePickerDateTable
	if svBindClass = "" then
		Log($"VDatePickerDateTable.VBindClass - the v-bind:class for ${mName} has not been set!"$)
		Return Me
	end if
...
'set style 
Sub SetStyleOnOff(styleName as string, styleValue As Boolean) As VDatePickerDateTable
	if svBindStyle = "" then
		Log($"VDatePickerDateTable.VBindCStyle - the v-bind:style for ${mName} has not been set!"$)
		Return Me
	end if
...
'required
'Sub SetRequiredOnOff(b As Boolean) As VDatePickerDateTable
'	If sRequired = "" Then
'		Log($"VDatePickerDateTable.Required - the required for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'read only
'Sub SetReadOnlyOnOff(b As Boolean) As VDatePickerDateTable
'	If sReadonly = "" Then
'		Log($"VDatePickerDateTable.ReadOnly - the readonly for ${mName} has not been set!"$)
'		Return Me
'	End If
...
'disabled
'Sub SetDisabledOnOff(b As Boolean) As VDatePickerDateTable
'	If sDisabled = "" Then
'		Log($"VDatePickerDateTable.Disabled - the disabled for ${mName} has not been set!"$)
'		Return Me
'	End If
