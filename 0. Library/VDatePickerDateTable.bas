...
#DesignerProperty: Key: Current, DisplayName: Current, Description: , DefaultValue: , FieldType: String
...
#DesignerProperty: Key: TableDate, DisplayName: TableDate, Description: , DefaultValue: , FieldType: String
...
'set allowed-dates
Sub SetAllowedDates(varAllowedDates As Object) As VDatePickerDateTable
...
'set enabled
Sub SetEnabled(varEnabled As String) As VDatePickerDateTable
sEnabled = varEnabled
...
'set event-color
Sub SetEventColor(varEventColor As Object) As VDatePickerDateTable
SetAttr("event-color", varEventColor)
Return Me
End Sub

'set events
Sub SetEvents(varEvents As Object) As VDatePickerDateTable
...
'set format
Sub SetFormat(varFormat As Object) As VDatePickerDateTable
...
'set value
Sub SetValue(varValue As Object) As VDatePickerDateTable
SetAttr("value", varValue)
Return Me
End Sub

'set weekday-format
Sub SetWeekdayFormat(varWeekdayFormat As Object) As VDatePickerDateTable
...
Sub AddToApp(va As VueApp) As VDatePickerDateTable
